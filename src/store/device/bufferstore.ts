...
export const usebuffer = defineStore('bufferlyer', () => {
    ...
    let hotelsWithinBuffer;
    function addtotable(buffer:any,bufferLayerview:FeatureLayer){
      const query = hoteldata.createQuery();
            query.geometry = buffer;
            //bufferLayerview.remove
            const hotelPointSymbol = {
                type: 'picture-marker',
    // 图片地址，可以网络路径或本地路径（PS：base64亦可）
                url:"image://data:image/png;base64,",
      ...
      // 遍历缓冲区内的酒店要素，设置自定义样式
            ...
            bufferLayerview.addMany(hotelsWithinBuffer);
            const hotelDetailsDiv = document.getElementById('hotel-details');
            const tbody = hotelDetailsDiv.querySelector('tbody');
    ...
    return{createBuffer,createBufferview,addtotable,buffer}
})
import {
  ...
  r as r2,
  s as s4
} from "./chunk-KEA4MCOH.js";
import {
  o as o2,
  r as r3
} from "./chunk-BDRIBQHS.js";
import {
  f
...
async function o4(o5, m2, f2) {
  const n = "string" == typeof o5 ? L(o5) : o5, p = m2[0].spatialReference, a = c(m2[0]), u = { ...f2, query: { ...n.query, f: "json", sr: p.wkid ? p.wkid : JSON.stringify(p), geometries: JSON.stringify(r3(m2)) } }, { data: y2 } = await U(n.path + "/simplify", u);
  return o2(y2.geometries, a, p);
}
...
function P(e, t2) {
  ...
  for (let o5 = 0; o5 < t2.cutIndexes.length; o5++) {
    const s5 = t2.cutIndexes[o5], r4 = t2.geometries[o5], i2 = o(r4);
...
async function v3(t2, n, l) {
  ...
  let x2, d2, w2, j2, M2, L2, U3, z, A = 0;
  const S = [], k = [];
  for (const e of t2)
    if (t(e))
      k.push(e);
    else if (x2 || (x2 = e.spatialReference, d2 = R(x2), w2 = x2.isWebMercator, L2 = w2 ? 102100 : 4326, j2 = r2[L2].maxX, M2 = r2[L2].minX, U3 = r2[L2].plus180Line, z = r2[L2].minus180Line), d2)
      if ("mesh" === e.type)
        k.push(e);
      else if ("point" === e.type)
        k.push(b(e.clone(), j2, M2));
        ...
        t3.offset(n2, 0), t3.intersects(U3) && t3.xmax !== j2 ? (A = t3.xmax > A ? t3.xmax : A, o5 = R3(o5, w2), S.push(o5), k.push("cut")) : t3.intersects(z) && t3.xmin !== M2 ? (A = t3.xmax * (2 * j2) > A ? t3.xmax * (2 * j2) : A, o5 = R3(o5, w2, 360), S.push(o5), k.push("cut")) : k.push(o5);
      } else
        k.push(e.clone());
    else
      k.push(e);
...
//# sourceMappingURL=chunk-3F26JL34.js.map

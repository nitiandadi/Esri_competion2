...
function j(r2, n2) {
  if (!r2)
    return null;
  let l6 = null;
  return x(r2) ? l6 = g2(r2) : S(r2) && (l6 = r2.color ? new l2(r2.color) : null), l6 ? k(l6, n2) : null;
}
function g2(t2) {
...
function L(e4, t2, o) {
  ...
  const i2 = (e5) => {
    ...
    return k(t2 = t2 ?? r3 ?? (null != o ? p2 : null), o);
  };
  r2.forEach((e5) => {
    var _a;
    if ("object" !== e5.type || null == ((_a = e5.resource) == null ? void 0 : _a.href) || t2)
      if ("water" === e5.type)
        ...
        t(e5.material) ? e5.material = new l3({ color: r3 }) : e5.material.color = r3, null != o && "outline" in e5 && r(e5.outline) && r(e5.outline.color) && (e5.outline.color = k(e5.outline.color, o));
      }
  });
}
function z(e4, t2, o) {
  (t2 = t2 ?? e4.color) && (e4.color = k(t2, o)), null != o && "outline" in e4 && e4.outline && e4.outline.color && (e4.outline.color = k(e4.outline.color, o));
}
function S2(r2, n2, l6) {
  r2 && (n2 || null != l6) && (n2 && (n2 = new l2(n2)), x(r2) ? L(r2, n2, l6) : S(r2) && z(r2, n2, l6));
}
...
async function R(e4) {
  const t2 = await import("./symbolLayerUtils-3IMBJXQB.js"), o = await t2.computeObjectLayerResourceSize(e4, 10), { width: r2, height: n2, depth: l6 } = e4, i2 = [r2, l6, n2];
  let s = 1;
...
async function J(e4, r2) {
  if (e4 && r2)
    return x(e4) ? x3(e4, r2) : void (S(e4) && D(e4, r2));
}
function N(e4, r2, n2) {
  if (e4 && null != r2)
    if (x(e4)) {
...
//# sourceMappingURL=chunk-UXJ7LOVI.js.map

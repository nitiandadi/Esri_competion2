...
var A = class {
  ...
  async _getAggregateGeometry(e4, t4) {
    const n2 = await import("./geometryEngineJSON-KLDNOGVW.js"), { statisticType: o2, outStatisticFieldName: l3 } = e4, { featureAdapter: u2, spatialReference: c4, geometryType: d3, hasZ: m2, hasM: h } = this, g2 = t4.map((e5) => v3(d3, m2, h, u2.getGeometry(e5))), p2 = n2.convexHull(c4, g2, true)[0], y2 = { aggregateGeometries: null, outStatisticFieldName: null };
...
//# sourceMappingURL=chunk-OFBU6NWV.js.map

...
var r5 = false;
function a6() {
  return n2 || (n2 = import("./lerc-wasm-MAE4PITG.js").then((e8) => e8.l).then(({ default: t7 }) => t7({ locateFile: (t8) => a3(`esri/layers/support/rasterFormats/${t8}`) })).then((e8) => {
    u3(e8), r5 = true;
  }), n2);
}
...
//# sourceMappingURL=chunk-KRKCY72W.js.map

...
async function B() {
  has("host-webworker") ? j2 || (j2 = await import("./request-BOPIDY6F.js")) : U._abortableFetch || (U._abortableFetch = globalThis.fetch.bind(globalThis));
}
async function $() {
  r2 || await import("./IdentityManager-J6ZBOI3X.js");
}
async function z(r4) {
  var _a;
...
//# sourceMappingURL=chunk-MKMLHQNH.js.map

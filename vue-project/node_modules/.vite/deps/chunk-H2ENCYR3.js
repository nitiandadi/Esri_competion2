...
function r3(r6, o8, e4) {
  let i4, n;
  return void 0 === o8 ? (n = r6, i4 = [void 0]) : "string" != typeof o8 ? (n = r6, i4 = [void 0], e4 = o8) : (n = o8, i4 = Array.isArray(r6) ? r6 : [r6]), (r7, o9) => {
    const p8 = r7.constructor.prototype;
    for (const c6 of i4) {
      const i5 = d(r7, c6, n);
      i5.write && "object" == typeof i5.write || (i5.write = {}), e4 && (i5.write.target = e4), i5.write.writer = p8[o9];
    }
  };
}
...
function R(e4) {
  return I(e4) && e4.wkid && d2[e4.wkid] || null;
}
function o4(e4) {
...
var c = { wkid: 4326, wkt: r2(d2[4326].wkTemplate, { Central_Meridian: "0.0" }) };
...
function z(e4, t6 = false) {
  ...
  if (r6) {
    ...
    n = q.values[q[r6]], !n && t6 && B.has(r6) && (n = d3);
  } else
...
function M3(i4, o8) {
  ...
  return g2(u5, l6) ? E(u5, l6) ? p(i4) : k(l6) ? x2(i4, y3, f2.WebMercator, false, p(i4)) : G(l6) ? x2(i4, d4, f2.WGS84, false, p(i4)) : null : null;
}
...
function d4(n, t6, e4 = [0, 0], r6 = false) {
...
function j(t6, i4 = false, r6 = p(t6)) {
  return x2(t6, d4, f2.WGS84, i4, r6);
}
...
var M4 = f6 = class extends p5 {
  ...
  normalizeCtorArgs(t6, i4, e4, s7, n) {
    return d5(t6) ? { spatialReference: t6, xmin: 0, ymin: 0, xmax: 0, ymax: 0 } : "object" == typeof t6 ? (t6.spatialReference = null == t6.spatialReference ? f2.WGS84 : t6.spatialReference, t6) : { xmin: t6, ymin: i4, xmax: e4, ymax: s7, spatialReference: n ?? f2.WGS84 };
  }
  ...
  _getParts(t6) {
    ...
    if (!i4) {
      ...
      const y5 = h5.x, u5 = h5.frameId, d6 = l6 === y5 && m5 > 0;
      if (m5 > 2 * x6) {
        const t7 = new f6(r6 < a5 ? l6 : y5, e5, x6, s8, n), m6 = new f6(o8, e5, r6 < a5 ? y5 : l6, s8, n), h6 = new f6(0, e5, x6, s8, n), p8 = new f6(o8, e5, 0, s8, n), d7 = [], z4 = [];
        t7.contains(h6) && d7.push(c6), t7.contains(p8) && z4.push(c6), m6.contains(h6) && d7.push(u5), m6.contains(p8) && z4.push(u5);
        for (let i5 = c6 + 1; i5 < u5; i5++)
          d7.push(i5), z4.push(i5);
        i4.push({ extent: t7, frameIds: [c6] }, { extent: m6, frameIds: [u5] }, { extent: h6, frameIds: d7 }, { extent: p8, frameIds: z4 });
      } else
        l6 > y5 || d6 ? i4.push({ extent: new f6(l6, e5, x6, s8, n), frameIds: [c6] }, { extent: new f6(o8, e5, y5, s8, n), frameIds: [u5] }) : i4.push({ extent: new f6(l6, e5, y5, s8, n), frameIds: [c6] });
...
//# sourceMappingURL=chunk-H2ENCYR3.js.map

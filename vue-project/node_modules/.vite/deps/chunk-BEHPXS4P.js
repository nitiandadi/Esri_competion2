...
async function a3(e2) {
  if (!e2)
    return;
  const a4 = e2.includes("-vector") ? e2.slice(0, e2.indexOf("-vector")) : e2, s3 = await u2("esri/t9n/basemaps");
  return s3[e2] || s3[a4];
}
var s2 = { streets: { id: "streets", classic: true, deprecated: true, get thumbnailUrl() {
  return a2("esri/images/basemap/streets.jpg");
  ...
  return a2("esri/images/basemap/gray.jpg");
  ...
  return a2("esri/images/basemap/national-geographic.jpg");
...
var v = 0;
var _ = "esri.Basemap";
var U = S = class extends u(m) {
  constructor(e2) {
    super(e2), this.id = null, this.portalItem = null, this.spatialReference = null, this.thumbnailUrl = null, this.title = "Basemap", this.id = Date.now().toString(16) + "-basemap-" + v++, this.baseLayers = new j(), this.referenceLayers = new j();
    const t = (e3) => {
  ...
  _writeBaseLayers(e2, r4, t) {
    ...
    e2 ? (t = { ...t, layerContainerType: "basemap" }, this.baseLayers.forEach((e3) => {
      const r5 = y2(e3, t.webmap ? t.webmap.getLayerJSONFromResourceInfo(e3) : null, t);
      r(r5) && s3.push(r5);
    }), this.referenceLayers.forEach((e3) => {
      const r5 = y2(e3, t.webmap ? t.webmap.getLayerJSONFromResourceInfo(e3) : null, t);
      r(r5) && ("scene" !== e3.type && (r5.isReference = true), s3.push(r5));
  ...
  write(e2, r4) {
    return e2 = e2 || {}, r4 && r4.origin || (r4 = { origin: "web-map", ...r4 }), super.write(e2, r4), !this.loaded && this.resourceInfo && this.resourceInfo.data.baseMapLayers && (e2.baseMapLayers = this.resourceInfo.data.baseMapLayers.map((e3) => {
      const r5 = p(e3);
      return r5.url && ht(r5.url) && (r5.url = `https:${r5.url}`), r5.templateUrl && ht(r5.templateUrl) && (r5.templateUrl = `https:${r5.templateUrl}`), r5;
    })), e2;
  }
  ...
  async _loadLayersFromJSON(e2, r4, t) {
    const s3 = this.resourceInfo && this.resourceInfo.context, o = this.portalItem && this.portalItem.portal || s3 && s3.portal || null, a4 = s3 && "web-scene" === s3.origin ? "web-scene" : "web-map", { populateOperationalLayers: i } = await import("./layersCreator-IHAQXJ4Z.js"), n2 = [];
    if (f(t), e2.baseMapLayers && Array.isArray(e2.baseMapLayers)) {
      const t2 = { context: { origin: a4, url: r4, portal: o, layerContainerType: "basemap" }, defaultLayerType: "DefaultTileLayer" }, s4 = (e3) => "web-scene" === a4 && "ArcGISSceneServiceLayer" === e3.layerType || e3.isReference, l2 = i(this.baseLayers, e2.baseMapLayers.filter((e3) => !s4(e3)), t2);
      n2.push(l2);
      const p2 = i(this.referenceLayers, e2.baseMapLayers.filter(s4), t2);
      n2.push(p2);
    }
    await E(n2);
  }
  async _loadFromItem(e2, r4) {
    const t = await e2.load(r4), s3 = await t.fetchData("json", r4), o = L(e2.itemUrl ?? "");
    return this._set("resourceInfo", { data: s3.baseMap ?? {}, context: { origin: "Web Scene" === e2.type ? "web-scene" : "web-map", portal: e2.portal || b.getDefault(), url: o } }), this.read(this.resourceInfo.data, this.resourceInfo.context), this.read({ spatialReference: s3.spatialReference }, this.resourceInfo.context), this.read({ title: e2.title, thumbnailUrl: e2.thumbnailUrl }, { origin: "portal-item", portal: e2.portal || b.getDefault(), url: o }), this._loadLayersFromJSON(this.resourceInfo.data, o, r4);
  }
  static fromId(e2) {
    const r4 = s2[e2];
    if (r4) {
      ...
      return S.fromJSON(r4);
    }
    return null;
  }
};
e([y({ json: { write: { ignoreOrigin: true, target: "baseMapLayers", writer(e2, r4, t, s3) {
  this._writeBaseLayers(e2, r4, s3);
} }, origins: { "web-scene": { write: { ignoreOrigin: true, target: { baseMapLayers: { type: j } }, writer(e2, r4, t, s3) {
  this._writeBaseLayers(e2, r4, s3);
} } } } } })], U.prototype, "baseLayers", null), e([y({ type: String, json: { origins: { "web-scene": { write: true } } } })], U.prototype, "id", void 0), e([y({ type: x })], U.prototype, "portalItem", void 0), e([y()], U.prototype, "referenceLayers", null), e([y({ readOnly: true })], U.prototype, "resourceInfo", void 0), e([y({ type: f2 })], U.prototype, "spatialReference", void 0), e([y()], U.prototype, "thumbnailUrl", void 0), e([y({ type: String, json: { origins: { "web-scene": { write: { isRequired: true } } } } })], U.prototype, "title", void 0), e([r3("title")], U.prototype, "writeTitle", null), U = S = e([a(_)], U);
var x2 = U;
...
//# sourceMappingURL=chunk-BEHPXS4P.js.map

...
function D(t) {
  ...
  if (B.test(t.name))
    return o2(P(t.parameters[0]), M2(t.parameters[1]), M2(t.parameters[2]), t.parameters[3] ? M2(t.parameters[3]) : 1);
...
//# sourceMappingURL=chunk-LC5BGIRA.js.map

...
var a = class {
  ...
  *values() {
  ...
  remove(t2, a3 = null) {
    var _a;
    return this === t2 ? a3 ? (a3.next = this.next, a3) : this.next : ((_a = this.next) == null ? void 0 : _a.remove(t2, this)) ?? null;
  }
  get last() {
...
var n = class {
  ...
  acquire(s) {
    ...
    return c(this._addPage().allocate(s), "Expected to allocate page");
  }
  release(t2) {
...
//# sourceMappingURL=chunk-CO3U7RJC.js.map

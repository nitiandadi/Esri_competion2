...
function o2(e, a) {
  for (var o3 = 0; o3 < a.length; o3++) {
    const r3 = a[o3];
    if ("string" != typeof r3 && !Array.isArray(r3)) {
      for (const a2 in r3)
        if ("default" !== a2 && !(a2 in e)) {
          const o4 = Object.getOwnPropertyDescriptor(r3, a2);
          o4 && Object.defineProperty(e, a2, o4.get ? o4 : { enumerable: true, get: () => r3[a2] });
        }
    }
  }
...
var n = o2({ __proto__: null, default: o(i) }, [i]);
export {
  n as p
};
//# sourceMappingURL=pt_BR-GSDY4JGT.js.map

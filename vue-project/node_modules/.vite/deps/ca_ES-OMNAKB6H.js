...
function o2(e, r2) {
  for (var o3 = 0; o3 < r2.length; o3++) {
    const d2 = r2[o3];
    if ("string" != typeof d2 && !Array.isArray(d2)) {
      for (const r3 in d2)
        if ("default" !== r3 && !(r3 in e)) {
          const o4 = Object.getOwnPropertyDescriptor(d2, r3);
          o4 && Object.defineProperty(e, r3, o4.get ? o4 : { enumerable: true, get: () => d2[r3] });
        }
    }
  }
...
var i = o2({ __proto__: null, default: o(t) }, [t]);
export {
  i as c
};
//# sourceMappingURL=ca_ES-OMNAKB6H.js.map

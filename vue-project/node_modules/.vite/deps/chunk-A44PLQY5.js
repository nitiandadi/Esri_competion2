...
var r5 = false;
function a6() {
  return n2 || (n2 = import("./lerc-wasm-RJV5YMQD.js").then((e8) => e8.l).then(({ default: t7 }) => t7({ locateFile: (t8) => a3(`esri/layers/support/rasterFormats/${t8}`) })).then((e8) => {
    u3(e8), r5 = true;
  }), n2);
}
...
function x3(t7, s9) {
  ...
  if ("number" == typeof g5 && (g5 = a8[g5]), t7.dra)
    ...
    c6 = ((_a = t7.statistics) == null ? void 0 : _a.length) > 0 ? t7.statistics : e(m7.statistics), h6 = t7.histograms || e(m7.histograms);
...
e2([y({ type: Number, json: { write: true } })], l5.prototype, "blockWidth", void 0), e2([y({ type: Number, json: { write: true } })], l5.prototype, "blockHeight", void 0), e2([y({ type: String, json: { write: true } })], l5.prototype, "compression", void 0), e2([y({ type: w, json: { write: true } })], l5.prototype, "origin", void 0), e2([y({ type: Number, json: { write: true } })], l5.prototype, "firstPyramidLevel", void 0), e2([y({ type: Number, json: { write: true } })], l5.prototype, "maximumPyramidLevel", void 0), e2([y({ json: { write: true } })], l5.prototype, "pyramidResolutions", void 0), e2([y({ type: Number, json: { write: true } })], l5.prototype, "pyramidScalingFactor", void 0), e2([y({ type: Number, json: { write: true } })], l5.prototype, "pyramidBlockWidth", void 0), e2([y({ type: Number, json: { write: true } })], l5.prototype, "pyramidBlockHeight", void 0), e2([y({ type: Boolean, json: { write: true } })], l5.prototype, "isVirtualTileInfo", void 0), e2([y({ json: { write: true } })], l5.prototype, "tileInfo", void 0), e2([y()], l5.prototype, "transposeInfo", void 0), e2([y()], l5.prototype, "blockBoundary", void 0), l5 = p7 = e2([a2("esri.layers.support.RasterStorageInfo")], l5);
var n6 = l5;
...
e2([y({ json: { write: true } })], h4.prototype, "attributeTable", void 0), e2([y({ json: { write: true } })], h4.prototype, "bandCount", void 0), e2([y({ json: { write: true } })], h4.prototype, "colormap", void 0), e2([y({ type: String, readOnly: true })], h4.prototype, "dataType", null), e2([y({ type: w2, json: { write: true } })], h4.prototype, "extent", void 0), e2([y({ type: w2, json: { write: true } })], h4.prototype, "nativeExtent", null), e2([y({ json: { write: true } })], h4.prototype, "nativePixelSize", null), e2([y({ json: { write: true } })], h4.prototype, "format", void 0), e2([y({ json: { write: true } })], h4.prototype, "height", void 0), e2([y({ json: { write: true } })], h4.prototype, "width", void 0), e2([y({ json: { write: true } })], h4.prototype, "hasMultidimensionalTranspose", null), e2([y({ json: { write: true } })], h4.prototype, "histograms", void 0), e2([y({ json: { write: true } })], h4.prototype, "keyProperties", void 0), e2([y({ json: { write: true } })], h4.prototype, "multidimensionalInfo", void 0), e2([y({ json: { write: true } })], h4.prototype, "noDataValue", void 0), e2([y({ json: { write: true } })], h4.prototype, "pixelSize", void 0), e2([y({ json: { write: true } })], h4.prototype, "pixelType", void 0), e2([y()], h4.prototype, "isPseudoSpatialReference", void 0), e2([y({ type: f, json: { write: true } })], h4.prototype, "spatialReference", void 0), e2([y({ json: { write: true } })], h4.prototype, "statistics", void 0), e2([y({ type: n6, json: { write: true } })], h4.prototype, "storageInfo", void 0), e2([y({ json: { write: true } })], h4.prototype, "transform", void 0), h4 = l6 = e2([a2("esri.layers.support.RasterInfo")], h4);
var u6 = h4;
...
var v5 = class extends l {
  ...
  _symbolizeStretch(e8, t7) {
    ...
    if ("histogramEqualization" === n9.stretchType) {
      ...
      if (!l8)
        return e8;
      a12 > 1 && (t7 == null ? void 0 : t7.length) === ((_b = e(e8)) == null ? void 0 : _b.pixels.length) && (l8 == null ? void 0 : l8.lut.length) === a12 && (l8 = { lut: t7.map((e9) => l8.lut[e9]), offset: l8.offset }), u8 = p4(e8, l8);
    } else {
  ...
  _symbolizeShadedRelief(e8, t7) {
    ...
    if (!n9)
      return a12;
    const i7 = ((_a = e(this.rasterInfo.statistics)) == null ? void 0 : _a[0]) ?? { min: 0, max: 8e3 };
  ...
  _generateShadedReliefWebGLParams(e8, t7 = false, r10 = { x: 0, y: 0 }) {
    ...
    const i7 = { ...e8, isGCS: t7, resolution: r10 }, l8 = n7(i7), u8 = (_a = e(this.rasterInfo.statistics)) == null ? void 0 : _a[0];
...
e2([y({ json: { write: true } })], v5.prototype, "rendererJSON", void 0), e2([y({ type: u6, json: { write: true } })], v5.prototype, "rasterInfo", void 0), e2([y({ json: { write: true } })], v5.prototype, "lookup", void 0), e2([y()], v5.prototype, "canRenderInWebGL", void 0), v5 = e2([a2("esri.renderers.support.RasterSymbolizer")], v5);
var T3 = v5;
...
//# sourceMappingURL=chunk-A44PLQY5.js.map

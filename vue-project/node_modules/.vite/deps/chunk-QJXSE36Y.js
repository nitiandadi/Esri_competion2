...
async function B() {
  has("host-webworker") ? j2 || (j2 = await import("./request-RKIQMSZ3.js")) : U._abortableFetch || (U._abortableFetch = globalThis.fetch.bind(globalThis));
}
async function $() {
  r2 || await import("./IdentityManager-LQRTHAOS.js");
}
async function z(r4) {
  var _a;
...
//# sourceMappingURL=chunk-QJXSE36Y.js.map

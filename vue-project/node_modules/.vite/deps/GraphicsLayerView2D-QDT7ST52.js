...
var n = class extends f(u) {
  ...
  detach() {
    this.container.removeAllChildren(), this.graphicsView = a(this.graphicsView);
  }
  async hitTest(i2) {
  ...
  highlight(i2) {
    let s;
    "number" == typeof i2 ? s = [i2] : i2 instanceof g ? s = [i2.uid] : Array.isArray(i2) && i2.length > 0 ? s = "number" == typeof i2[0] ? i2 : i2.map((i3) => i3 && i3.uid) : j.isCollection(i2) && i2.length > 0 && (s = i2.map((i3) => i3 && i3.uid).toArray());
    const r2 = s == null ? void 0 : s.filter(r);
    return (r2 == null ? void 0 : r2.length) ? (this._addHighlight(r2), { remove: () => this._removeHighlight(r2) }) : l;
  }
  _addHighlight(i2) {
    for (const t of i2)
...
e([y()], n.prototype, "graphicsView", void 0), n = e([a2("esri.views.2d.layers.GraphicsLayerView2D")], n);
var d = n;
export {
  d as default
};
//# sourceMappingURL=GraphicsLayerView2D-QDT7ST52.js.map

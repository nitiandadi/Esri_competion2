...
var U = S = class extends u(m) {
  ...
  async _loadLayersFromJSON(e2, r4, t) {
    const s3 = this.resourceInfo && this.resourceInfo.context, o = this.portalItem && this.portalItem.portal || s3 && s3.portal || null, a4 = s3 && "web-scene" === s3.origin ? "web-scene" : "web-map", { populateOperationalLayers: i } = await import("./layersCreator-IBKFQUIV.js"), n2 = [];
...
//# sourceMappingURL=chunk-VGE7POXD.js.map

    ...
    if ("string" != typeof t2 && !Array.isArray(t2)) {
      for (const o3 in t2)
        if ("default" !== o3 && !(o3 in e)) {
          const r4 = Object.getOwnPropertyDescriptor(t2, o3);
          r4 && Object.defineProperty(e, o3, r4.get ? r4 : { enumerable: true, get: () => t2[o3] });
        }
    }
  }
...
var d = r2({ __proto__: null, default: o(_) }, [_]);
export {
  d as c
};
//# sourceMappingURL=cs_CZ-HRORQNHF.js.map

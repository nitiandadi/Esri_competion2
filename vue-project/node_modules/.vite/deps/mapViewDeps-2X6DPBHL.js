...
async function s5(s6) {
  const r10 = import("./mask-svg-ZKMJLYLJ.js"), i9 = import("./overlay-svg-CCUHSF45.js"), o11 = t4((await r10).default, { signal: s6 }), e7 = t4((await i9).default, { signal: s6 }), m5 = { mask: await o11, overlay: await e7 };
  return f(s6), m5;
}
...
//# sourceMappingURL=mapViewDeps-2X6DPBHL.js.map

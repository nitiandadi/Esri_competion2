...
e([y({ type: String, json: { write: true } })], i6.prototype, "description", void 0), e([y({ type: String, json: { read: p4.read, write: p4.write } })], i6.prototype, "type", void 0), i6 = e([a("esri.rest.support.GPMessage")], i6);
var a6 = i6;
...
e([y({ type: String, json: { read: p5.read, write: p5.write } })], c4.prototype, "type", void 0), c4 = e([a("esri.rest.support.NAMessage")], c4);
var a7 = c4;
...
e([y({ type: [c6] })], u5.prototype, "events", void 0), e([o2("geometry", ["compressedGeometry"])], u5.prototype, "readGeometry", null), e([y({ type: [i7] })], u5.prototype, "strings", void 0), u5 = e([a("esri.rest.support.DirectionsFeature")], u5);
var l5 = u5;
...
e([y({ type: x2, json: { write: true } })], n5.prototype, "directionLines", void 0), e([y({ type: x2, json: { write: true } })], n5.prototype, "directionPoints", void 0), e([y({ type: f5, json: { write: true } })], n5.prototype, "directions", void 0), e([y({ type: g, json: { write: true } })], n5.prototype, "route", void 0), e([y({ type: String, json: { write: true } })], n5.prototype, "routeName", void 0), e([y({ type: [g], json: { write: true } })], n5.prototype, "stops", void 0), e([y({ type: x2, json: { write: true } })], n5.prototype, "traversedEdges", void 0), e([y({ type: x2, json: { write: true } })], n5.prototype, "traversedJunctions", void 0), e([y({ type: x2, json: { write: true } })], n5.prototype, "traversedTurns", void 0), n5 = e([a("esri.rest.support.RouteResult")], n5);
var u7 = n5;
...
var t4 = { type: String, json: { read: { source: "token" }, write: { target: "token" } } };
...
function re(e3, t5, r4) {
  ...
  const { timeAttributeName: a9, distanceAttributeName: l8 } = s8, m8 = i8.find(({ name: e4 }) => e4 === a9), y7 = i8.find(({ name: e4 }) => e4 === l8), f6 = ((_b = e2(r4.travelMode)) == null ? void 0 : _b.impedanceAttributeName) ?? e2(r4.impedanceAttribute) ?? t5.impedance, d2 = m8 == null ? void 0 : m8.units, h3 = y7 == null ? void 0 : y7.units;
  if (!d2 || !h3)
    throw new s4("routelayer:unknown-impedance-units", "the units of either the distance or time impedance are unknown");
  const w4 = r4.directionsLanguage ?? t5.directionsLanguage, S4 = e2(r4.accumulateAttributes) ?? t5.accumulateAttributeNames ?? [], g3 = new Set(i8.filter(({ name: e4 }) => e4 === a9 || e4 === l8 || e4 === f6 || null != e4 && S4.includes(e4)).map(({ name: e4 }) => e4)), b5 = (e4) => {
    for (const t6 in e4)
...
var de = class extends n2(t3(c2(_(O(a3(b)))))) {
  ...
  readSpatialReference(e3, t5) {
    ...
    if (!(r4 == null ? void 0 : r4.length))
      return f.WGS84;
    const { layerDefinition: o6, featureSet: i8 } = r4[0], s8 = i8.features[0], n7 = ((_b = e2(s8 == null ? void 0 : s8.geometry)) == null ? void 0 : _b.spatialReference) ?? i8.spatialReference ?? o6.spatialReference ?? o6.extent.spatialReference ?? c;

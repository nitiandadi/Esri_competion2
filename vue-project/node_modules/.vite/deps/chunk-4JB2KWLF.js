...
async function o(o2) {
  const a2 = "portalItem" in o2 ? o2 : { portalItem: o2 }, e2 = await import("./portalLayers-O2KO5WCE.js");
  try {
...
var h = class extends n.EventedMixin(s4(m)) {
  ...
  static async fromArcGISServerUrl(t) {
    ...
    return (await import("./arcgisLayers-U7UPAOY4.js")).fromUrl(e2);
  }
...
//# sourceMappingURL=chunk-4JB2KWLF.js.map

...
var A = class extends a2(n.EventedAccessor) {
  ...
  static async getPropertiesFromWebMap(t4, e5) {
    ...
    if (!i4)
      return null;
    const { getFullTimeExtentFromWebDocument: n6, getModeFromTimeSlider: s5, getStopsFromTimeSlider: r2, getTimeExtentFromTimeSlider: o3 } = await import("./utils-6GL6Q3YA.js"), l4 = await n6(t4, e5), m = i4.loop, u = s5(i4);
...
var C2 = class extends W {
  ...
  loadDependencies() {
    return Promise.all([import("./calcite-action-WOYWHAZI.js"), import("./calcite-action-menu-PRXQFQ2N.js")]);
  }
  destroy() {

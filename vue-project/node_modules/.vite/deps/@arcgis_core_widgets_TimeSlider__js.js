...
import {
  a as a3
} from "./chunk-WK37PM3W.js";
import {
  a as a2
} from "./chunk-243PR7VH.js";
...
import "./chunk-3NPWFG5Q.js";
import "./chunk-JOHFBYWS.js";
...
var A = class extends a2(n.EventedAccessor) {
  ...
  static async getPropertiesFromWebMap(t4, e5) {
    ...
    if (!i4)
      return null;
    const { getFullTimeExtentFromWebDocument: n6, getModeFromTimeSlider: s5, getStopsFromTimeSlider: r2, getTimeExtentFromTimeSlider: o3 } = await import("./utils-HO65JO7E.js"), l4 = await n6(t4, e5), m = i4.loop, u = s5(i4);

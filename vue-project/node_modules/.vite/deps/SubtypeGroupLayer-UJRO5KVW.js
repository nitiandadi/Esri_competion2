...
import {
  ...
  y as y4,
  y2 as y5
} from "./chunk-LCCPKYWG.js";
import "./chunk-6JKYZ2HT.js";
import {
  s as s4
} from "./chunk-CBPSNSHU.js";
import {
  a as a4
} from "./chunk-2MXTJGGQ.js";
...
e([y2({ readOnly: true, json: { read: false } })], Y.prototype, "capabilities", null), e([y2({ readOnly: true, json: { read: false } })], Y.prototype, "effectiveCapabilities", null), e([y2({ json: { write: { ignoreOrigin: true } } })], Y.prototype, "charts", void 0), e([y2({ type: Boolean, nonNullable: true, json: { name: "enableEditing", write: { ignoreOrigin: true } } })], Y.prototype, "editingEnabled", void 0), e([y2({ type: Boolean, readOnly: true })], Y.prototype, "effectiveEditingEnabled", null), e([y2({ readOnly: true, json: { read: false } })], Y.prototype, "elevationInfo", null), e([y2({ readOnly: true, json: { name: "layerDefinition.fieldOverrides", origins: { service: { read: false } }, write: { ignoreOrigin: true, allowNull: true } } })], Y.prototype, "fieldOverrides", void 0), e([r3("fieldOverrides")], Y.prototype, "writeFieldOverrides", null), e([y2({ ...M.fields, readOnly: true, json: { read: false } })], Y.prototype, "fields", null), e([y2(M.fieldsIndex)], Y.prototype, "fieldsIndex", void 0), e([y2({ type: y4, json: { name: "formInfo", write: { ignoreOrigin: true } } })], Y.prototype, "formTemplate", void 0), e([y2({ type: String, readOnly: true, json: { origins: { service: { read: false } }, write: { ignoreOrigin: true } } })], Y.prototype, "id", void 0), e([y2({ readOnly: true, json: { read: false } })], Y.prototype, "geometryType", null), e([y2({ readOnly: true, json: { read: false } })], Y.prototype, "type", void 0), e([y2(B(p(m2)))], Y.prototype, "labelsVisible", void 0), e([y2({ type: [C2], json: { name: "layerDefinition.drawingInfo.labelingInfo", origins: { service: { read: false } }, read: { reader: i3 }, write: { ignoreOrigin: true } } })], Y.prototype, "labelingInfo", void 0), e([y2({ type: ["ArcGISFeatureLayer"], readOnly: true, json: { read: false, write: { ignoreOrigin: true } } })], Y.prototype, "layerType", void 0), e([y2(B(p(c)))], Y.prototype, "legendEnabled", void 0), e([y2({ type: ["show", "hide"] })], Y.prototype, "listMode", void 0), e([y2((() => {
  const e3 = p(I);
...
var le = class extends T2(a4(n(a6(t3(p3(p6(c2(_(O(o3(i2(a3(b))))))))))))) {
  ...
  async createGraphicsSource(e3) {
    const { default: r4 } = await y(import("./FeatureLayerSource-2BZ463FC.js"), e3);
...
//# sourceMappingURL=SubtypeGroupLayer-UJRO5KVW.js.map

import {
  b as b3
} from "./chunk-YLCX2QKZ.js";
import "./chunk-PIX67QBZ.js";
import "./chunk-WPVZ2JJC.js";
import {
  a as a3,
  n as n2
} from "./chunk-ZNDSXYSI.js";
import {
  r as r3
...
import {
  n as n3
} from "./chunk-3DUUF22S.js";
import "./chunk-IHRAZ7MK.js";
...
var Ae = class extends O(m2.LoadableMixin(m(L3))) {
  ...
  async save(e4) {
    ...
    const t5 = import("./saveUtils-ZOOEXHYZ.js");
  ...
  async saveAs(e4, t5) {
    t5 = t5 || {};
    const r4 = this._getPortalItem(e4), i15 = import("./saveUtils-ZOOEXHYZ.js");
    await this._updateFromPromise, await this.load(), await this._loadLayerContainers(), await this._beforeSave(), await this._validateMap();
  ...
  _loadFromJSON(e4, t5) {
    ...
    return this.portalItem && (r4.context.portal = this.portalItem.portal || b2.getDefault()), import("./layersCreator-IHAQXJ4Z.js").then(({ populateOperationalLayers: t6 }) => {
  ...
  async _getExtentFromItem() {
    ...
    if (e4 && t5) {
      ...
      if (e4.isWebMercator)
        return R(t5);
      return (await import("./geometryServiceUtils-G4UANKRT.js")).getGeometryServiceURL(this.portalItem).then((r4) => {
        const i15 = new a3();
  ...
  async _projectToWGS84(e4) {
    ...
    if (t5.isWebMercator)
      return j2(e4);
    const r4 = await import("./geometryServiceUtils-G4UANKRT.js"), i15 = await r4.getGeometryServiceURL(this.portalItem), o5 = new a3();

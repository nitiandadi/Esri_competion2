import {
  b as b3
} from "./chunk-3V3NKA4I.js";
import "./chunk-WIY455LN.js";
import "./chunk-MVLXAZ5P.js";
import {
  i as i4
...
import {
  ...
  m as m3,
  v as v3
} from "./chunk-OQUBYICV.js";
import {
  u as u2
} from "./chunk-YWFASVWM.js";
import "./chunk-DNMUMKYV.js";
import "./chunk-DLKP3YK7.js";
import {
  y as y3
} from "./chunk-A4H5D5SE.js";
import {
  l as l2
} from "./chunk-DLEEZ5CX.js";
import "./chunk-BRSYQXRG.js";
import "./chunk-QS7JATZ7.js";
import "./chunk-UV5UXWQM.js";
...
var Ae = class extends O(m2.LoadableMixin(m(L3))) {
  ...
  async save(e4) {
    ...
    const t5 = import("./saveUtils-WVPNXJVM.js");
  ...
  async saveAs(e4, t5) {
    t5 = t5 || {};
    const r4 = this._getPortalItem(e4), i16 = import("./saveUtils-WVPNXJVM.js");
    await this._updateFromPromise, await this.load(), await this._loadLayerContainers(), await this._beforeSave(), await this._validateMap();
  ...
  _loadFromJSON(e4, t5) {
    ...
    return this.portalItem && (r4.context.portal = this.portalItem.portal || b2.getDefault()), import("./layersCreator-MKCECIKQ.js").then(({ populateOperationalLayers: t6 }) => {
  ...
  async _getExtentFromItem() {
    ...
    if (e4 && t5) {
      ...
      if (e4.isWebMercator)
        return R(t5);
      return (await import("./geometryServiceUtils-AFVQUWHK.js")).getGeometryServiceURL(this.portalItem).then((r4) => {
        const i16 = new a4();
  ...
  async _projectToWGS84(e4) {
    ...
    if (t5.isWebMercator)
      return j2(e4);
    const r4 = await import("./geometryServiceUtils-AFVQUWHK.js"), i16 = await r4.getGeometryServiceURL(this.portalItem), o6 = new a4();

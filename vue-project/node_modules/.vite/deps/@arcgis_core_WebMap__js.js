...
var Ae = class extends O(m2.LoadableMixin(m(L3))) {
  ...
  _loadFromJSON(e4, t5) {
    ...
    return this.portalItem && (r4.context.portal = this.portalItem.portal || b2.getDefault()), import("./layersCreator-RYP3KRGN.js").then(({ populateOperationalLayers: t6 }) => {
  ...
  async _getExtentFromItem() {
    ...
    if (e4 && t5) {
      ...
      if (e4.isWebMercator)
        return R(t5);
      return (await import("./geometryServiceUtils-5TZAZLMT.js")).getGeometryServiceURL(this.portalItem).then((r4) => {
        const i15 = new a3();
  ...
  async _projectToWGS84(e4) {
    ...
    if (t5.isWebMercator)
      return j2(e4);
    const r4 = await import("./geometryServiceUtils-5TZAZLMT.js"), i15 = await r4.getGeometryServiceURL(this.portalItem), o5 = new a3();

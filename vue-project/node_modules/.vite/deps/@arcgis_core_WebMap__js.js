...
var Ae = class extends O(m2.LoadableMixin(m(L3))) {
  ...
  async save(e4) {
    ...
    const t5 = import("./saveUtils-QTNC5HVA.js");
  ...
  async saveAs(e4, t5) {
    t5 = t5 || {};
    const r4 = this._getPortalItem(e4), i16 = import("./saveUtils-QTNC5HVA.js");
    await this._updateFromPromise, await this.load(), await this._loadLayerContainers(), await this._beforeSave(), await this._validateMap();
  ...
  _loadFromJSON(e4, t5) {
    ...
    return this.portalItem && (r4.context.portal = this.portalItem.portal || b2.getDefault()), import("./layersCreator-7RHXZEU7.js").then(({ populateOperationalLayers: t6 }) => {
  ...
  async _getExtentFromItem() {
    ...
    if (e4 && t5) {
      ...
      if (e4.isWebMercator)
        return R(t5);
      return (await import("./geometryServiceUtils-IWX4T3MT.js")).getGeometryServiceURL(this.portalItem).then((r4) => {
        const i16 = new a4();
  ...
  async _projectToWGS84(e4) {
    ...
    if (t5.isWebMercator)
      return j2(e4);
    const r4 = await import("./geometryServiceUtils-IWX4T3MT.js"), i16 = await r4.getGeometryServiceURL(this.portalItem), o6 = new a4();

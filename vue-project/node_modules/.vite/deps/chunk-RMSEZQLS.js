...
function f2(e, t2) {
  if (d(e, t2), t2 && ("blendMode" in e && (t2.blendMode = e.blendMode, "normal" === t2.blendMode && delete t2.blendMode), t2.opacity = y(e.opacity) ?? void 0, t2.title = e.title || "Layer", t2.visibility = e.visible, "legendEnabled" in e && "wmts" !== e.type))
    if (f(e)) {
...
function y2(n, r2, o) {
  if (!("write" in n) || !n.write)
    return o && o.messages && o.messages.push(new s("layer:unsupported", `Layers (${n.title}, ${n.id}) of type '${n.declaredClass}' cannot be persisted`, { layer: n })), null;
  if (c(n, o)) {
    const e = {};
...
//# sourceMappingURL=chunk-RMSEZQLS.js.map

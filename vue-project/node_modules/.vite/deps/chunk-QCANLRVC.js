...
var u2 = m3 = class extends i(l) {
  ...
  toGraphic() {
    const e4 = { ObjectID: e(this.objectId), DirectionLineType: r(this.directionLineType) ? g2.toJSON(this.directionLineType) : null, DirectionPointID: e(this.directionPointId), Meters: e(this.distance), Minutes: e(this.duration) };
...
var b3 = u3 = class extends i(l) {
  ...
  toGraphic() {
    const e4 = { ObjectID: e(this.objectId), DirectionPointType: r(this.directionPointType) ? N.toJSON(this.directionPointType) : null, Sequence: e(this.sequence), StopID: this.stopId };
...
var h3 = T2 = class extends i(l) {
  ...
  toGraphic() {
    const e4 = { ObjectID: e(this.objectId), BarrierType: r(this.barrierType) ? A.toJSON(this.barrierType) : null, Costs: r(this.costs) ? JSON.stringify(o5(this.costs)) : null, Name: this.name ?? null, ScaleFactor: this.scaleFactor ?? null };
    return new g({ geometry: this.geometry, attributes: e4, symbol: this.symbol, popupTemplate: this.popupTemplate });
  }
};
h3.fields = [{ name: "ObjectID", alias: "ObjectID", type: "esriFieldTypeOID", editable: false, nullable: false, domain: null }, { name: "BarrierType", alias: "Barrier Type", type: "esriFieldTypeInteger", editable: true, nullable: true, visible: true, domain: { type: "codedValue", name: "esriNABarrierType", codedValues: [{ name: "Restriction", code: 0 }, { name: "Scaled Cost", code: 1 }, { name: "Added Cost", code: 2 }] } }, { name: "Costs", alias: "Costs", type: "esriFieldTypeString", length: 1048576, editable: true, nullable: true, visible: false, domain: null }, { name: "Name", alias: "Name", type: "esriFieldTypeString", length: 255, editable: true, nullable: true, visible: true }, { name: "ScaleFactor", alias: "Scale Factor", type: "esriFieldTypeDouble", editable: true, nullable: true, visible: true }], h3.popupInfo = { title: "Polygon Barriers", fieldInfos: [{ fieldName: "Name", label: "Name", isEditable: true, tooltip: "", visible: true, stringFieldOption: "textbox" }, { fieldName: "BarrierType", label: "Barrier Type", isEditable: true, tooltip: "", visible: true, stringFieldOption: "textbox" }, { fieldName: "ScaleFactor", isEditable: true, tooltip: "", visible: true, format: { places: 3, digitSeparator: true }, stringFieldOption: "textbox" }, { fieldName: "Costs", label: "Costs", isEditable: true, tooltip: "", visible: false, stringFieldOption: "textbox" }], description: null, showAttachments: false, mediaInfos: [] }, e2([y({ type: A.apiValues, json: { name: "attributes.BarrierType", read: { reader: A.read }, write: { writer: A.write } } })], h3.prototype, "barrierType", void 0), e2([y()], h3.prototype, "costs", void 0), e2([o("costs", ["attributes"])], h3.prototype, "readCosts", null), e2([r2("costs")], h3.prototype, "writeCosts", null), e2([y({ type: v, json: { write: true } })], h3.prototype, "geometry", void 0), e2([y({ json: { name: "attributes.Name" } })], h3.prototype, "name", void 0), e2([y({ json: { name: "attributes.ObjectID" } })], h3.prototype, "objectId", void 0), e2([y({ type: k })], h3.prototype, "popupTemplate", void 0), e2([y()], h3.prototype, "scaleFactor", void 0), e2([y({ types: j })], h3.prototype, "symbol", void 0), e2([y({ readOnly: true, json: { read: false } })], h3.prototype, "type", void 0), h3 = T2 = e2([a("esri.rest.support.PolygonBarrier")], h3);
var g3 = h3;
...
var T3 = j2 = class extends i(l) {
  ...
  toGraphic() {
    const e4 = { ObjectID: e(this.objectId), BarrierType: r(this.barrierType) ? A.toJSON(this.barrierType) : null, Costs: r(this.costs) ? JSON.stringify(o5(this.costs)) : null, Name: this.name, ScaleFactor: this.scaleFactor };
    return new g({ geometry: this.geometry, attributes: e4, symbol: this.symbol, popupTemplate: this.popupTemplate });
  }
};
T3.fields = [{ name: "ObjectID", alias: "ObjectID", type: "esriFieldTypeOID", editable: false, nullable: false, domain: null }, { name: "BarrierType", alias: "Barrier Type", type: "esriFieldTypeInteger", editable: true, nullable: true, visible: true, domain: { type: "codedValue", name: "esriNABarrierType", codedValues: [{ name: "Restriction", code: 0 }, { name: "Scaled Cost", code: 1 }, { name: "Added Cost", code: 2 }] } }, { name: "Costs", alias: "Costs", type: "esriFieldTypeString", length: 1048576, editable: true, nullable: true, visible: false, domain: null }, { name: "Name", alias: "Name", type: "esriFieldTypeString", length: 255, editable: true, nullable: true, visible: true }, { name: "ScaleFactor", alias: "Scale Factor", type: "esriFieldTypeDouble", editable: true, nullable: true, visible: true }], T3.popupInfo = { title: "Line Barriers", fieldInfos: [{ fieldName: "Name", label: "Name", isEditable: true, tooltip: "", visible: true, stringFieldOption: "textbox" }, { fieldName: "BarrierType", label: "Barrier Type", isEditable: true, tooltip: "", visible: true, stringFieldOption: "textbox" }, { fieldName: "ScaleFactor", isEditable: true, tooltip: "", visible: true, format: { places: 3, digitSeparator: true }, stringFieldOption: "textbox" }, { fieldName: "Costs", label: "Costs", isEditable: true, tooltip: "", visible: false, stringFieldOption: "textbox" }], description: null, showAttachments: false, mediaInfos: [] }, e2([y({ type: A.apiValues, json: { read: { source: "attributes.BarrierType", reader: A.read } } })], T3.prototype, "barrierType", void 0), e2([y()], T3.prototype, "costs", void 0), e2([o("costs", ["attributes"])], T3.prototype, "readCosts", null), e2([y({ type: m, json: { write: true } })], T3.prototype, "geometry", void 0), e2([y({ json: { name: "attributes.Name" } })], T3.prototype, "name", void 0), e2([y({ json: { name: "attributes.ObjectID" } })], T3.prototype, "objectId", void 0), e2([y({ type: k })], T3.prototype, "popupTemplate", void 0), e2([y()], T3.prototype, "scaleFactor", void 0), e2([y({ types: j })], T3.prototype, "symbol", void 0), e2([y({ readOnly: true, json: { read: false } })], T3.prototype, "type", void 0), T3 = j2 = e2([a("esri.rest.support.PolylineBarrier")], T3);
var f2 = T3;
...
e2([y({ type: [Object], json: { write: true } })], j3.prototype, "attributeParameterValues", void 0), e2([y({ type: String, json: { write: true } })], j3.prototype, "description", void 0), e2([o3(f, { ignoreUnknown: false })], j3.prototype, "distanceAttributeName", void 0), e2([y({ type: String, json: { write: true } })], j3.prototype, "id", void 0), e2([o("id", ["id", "itemId"])], j3.prototype, "readId", null), e2([o3(U, { ignoreUnknown: false })], j3.prototype, "impedanceAttributeName", void 0), e2([y({ type: String, json: { write: true } })], j3.prototype, "name", void 0), e2([y({ type: [String], json: { write: true } })], j3.prototype, "restrictionAttributeNames", void 0), e2([o("restrictionAttributeNames")], j3.prototype, "readRestrictionAttributes", null), e2([r2("restrictionAttributeNames")], j3.prototype, "writeRestrictionAttributes", null), e2([y({ type: Number, json: { write: { allowNull: true } } })], j3.prototype, "simplificationTolerance", void 0), e2([o3(i2)], j3.prototype, "simplificationToleranceUnits", void 0), e2([o3(y2, { ignoreUnknown: false })], j3.prototype, "timeAttributeName", void 0), e2([o3(m2)], j3.prototype, "type", void 0), e2([y({ type: Boolean, json: { write: true } })], j3.prototype, "useHierarchy", void 0), e2([o3(l2)], j3.prototype, "uturnAtJunctions", void 0), j3 = e2([a("esri.rest.support.TravelMode")], j3);
var A2 = j3;
...
e2([y({ type: [String], json: { name: "accumulateAttributeNames", write: true } })], c2.prototype, "accumulateAttributes", void 0), e2([o("accumulateAttributes")], c2.prototype, "readAccumulateAttributes", null), e2([r2("accumulateAttributes")], c2.prototype, "writeAccumulateAttributes", null), e2([y({ type: String, json: { write: true } })], c2.prototype, "directionsLanguage", void 0), e2([y({ type: Boolean, json: { write: true } })], c2.prototype, "findBestSequence", void 0), e2([y({ type: Boolean, json: { write: true } })], c2.prototype, "preserveFirstStop", void 0), e2([y({ type: Boolean, json: { write: true } })], c2.prototype, "preserveLastStop", void 0), e2([y({ type: Boolean, json: { write: true } })], c2.prototype, "startTimeIsUTC", void 0), e2([y({ type: Boolean, json: { write: true } })], c2.prototype, "timeWindowsAreUTC", void 0), e2([y({ type: A2, json: { write: true } })], c2.prototype, "travelMode", void 0), c2 = e2([a("esri.layers.support.RouteSettings")], c2);
var l3 = c2;
...
//# sourceMappingURL=chunk-QCANLRVC.js.map

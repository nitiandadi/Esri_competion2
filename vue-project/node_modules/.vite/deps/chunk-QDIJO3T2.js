...
var n = class extends o {
  constructor(e2, r2) {
    super(a(r2) + e2.message, { cause: e2 }), this.loc = null, Error.captureStackTrace && Error.captureStackTrace(this, n), r2 && r2.loc && (this.loc = r2.loc);
  }
};
var t = class extends Error {
  constructor(e2, o2, n2, s2) {
    super("Execution error - " + a(n2) + i(r[o2], s2)), this.loc = null, this.declaredRootClass = "esri.arcade.arcadeexecutionerror", Error.captureStackTrace && Error.captureStackTrace(this, t), n2 && n2.loc && (this.loc = n2.loc);
  }
};
function a(e2) {
  var _a, _b;
...
var s = class extends Error {
  constructor(e2, o2, n2, t2) {
    super("Compilation error - " + a(n2) + i(r[o2], t2)), this.loc = null, this.declaredRootClass = "esri.arcade.arcadecompilationerror", Error.captureStackTrace && Error.captureStackTrace(this, s), n2 && n2.loc && (this.loc = n2.loc);
  }
};
...
var p = class extends Error {
  constructor(e2, r2) {
    super(i(d[e2], r2)), this.declaredRootClass = "esri.arcade.arcademoduleerror", Error.captureStackTrace && Error.captureStackTrace(this, p);
  }
};
...
//# sourceMappingURL=chunk-QDIJO3T2.js.map

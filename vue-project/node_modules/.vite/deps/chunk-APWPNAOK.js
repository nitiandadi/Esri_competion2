...
var h = class extends v2 {
  ...
  async update(t2, r2) {
    return (await import("./resourceUtils-RDY3QBPS.js")).addOrUpdateResource(this, "update", t2, r2);
  }
  hasPath() {
    return r(this.path);
  }
...
var S = f = class extends u(m) {
  ...
  async fetchResources(e3 = {}, t2) {
    return (await import("./resourceUtils-RDY3QBPS.js")).fetchResources(this, e3, t2);
  }
  async addResource(e3, t2, i) {
    const r2 = await import("./resourceUtils-RDY3QBPS.js");
  ...
  async removeAllResources(e3) {
    return (await import("./resourceUtils-RDY3QBPS.js")).removeAllResources(this, e3);
  }
  resourceFromPath(e3) {
...
//# sourceMappingURL=chunk-APWPNAOK.js.map

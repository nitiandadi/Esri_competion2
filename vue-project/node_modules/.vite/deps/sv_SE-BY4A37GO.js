    ...
    if ("string" != typeof t2 && !Array.isArray(t2)) {
      for (const r3 in t2)
        if ("default" !== r3 && !(r3 in e)) {
          const a3 = Object.getOwnPropertyDescriptor(t2, r3);
          a3 && Object.defineProperty(e, r3, a3.get ? a3 : { enumerable: true, get: () => t2[r3] });
        }
    }
  }

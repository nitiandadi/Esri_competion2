...
async function o(o2) {
  ...
  if (i2.isWebMercator)
    return j(o2);
  const s2 = f.WGS84;
  return await _n(i2, s2), rn(o2, s2);
}
function i(e, t) {
  if (!s(e, t)) {
...
var u = { DEVELOPER_BASEMAP: "DeveloperBasemap", JSAPI: "ArcGIS API for JavaScript", METADATA: "Metadata", MULTI_LAYER: "Multilayer", SINGLE_LAYER: "Singlelayer", TABLE: "Table" };
function l(e) {
  var _a;
...
//# sourceMappingURL=chunk-XFW76F64.js.map

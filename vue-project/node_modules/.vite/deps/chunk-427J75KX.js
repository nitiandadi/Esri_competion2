...
function c(t3) {
  ...
  const f3 = new Float64Array(3 * u3.count), h3 = [], w3 = [], g = [], p2 = [];
  if (d3 = s3(t3, d3, h3), d3 = s3(t3, d3, w3), d3 = s3(t3, d3, g), d3 = s3(t3, d3, p2), d3 !== t3.byteLength)
...
function d(o3, r3, n3) {
  ...
  for (let e2 = 0; e2 < a3; e2++) {
    for (; w3 < s5; )
      h3 |= f3[g] << w3, w3 += 8, g += 1;
    n3[e2] = h3 & p2, h3 >>>= s5, w3 -= s5, w3 + s5 > 32 && (h3 |= f3[g - 1] >> 8 - w3);
  }
  return r3 + g;
}
...
function s4(e2, t3) {
  ...
  for (let o3 = 0; o3 < t3.length; o3++) {
    const i2 = t3[o3], u3 = i2.valueType || i2.type, a3 = A[u3];
    n3.fields[i2.property] = a3(e2, r3), r3 += h2[u3].BYTES_PER_ELEMENT;
  }
...
function b(n3, r3, o3) {
  ...
  for (let s5 = 0; s5 < r3.ordering.length; s5++) {
    const n4 = r3.ordering[s5], o4 = p(r3[n4]);
    ...
    a3 += o4.byteCount ?? 0, u3.entries[n4] = o4;
  }
...
function w2(e2, t3) {
  ...
  if (t3.faces && a3) {
    ...
    for (const e3 of t3.ordering) {
      ...
      o3.faces[e3] = n4, r3 += E(n4.valueType) * n4.valuesPerElement * a3;
    }
  }
...
function I(t3, n3, i2) {
  ...
  const a3 = b(n3, t3, i2);
  y(a3.byteOffset + a3.byteCount, n3.byteLength, "attribute");
  const s5 = a3.entries.attributeValues || a3.entries.objectIds;
  if (s5) {
    if ("String" === s5.valueType) {
      const e2 = a3.entries.attributeByteCounts, t4 = l2(n3, e2), r3 = d2(n3, s5);
...
//# sourceMappingURL=chunk-427J75KX.js.map

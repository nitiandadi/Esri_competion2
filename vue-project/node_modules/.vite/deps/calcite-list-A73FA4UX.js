...
} from "./chunk-GJOFLO3Y.js";
import {
  defineCustomElement as defineCustomElement2
} from "./chunk-DRCN6HPF.js";
import {
  Symbol,
  baseGetTag,
  debounce,
  ...
  isSymbol,
  root
} from "./chunk-NV2V6INH.js";
import {
  MAX_COLUMNS,
  getListItemChildren,
  updateListItemChildren
} from "./chunk-KSCQDAV3.js";
import {
  updateHostInteraction
} from "./chunk-NQKOVQDM.js";
import {
  connectLocalized,
  connectMessages,
  ...
  setUpMessages,
  updateMessages
} from "./chunk-3F5PEW5F.js";
import {
  componentLoaded,
  setComponentLoaded,
  setUpLoadableComponent
} from "./chunk-2AXP5KXT.js";
import {
  defineCustomElement
} from "./chunk-UNQDXHEJ.js";
import {
  createObserver
} from "./chunk-NOWVUVDB.js";
import {
  CSS_UTILITY,
...
var labelDisconnectedEvent = "calciteInternaLabelDisconnected";
...
var Input = proxyCustomElement(class extends H {
    ...
    this.setValue = ({ committing = false, nativeEvent, origin, previousValue, value }) => {
      ...
      if (this.type === "number") {
        ...
        const sanitizedValue = sanitizeNumberString(
          ...
          this.numberingSystem && this.numberingSystem !== "latn" || defaultNumberingSystem !== "latn" ? numberStringFormatter.delocalize(value) : value
        );
  ...
  incrementOrDecrementNumberValue(direction, inputMax, inputMin, nativeEvent) {
    ...
    const finalValue = typeof inputMin === "number" && !isNaN(inputMin) && nudgedValue < inputMin ? inputMin : typeof inputMax === "number" && !isNaN(inputMax) && nudgedValue > inputMax ? inputMax : nudgedValue;
  ...
  render() {
    ...
    const localeNumberInput = this.type === "number" ? h("input", { accept: this.accept, "aria-label": getLabelText(this), autocomplete: this.autocomplete, autofocus: this.autofocus ? true : null, defaultValue: this.defaultValue, disabled: this.disabled ? true : null, enterKeyHint: this.enterKeyHint, inputMode: this.inputMode, key: "localized-input", maxLength: this.maxLength, minLength: this.minLength, multiple: this.multiple, name: void 0, onBlur: this.inputBlurHandler, onFocus: this.inputFocusHandler, onInput: this.inputNumberInputHandler, onKeyDown: this.inputNumberKeyDownHandler, onKeyUp: this.inputKeyUpHandler, pattern: this.pattern, placeholder: this.placeholder || "", readOnly: this.readOnly, ref: this.setChildNumberElRef, type: "text", value: this.localizedValue }) : null;
...
var Filter = proxyCustomElement(class extends H {
  ...
  render() {
    ...
    return h(Fragment, null, h("div", { class: CSS2.container }, h("label", null, h("calcite-input", { "aria-label": this.messages.label, clearable: true, disabled, icon: ICONS.search, messageOverrides: { clear: this.messages.clear }, onCalciteInputInput: this.inputHandler, onKeyDown: this.keyDownHandler, placeholder: this.placeholder, ref: (el) => {
      this.textInput = el;
    }, scale, type: "text", value: this.value }))));
  }
...
var List = proxyCustomElement(class extends H {
  constructor() {
    ...
    this.updateFilteredItems = debounce(() => {
      ...
      const filteredItems = (listItems == null ? void 0 : listItems.filter((item) => {
  ...
  componentDidLoad() {
    setComponentLoaded(this);
    const { filterEl } = this;
    const filteredItems = filterEl == null ? void 0 : filterEl.filteredItems;
    if (filteredItems) {
      this.filteredData = filteredItems;
    }
    this.updateFilteredItems();
  ...
  async setFocus() {
    var _a;
    await componentLoaded(this);
    (_a = this.enabledListItems.find((listItem) => listItem.active)) == null ? void 0 : _a.setFocus();
  }
  // --------------------------------------------------------------------------
  //
  //  Render Methods
  ...
  render() {
    ...
    return h("div", { class: CSS3.container }, loading ? h("calcite-scrim", { class: CSS3.scrim, loading }) : null, h("table", { "aria-busy": toAriaBoolean(loading), "aria-label": label || "", class: CSS3.table, onKeyDown: this.handleListKeydown, role: "treegrid" }, filterEnabled ? h("thead", null, h("tr", { class: { [CSS3.sticky]: true } }, h("th", { colSpan: MAX_COLUMNS }, h("calcite-filter", { "aria-label": filterPlaceholder, disabled: loading || disabled, items: dataForFilter, onCalciteFilterChange: this.handleFilter, placeholder: filterPlaceholder, ref: (el) => this.filterEl = el, value: filterText })))) : null, h("tbody", { class: CSS3.tableContainer }, h("slot", { onSlotchange: this.handleDefaultSlotChange }))));
  }
  updateListItems() {
...
@esri/calcite-components/dist/components/calcite-list.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-list-A73FA4UX.js.map

...
var c3 = new s4({ esriGeometryPoint: "point", esriGeometryMultipoint: "multipoint", esriGeometryPolyline: "polyline", esriGeometryPolygon: "polygon", esriGeometryMultiPatch: "multipatch" });
async function p3(t2, r5, n8, o4) {
  const a8 = await E(t2);
  if (await l2(t2, r5, o4), !a8.addAttachment)
    throw new s2(o4, "Layer source does not support addAttachment capability");
  return a8.addAttachment(r5, n8);
}
function l2(t2, r5, n8) {
...
e([y()], p4.prototype, "creatorField", void 0), e([y()], p4.prototype, "creationDateField", void 0), e([y()], p4.prototype, "editorField", void 0), e([y()], p4.prototype, "editDateField", void 0), e([y()], p4.prototype, "realm", void 0), e([y({ type: a2 })], p4.prototype, "dateFieldsTimeReference", void 0), p4 = e([a("esri.layers.support.EditFieldsInfo")], p4);
var l3 = p4;
...
e([y({ constructOnly: true, json: { write: true } })], p5.prototype, "name", void 0), e([y({ constructOnly: true, json: { write: true } })], p5.prototype, "fields", void 0), e([y({ constructOnly: true, json: { write: true } })], p5.prototype, "isAscending", void 0), e([y({ constructOnly: true, json: { write: true } })], p5.prototype, "indexType", void 0), e([y({ constructOnly: true, json: { write: true } })], p5.prototype, "isUnique", void 0), e([y({ constructOnly: true, json: { write: true } })], p5.prototype, "description", void 0), p5 = e([a("esri.layers.support.FeatureIndex")], p5);

// node_modules/@arcgis/core/layers/support/GeometryFieldsInfo.js
var a3 = class extends i(l) {
  constructor(e4) {
    super(e4), this.shapeAreaField = null, this.shapeLengthField = null, this.units = null;
  }
};
e([y({ type: String, json: { read: { source: "shapeAreaFieldName" } } })], a3.prototype, "shapeAreaField", void 0), e([y({ type: String, json: { read: { source: "shapeLengthFieldName" } } })], a3.prototype, "shapeLengthField", void 0), e([y({ type: String, json: { read: (e4) => le.read(e4) || me.read(e4) } })], a3.prototype, "units", void 0), a3 = e([a("esri.layers.support.GeometryFieldsInfo")], a3);
var c4 = a3;

// node_modules/@arcgis/core/layers/support/Relationship.js
var n3 = new s4({ esriRelCardinalityOneToOne: "one-to-one", esriRelCardinalityOneToMany: "one-to-many", esriRelCardinalityManyToMany: "many-to-many" });
var a4 = new s4({ esriRelRoleOrigin: "origin", esriRelRoleDestination: "destination" });
...
e([y({ json: { read: n3.read, write: n3.write } })], l4.prototype, "cardinality", void 0), e([y({ json: { read: true, write: true } })], l4.prototype, "composite", void 0), e([y({ json: { read: true, write: true } })], l4.prototype, "id", void 0), e([y({ json: { read: true, write: true } })], l4.prototype, "keyField", void 0), e([y({ json: { read: true, write: true } })], l4.prototype, "keyFieldInRelationshipTable", void 0), e([y({ json: { read: true, write: true } })], l4.prototype, "name", void 0), e([y({ json: { read: true, write: true } })], l4.prototype, "relatedTableId", void 0), e([y({ json: { read: true, write: true } })], l4.prototype, "relationshipTableId", void 0), e([y({ json: { read: a4.read, write: a4.write } })], l4.prototype, "role", void 0), l4 = e([a("esri.layers.support.Relationship")], l4);
var p6 = l4;
...
e([y({ type: String, json: { write: true } })], p7.prototype, "expression", void 0), e([y({ type: String, json: { write: true } })], p7.prototype, "name", void 0), e([y({ type: ["boolean", "date", "number", "string"], json: { write: true } })], p7.prototype, "returnType", void 0), e([y({ type: String, json: { write: true } })], p7.prototype, "title", void 0), p7 = s5 = e([a("esri.form.ExpressionInfo")], p7);
var i3 = p7;
...
e([y({ type: ["attachment", "audio", "document", "image", "signature", "video"], json: { write: true } })], p8.prototype, "type", void 0), p8 = s6 = e([a("esri.form.elements.inputs.AttachmentInput")], p8);
var c5 = p8;

// node_modules/@arcgis/core/form/elements/AttachmentElement.js
var i5;
var p9 = i5 = class extends i4 {
  constructor(t2) {
...
e([y({ type: String, json: { write: true } })], p9.prototype, "attachmentKeyword", void 0), e([y({ type: Boolean, json: { write: true } })], p9.prototype, "editable", void 0), e([y({ type: c5, json: { read: { source: "inputType" }, write: { target: "inputType" } } })], p9.prototype, "input", void 0), e([y({ type: ["attachment"], json: { read: false, write: true } })], p9.prototype, "type", void 0), p9 = i5 = e([a("esri.form.elements.AttachmentElement")], p9);
var n4 = p9;
...
e([y({ type: ["barcode-scanner"], json: { read: false, write: true } })], c6.prototype, "type", void 0), c6 = o2 = e([a("esri.form.elements.inputs.BarcodeScannerInput")], c6);
var n5 = c6;

// node_modules/@arcgis/core/form/elements/inputs/ComboBoxInput.js
var s8;
var p12 = s8 = class extends p10 {
  constructor(o4) {
...
e([y({ type: String, json: { write: true } })], p12.prototype, "noValueOptionLabel", void 0), e([y({ type: Boolean, json: { write: true } })], p12.prototype, "showNoValueOption", void 0), e([y({ type: ["combo-box"], json: { read: false, write: true } })], p12.prototype, "type", void 0), p12 = s8 = e([a("esri.form.elements.inputs.ComboBoxInput")], p12);
var i6 = p12;
...
e([y({ type: Boolean, json: { write: true } })], m2.prototype, "includeTime", void 0), e([y({ type: Date, json: { type: Number, write: true } })], m2.prototype, "max", void 0), e([o("max")], m2.prototype, "readMax", null), e([r2("max")], m2.prototype, "writeMax", null), e([y({ type: Date, json: { type: Number, write: true } })], m2.prototype, "min", void 0), e([o("min")], m2.prototype, "readMin", null), e([r2("min")], m2.prototype, "writeMin", null), e([y({ type: ["datetime-picker"], json: { read: false, write: true } })], m2.prototype, "type", void 0), m2 = s9 = e([a("esri.form.elements.inputs.DateTimePickerInput")], m2);
var c7 = m2;

// node_modules/@arcgis/core/form/elements/inputs/RadioButtonsInput.js
var s10;
var p13 = s10 = class extends p10 {
  constructor(o4) {
...
e([y({ type: String, json: { write: true } })], p13.prototype, "noValueOptionLabel", void 0), e([y({ type: Boolean, json: { write: true } })], p13.prototype, "showNoValueOption", void 0), e([y({ type: ["radio-buttons"], json: { read: false, write: true } })], p13.prototype, "type", void 0), p13 = s10 = e([a("esri.form.elements.inputs.RadioButtonsInput")], p13);
var i7 = p13;

// node_modules/@arcgis/core/form/elements/inputs/SwitchInput.js
var s11;
var p14 = s11 = class extends p10 {
  constructor(o4) {
...
e([y({ type: [String, Number], json: { write: true } })], p14.prototype, "offValue", void 0), e([y({ type: [String, Number], json: { write: true } })], p14.prototype, "onValue", void 0), e([y({ type: ["switch"], json: { read: false, write: true } })], p14.prototype, "type", void 0), p14 = s11 = e([a("esri.form.elements.inputs.SwitchInput")], p14);
var i8 = p14;

// node_modules/@arcgis/core/form/elements/inputs/TextAreaInput.js
var o3;
var p15 = o3 = class extends p11 {
  constructor(t2) {
...
e([y({ type: ["text-area"], json: { read: false, write: true } })], p15.prototype, "type", void 0), p15 = o3 = e([a("esri.form.elements.inputs.TextAreaInput")], p15);
var a6 = p15;

// node_modules/@arcgis/core/form/elements/inputs/TextBoxInput.js
var s12;
var p16 = s12 = class extends p11 {
  constructor(t2) {
...
e([y({ type: ["text-box"], json: { read: false, write: true } })], p16.prototype, "type", void 0), p16 = s12 = e([a("esri.form.elements.inputs.TextBoxInput")], p16);
var c8 = p16;

// node_modules/@arcgis/core/form/elements/support/inputs.js
var m3 = { base: p10, key: "type", typeMap: { "barcode-scanner": n5, "combo-box": i6, "datetime-picker": c7, "radio-buttons": i7, switch: i8, "text-area": a6, "text-box": c8 } };

// node_modules/@arcgis/core/form/elements/FieldElement.js
var a7;
var d4 = "esri.form.elements.FieldElement";
var u = s.getLogger(d4);
var m4 = a7 = class extends i4 {
  constructor(e4) {
  ...
  clone() {
    return new a7({ description: this.description, domain: this.domain, editable: this.editable, editableExpression: this.editableExpression, fieldName: this.fieldName, hint: this.hint, input: this.input, label: this.label, requiredExpression: this.requiredExpression, valueExpression: this.valueExpression, visibilityExpression: this.visibilityExpression });
  }
};
e([y({ types: n, json: { read: { reader: i2 }, write: true } })], m4.prototype, "domain", void 0), e([y({ type: Boolean, json: { write: true } })], m4.prototype, "editable", null), e([y({ type: String, json: { write: true } })], m4.prototype, "editableExpression", void 0), e([y({ type: String, json: { write: true } })], m4.prototype, "fieldName", void 0), e([y({ type: String, json: { write: true } })], m4.prototype, "hint", void 0), e([y({ types: m3, json: { read: { source: "inputType" }, write: { target: "inputType" } } })], m4.prototype, "input", void 0), e([y({ type: String, json: { write: true } })], m4.prototype, "requiredExpression", void 0), e([y({ type: String, json: { read: false, write: true } })], m4.prototype, "type", void 0), e([y({ type: String, json: { write: true } })], m4.prototype, "valueExpression", void 0), m4 = a7 = e([a(d4)], m4);
var c9 = m4;

// node_modules/@arcgis/core/form/elements/RelationshipElement.js
var p17;
var l5 = p17 = class extends i4 {
  constructor(e4) {
  ...
  clone() {
    return new p17({ description: this.description, displayCount: this.displayCount, displayType: this.displayType, editable: this.editable, label: this.label, orderByFields: p(this.orderByFields), relationshipId: this.relationshipId, visibilityExpression: this.visibilityExpression });
  }
};
e([y({ type: Number, json: { write: true } })], l5.prototype, "displayCount", void 0), e([y({ type: ["list"], json: { write: true } })], l5.prototype, "displayType", void 0), e([y({ type: Boolean, json: { write: true } })], l5.prototype, "editable", void 0), e([y({ type: [c], json: { write: true } })], l5.prototype, "orderByFields", void 0), e([y({ type: Number, json: { write: true } })], l5.prototype, "relationshipId", void 0), e([y({ type: ["relationship"], json: { read: false, write: true } })], l5.prototype, "type", void 0), l5 = p17 = e([a("esri.form.elements.RelationshipElement")], l5);
var d5 = l5;

// node_modules/@arcgis/core/form/support/elements.js
function n7(t2) {
  return { typesWithGroup: { base: i4, key: "type", typeMap: { attachment: n4, field: c9, group: t2, relationship: d5 } }, typesWithoutGroup: { base: i4, key: "type", typeMap: { attachment: n4, field: c9, relationship: d5 } } };
}
...
var h2 = f5 = class extends l {
  ...
  readElements(e4, t2) {
    return i9(t2.formElements, j3);
  }
  writeElements(e4, t2) {
    t2.formElements = u2(e4, j3);
  }
  clone() {
    return new f5({ description: this.description, expressionInfos: p(this.expressionInfos), elements: p(this.elements), title: this.title, preserveFieldValuesWhenHidden: this.preserveFieldValuesWhenHidden });
  }
};
e([y({ type: String, json: { write: true } })], h2.prototype, "description", void 0), e([y({ json: { write: true } })], h2.prototype, "elements", void 0), e([s3("elements")], h2.prototype, "castElements", null), e([o("elements", ["formElements"])], h2.prototype, "readElements", null), e([r2("elements")], h2.prototype, "writeElements", null), e([y({ type: [i3], json: { write: true } })], h2.prototype, "expressionInfos", void 0), e([y({ type: Boolean, json: { default: false, write: true } })], h2.prototype, "preserveFieldValuesWhenHidden", void 0), e([y({ type: String, json: { write: true } })], h2.prototype, "title", void 0), h2 = f5 = e([a("esri.form.FormTemplate")], h2);
var y4 = h2;
...
//# sourceMappingURL=chunk-J7UL3GVF.js.map

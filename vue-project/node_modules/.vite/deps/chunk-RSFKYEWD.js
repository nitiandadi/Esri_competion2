...
async function o(o2) {
  const a2 = "portalItem" in o2 ? o2 : { portalItem: o2 }, e2 = await import("./portalLayers-AY5Z53HK.js");
  try {
...
var h = class extends n.EventedMixin(s4(m)) {
  ...
  static async fromArcGISServerUrl(t) {
    ...
    return (await import("./arcgisLayers-RG73FG66.js")).fromUrl(e2);
  }
...
//# sourceMappingURL=chunk-RSFKYEWD.js.map

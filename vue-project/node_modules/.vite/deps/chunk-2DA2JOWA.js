...
var s2;
var a = function(e4) {
  if ("WebkitTransition" in e4.style)
    o2 = "webkitTransitionEnd", s2 = "webkitAnimationEnd";
  else {
    if (!("transition" in e4.style))
...
var l = function(e4, t7) {
  return void 0 === t7 && (t7 = e4 + "-active"), function(n8) {
    c2(n8);
    var r3 = false, i4 = function(a4) {
      r3 || (r3 = true, n8.removeEventListener(o2, i4), n8.removeEventListener(s2, i4), n8.classList.remove(e4), n8.classList.remove(t7));
    };
    n8.classList.add(e4), n8.addEventListener(o2, i4), n8.addEventListener(s2, i4), requestAnimationFrame(function() {
      n8.classList.add(t7);
    });
  };
};
var d = function(e4, t7) {
  return void 0 === t7 && (t7 = e4 + "-active"), function(n8, r3) {
    c2(n8);
    var i4 = false, a4 = function(e5) {
      i4 || (i4 = true, n8.removeEventListener(o2, a4), n8.removeEventListener(s2, a4), r3());
    };
    n8.classList.add(e4), n8.addEventListener(o2, a4), n8.addEventListener(s2, a4), requestAnimationFrame(function() {
      n8.classList.add(t7);
    });
  };
};
...
function p(e4) {
  ...
  for (let t7 = 0; t7 < arguments.length; t7++) {
    const e5 = arguments[t7], r4 = typeof e5;
    if ("string" === r4)
      n8.push(e5);
...
var g = (() => {
  const e4 = /* @__PURE__ */ new Map(), t7 = new ResizeObserver((t8) => {
    var _a;
    t2();
    for (const n8 of t8)
      (_a = e4.get(n8.target)) == null ? void 0 : _a(n8);
  });
  return (r3, i4, o7) => (e4.has(r3) && u.error("Already observing element", r3), e4.set(r3, i4), t7.observe(r3, o7), n(() => {
    t7.unobserve(r3), e4.delete(r3);
  }));
})();
function f(e4) {
  const t7 = e4 == null ? void 0 : e4.closest("[dir]");
  return null !== t7 && t7 instanceof HTMLElement && "rtl" === t7.dir || "rtl" === document.dir;
}
function h(e4) {
  const t7 = "data-node-ref";
  this[e4.getAttribute(t7)] = null;
}
function v(e4) {
  const t7 = "data-node-ref";
  this[e4.getAttribute(t7)] = e4;
}
function w(e4, t7) {
  return ("enter" === e4 ? l : d)(t7);
}
...
var E = new Sanitizer({ whiteList: b, onTagAttr: (e4, t7, n8) => {
  const r3 = `${t7}="${n8}"`;
  if (y.includes(t7))
    return r3;
}, stripIgnoreTag: true, stripIgnoreTagBody: ["script", "style"] }, true);
function A(e4, t7) {
  const n8 = e4.getBoundingClientRect(), r3 = t7.getBoundingClientRect(), i4 = n8.top + n8.height, o7 = r3.top + r3.height, s5 = n8.top, a4 = r3.top;
  (i4 > o7 || s5 < a4) && e4.scrollIntoView({ block: "end" });
}
function k(e4) {
  return "Enter" === e4 || " " === e4;
}
...
function i(e4, t7) {
  ...
  if (a2(f3)) {
    const r3 = t7.properties || o3, i4 = r3.key || f3;
    return { vnodeSelector: "div", properties: { key: i4, afterCreate: d2, afterUpdate: s3, afterRemoved: c3, parentWidget: e4, widgetConstructor: f3, widgetProperties: { ...r3, key: i4, children: n8 } }, children: void 0, text: void 0, domNode: null };
  }
  return t7;
}
function d2(t7, r3, o7, { parentWidget: i4, widgetConstructor: d6, widgetProperties: s5 }) {
  var _a;
  const a4 = new d6(s5);
  a4.container = t7, n3.set(t7, a4), (_a = a4.afterCreate) == null ? void 0 : _a.call(a4, a4, t7), i4._internalHandles.add(n(() => c3(t7)));
}
function s3(e4, t7, r3, { widgetProperties: o7 }) {
  var _a;
  const i4 = n3.get(e4);
  i4 && (i4.set(o7), (_a = i4.afterUpdate) == null ? void 0 : _a.call(i4, i4, e4));
}
function c3(e4) {
  var _a;
  const t7 = n3.get(e4);
  t7 && ((_a = t7.afterRemoved) == null ? void 0 : _a.call(t7, t7, e4), t7.destroy(), n3.delete(e4));
}
function a2(e4) {
...
var o4 = function(r3, t7) {
  for (var n8 = 0, i4 = r3.length; n8 < i4; n8++) {
    var d6 = r3[n8];
    Array.isArray(d6) ? o4(d6, t7) : null != d6 && false !== d6 && (d6.hasOwnProperty("vnodeSelector") || (d6 = e3(d6)), t7.push(d6));
  }
};
var t4 = function(r3, e4) {
  for (var t7 = [], n8 = 2; n8 < arguments.length; n8++)
    t7[n8 - 2] = arguments[n8];
  if (1 === t7.length && "string" == typeof t7[0])
    return { vnodeSelector: r3, properties: e4 || void 0, children: void 0, text: t7[0], domNode: null };
  var i4 = [];
  return o4(t7, i4), { vnodeSelector: r3, properties: e4 || void 0, children: i4, text: void 0, domNode: null };
};
function n4(e4, o7, ...n8) {
  return "function" != typeof e4 || a2(e4) ? t4(e4, o7, ...n8) : e4(o7, ...n8);
}
...
var n5 = (e4, t7) => {
  let r3 = {};
  return Object.keys(e4).forEach((t8) => {
    r3[t8] = e4[t8];
  }), t7 && Object.keys(t7).forEach((e5) => {
    r3[e5] = t7[e5];
  }), r3;
};
var s4 = (e4, t7) => e4.vnodeSelector === t7.vnodeSelector && (e4.properties && t7.properties ? e4.properties.key === t7.properties.key && e4.properties.bind === t7.properties.bind : !e4.properties && !t7.properties);
var l2 = (e4) => {
  if ("string" != typeof e4)
...
var d3 = (e4, t7, r3, o7) => {
  ...
  if ("" === i4.vnodeSelector)
    return;
  let n8 = i4.properties;
  if (!(n8 ? void 0 === n8.key ? n8.bind : n8.key : void 0)) {
...
var a3 = (e4) => {
  if (e4.properties) {
    let t7 = e4.properties.enterAnimation;
    t7 && t7(e4.domNode, e4.properties);
  }
};
var f2 = [];
var c4 = false;
var u2 = (e4) => {
  (e4.children || []).forEach(u2), e4.properties && e4.properties.afterRemoved && e4.properties.afterRemoved.apply(e4.properties.bind || e4.properties, [e4.domNode]);
};
var m = () => {
  c4 = false, f2.forEach(u2), f2.length = 0;
};
var h2 = (e4) => {
  f2.push(e4), c4 || (c4 = true, "undefined" != typeof window && "requestIdleCallback" in window ? window.requestIdleCallback(m, { timeout: 16 }) : setTimeout(m, 16));
};
var v2 = (e4) => {
  let t7 = e4.domNode;
  if (e4.properties) {
    let r3 = e4.properties.exitAnimation;
    if (r3) {
      t7.style.pointerEvents = "none";
      let o7 = () => {
        t7.parentNode && (t7.parentNode.removeChild(t7), h2(e4));
      };
      return void r3(t7, o7, e4.properties);
    }
  }
  t7.parentNode && (t7.parentNode.removeChild(t7), h2(e4));
};
var y2 = (t7, i4, n8) => {
  if (!i4)
    return;
  let s5 = n8.eventHandlerInterceptor, p4 = Object.keys(i4), d6 = p4.length;
  for (let a4 = 0; a4 < d6; a4++) {
    ...
    if ("class" === d7)
      ...
      let e4 = Object.keys(f3), r3 = e4.length;
      ...
      let e4 = Object.keys(f3), r3 = e4.length;
      for (let o7 = 0; o7 < r3; o7++) {
        let r4 = e4[o7], i5 = f3[r4];
        i5 && (l2(i5), n8.styleApplyer(t7, r4, i5));
      }
    } else if ("key" !== d7 && null != f3) {
      let l3 = typeof f3;
      "function" === l3 ? (0 === d7.lastIndexOf("on", 0) && (s5 && (f3 = s5(d7, f3, t7, i4)), "oninput" === d7 && function() {
        let e4 = f3;
        f3 = function(t8) {
          e4.apply(this, [t8]), t8.target["oninput-value"] = t8.target.value;
        };
      }()), t7[d7] = f3) : n8.namespace === r2 ? "href" === d7 ? t7.setAttributeNS(o5, d7, f3) : t7.setAttribute(d7, f3) : "string" === l3 && "value" !== d7 ? "innerHTML" === d7 ? t7[d7] = E.sanitize(f3) : g2(t7) && d7 in t7 ? t7[d7] = f3 : t7.setAttribute(d7, f3) : t7[d7] = f3;
    }
  }
};
function g2(e4) {
  if (!(e4 instanceof Element && e4.tagName.includes("-")))
    return false;
  const t7 = window.customElements.get(e4.tagName.toLowerCase());
  return !!t7 && e4 instanceof t7;
}
var N;
var b2 = (e4, t7, r3) => {
  if (t7)
...
var w2 = (e4, t7, r3) => {
  b2(e4, t7.children, r3), t7.text && (e4.textContent = t7.text), y2(e4, t7.properties, r3), t7.properties && t7.properties.afterCreate && t7.properties.afterCreate.apply(t7.properties.bind || t7.properties, [e4, r3, t7.vnodeSelector, t7.properties, t7.children]);
};
var x = (e4, t7, o7, i4) => {
  let s5, l3 = 0, p4 = e4.vnodeSelector, d6 = t7.ownerDocument;
  if ("" === p4)
    s5 = e4.domNode = d6.createTextNode(e4.text), void 0 !== o7 ? t7.insertBefore(s5, o7) : t7.appendChild(s5);
  else {
    for (let a4 = 0; a4 <= p4.length; ++a4) {
      let f3 = p4.charAt(a4);
      if (a4 === p4.length || "." === f3 || "#" === f3) {
        let f4 = p4.charAt(l3 - 1), c5 = p4.slice(l3, a4);
        "." === f4 ? s5.classList.add(c5) : "#" === f4 ? s5.id = c5 : ("svg" === c5 && (i4 = n5(i4, { namespace: r2 })), void 0 !== i4.namespace ? s5 = e4.domNode = d6.createElementNS(i4.namespace, c5) : (s5 = e4.domNode = e4.domNode || d6.createElement(c5), "input" === c5 && e4.properties && void 0 !== e4.properties.type && s5.setAttribute("type", e4.properties.type)), void 0 !== o7 ? t7.insertBefore(s5, o7) : s5.parentNode !== t7 && t7.appendChild(s5)), l3 = a4 + 1;
      }
    }
    w2(s5, e4, i4);
  }
...
var k2 = (e4, t7, r3) => {
  t7 && t7.split(" ").forEach((t8) => {
    t8 && e4.classList.toggle(t8, r3);
  });
};
var A2 = (t7, i4, n8, s5) => {
  if (!n8)
    return;
  let p4 = false, d6 = Object.keys(n8), a4 = d6.length;
  for (let f3 = 0; f3 < a4; f3++) {
    let a5 = d6[f3], c5 = n8[a5], u3 = i4[a5];
    if ("class" === a5)
      u3 !== c5 && (k2(t7, u3, false), k2(t7, c5, true));
    else if ("classes" === a5) {
      let e4 = t7.classList, r3 = Object.keys(c5), o7 = r3.length;
      for (let t8 = 0; t8 < o7; t8++) {
        let o8 = r3[t8], i5 = !!c5[o8];
        i5 !== !!u3[o8] && (p4 = true, i5 ? e4.add(o8) : e4.remove(o8));
      }
    } else if ("styles" === a5) {
      let e4 = Object.keys(c5), r3 = e4.length;
      for (let o7 = 0; o7 < r3; o7++) {
        let r4 = e4[o7], i5 = c5[r4];
        i5 !== u3[r4] && (p4 = true, i5 ? (l2(i5), s5.styleApplyer(t7, r4, i5)) : s5.styleApplyer(t7, r4, ""));
      }
    } else if (c5 || "string" != typeof u3 || (c5 = ""), "value" === a5) {
      let e4 = t7[a5];
      e4 !== c5 && (t7["oninput-value"] ? e4 === t7["oninput-value"] : c5 !== u3) && (t7[a5] = c5, t7["oninput-value"] = void 0), c5 !== u3 && (p4 = true);
    } else if (c5 !== u3) {
      let i5 = typeof c5;
      "function" === i5 && s5.eventHandlerInterceptor || (s5.namespace === r2 ? "href" === a5 ? t7.setAttributeNS(o5, a5, c5) : t7.setAttribute(a5, c5) : "string" === i5 ? "innerHTML" === a5 ? t7[a5] = E.sanitize(c5) : "role" === a5 && "" === c5 ? t7.removeAttribute(a5) : g2(t7) && a5 in t7 ? t7[a5] = c5 : t7.setAttribute(a5, c5) : t7[a5] !== c5 && (t7[a5] = c5), p4 = true);
    }
  }
  return p4;
};
var S = (e4, t7, r3, o7, n8) => {
  if (r3 === o7)
    return false;
  o7 = o7 || i2;
  let l3, f3 = (r3 = r3 || i2).length, c5 = o7.length, u3 = 0, m2 = 0, h3 = false;
  for (; m2 < c5; ) {
    let i4 = u3 < f3 ? r3[u3] : void 0, c6 = o7[m2];
    if (void 0 !== i4 && s4(i4, c6))
      h3 = N(i4, c6, n8) || h3, u3++;
    else {
      let i5 = p2(r3, c6, u3 + 1);
      if (i5 >= 0) {
        for (l3 = u3; l3 < i5; l3++)
          v2(r3[l3]), d3(r3, l3, e4, "removed");
        h3 = N(r3[i5], c6, n8) || h3, u3 = i5 + 1;
      } else
        x(c6, t7, u3 < f3 ? r3[u3].domNode : void 0, n8), a3(c6), d3(o7, m2, e4, "added");
    }
    m2++;
  }
  if (f3 > u3)
...
N = (e4, t7, o7) => {
  let i4 = e4.domNode, s5 = false;
  if (e4 === t7)
    return false;
  let l3 = false;
  if ("" === t7.vnodeSelector) {
    if (t7.text !== e4.text) {
      let e5 = i4.ownerDocument.createTextNode(t7.text);
      return i4.parentNode.replaceChild(e5, i4), t7.domNode = e5, s5 = true, s5;
    }
    t7.domNode = i4;
  } else
    0 === t7.vnodeSelector.lastIndexOf("svg", 0) && (o7 = n5(o7, { namespace: r2 })), e4.text !== t7.text && (l3 = true, void 0 === t7.text ? i4.removeChild(i4.firstChild) : i4.textContent = t7.text), t7.domNode = i4, l3 = S(t7, i4, e4.children, t7.children, o7) || l3, l3 = A2(i4, e4.properties, t7.properties, o7) || l3, t7.properties && t7.properties.afterUpdate && t7.properties.afterUpdate.apply(t7.properties.bind || t7.properties, [i4, o7, t7.vnodeSelector, t7.properties, t7.children]);
  return l3 && t7.properties && t7.properties.updateAnimation && t7.properties.updateAnimation(i4, t7.properties, e4.properties), s5;
};
var C = (e4, t7) => ({ getLastRender: () => e4, update: (r3) => {
  if (e4.vnodeSelector !== r3.vnodeSelector)
...
}, eventHandlerInterceptor: void 0, styleApplyer: (e4, r3, o7) => {
  "-" === r3.charAt(0) ? e4.style.setProperty(r3, o7) : e4.style[r3] = o7;
} };
var d4 = (r3) => n5(p3, r3);
var n6 = { create: (e4, t7) => (t7 = d4(t7), x(e4, document.createElement("div"), void 0, t7), C(e4, t7)), append: (e4, t7, p4) => (p4 = d4(p4), x(t7, e4, void 0, p4), C(t7, p4)), insertBefore: (e4, t7, p4) => (p4 = d4(p4), x(t7, e4.parentNode, e4, p4), C(t7, p4)), merge: (e4, r3, p4) => (p4 = d4(p4), r3.domNode = e4, w2(e4, r3, p4), C(r3, p4)), replace: (e4, t7, p4) => (p4 = d4(p4), x(t7, e4.parentNode, e4, p4), e4.parentNode.removeChild(e4), C(t7, p4)) };
...
var n7 = (e4, r3) => {
  let t7 = [];
  for (; e4 && e4 !== r3; )
    t7.push(e4), e4 = e4.parentNode;
  return t7;
};
t6 = Array.prototype.find ? (e4, r3) => e4.find(r3) : (e4, r3) => e4.filter(r3)[0];
var o6 = (e4, r3) => {
  let n8 = e4;
  return r3.forEach((e5) => {
    n8 = n8 && n8.children ? t6(n8.children, (r4) => r4.domNode === e5) : void 0;
  }), n8;
};
var d5 = (e4, r3, t7) => {
  let d6 = function(d7) {
    ...
    return e4.scheduleRender(), a4 && (l3 = a4.properties[`on${d7.type}`].apply(a4.properties.bind || this, arguments)), t7("domEventProcessed", d7), l3;
  };
  return (e5, r4, t8, n8) => d6;
};
var i3 = (t7) => {
  let n8, o7, i4 = d4(t7), p4 = i4.performanceLogger, l3 = true, a4 = false, s5 = [], c5 = [], u3 = (e4, r3, t8) => {
    let o8, l4 = () => o8;
    i4.eventHandlerInterceptor = d5(n8, l4, p4), o8 = e4(r3, t8(), i4), s5.push(o8), c5.push(t8);
  }, f3 = () => {
    if (o7 = void 0, l3) {
      l3 = false, p4("renderStart", void 0);
      for (let e4 = 0; e4 < s5.length; e4++) {
        let r3 = c5[e4]();
        p4("rendered", void 0), s5[e4].update(r3), p4("patched", void 0);
      }
...
@esri/arcgis-html-sanitizer/dist/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2DA2JOWA.js.map

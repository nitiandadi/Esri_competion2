  ...
  if (o12 && e13)
    if ("object" == typeof e13)
      ...
      if (e13.includes(".")) {
        ...
        return void t8(o5(o12, n12), i11, s14);
      }
...
function n7(r8, t15) {
  if (has("esri-unknown-property-errors") && !e7(r8, t15))
...
var t9 = class extends r2 {
  constructor(e13, s14, r8) {
    if (super(e13, s14, r8), !(this instanceof t9))
      return new t9(e13, s14, r8);
  }
};
...
function g2(t15) {
  ...
  return (o12, p10, u9) => {
    ...
    if (!c12) {
      ...
      return u9 && u9.messages && o12 && u9.messages.push(new t9(`${n12}:unsupported`, t16, { definition: o12, context: u9 })), void i3.error(t16);
    }
    const a11 = new c12();
...
function i6(r8, e13) {
  ...
  r8 && (1 === t15 || "type" in r8 && e8(r8.type)) ? e13.write.writer = a7 : t15 > 1 ? e13.write.writer = l5(t15) : e13.types ? Array.isArray(e13.types) ? e13.write.writer = f5(e13.types[0]) : e13.write.writer = o10(e13.types) : e13.write.writer = s9;
}
function o10(r8) {
...
var s12 = class {
  ...
  observe(s14) {
    ...
    return o12 || (t15.push(s14), n12 && this._removeDestroyedObservers()), new s11(t15, s14);
  }
...
var a10 = class {
  constructor(t15, e13, s14) {
    this.properties = t15, this.propertyName = e13, this.metadata = s14, this.observerObject = new l7(), this._accessed = null, this._handles = null, this.observerObject.flags = i4.Dirty | (s14.nonNullable ? i4.NonNullable : 0) | (s14.hasOwnProperty("value") ? i4.HasDefaultValue : 0) | (void 0 === s14.get ? i4.DepTrackingInitialized : 0) | (void 0 === s14.dependsOn ? i4.AutoTracked : 0), c10.register(this, this.observerObject);
  }
  destroy() {
    this.observerObject.destroy(), this._accessed = null, this._clearObservationHandles(), c10.unregister(this);
  }
  getComputed() {
...
var c10 = new FinalizationRegistry((t15) => {
  t15.destroy();
});
  ...
  destroy() {
    ...
    for (const [t15, e13] of this.properties) {
      if (e13.metadata.autoDestroy) {
        ...
        s14 && v4(s14) && (s14.destroy(), ~e13.observerObject.flags & i4.NonNullable && this._internalSet(e13, null));
      }
      e13.destroy();
    }
  }
...
var t14 = class {
  constructor(t15) {
    this._notify = t15, this._accessed = [], this._handles = [], this._observerObject = new s13(this._notify), e11.register(this, this._observerObject);
  }
  destroy() {
    var _a;
...
function o11(e13, o12) {
  let u9 = new t14(s14), l9 = null, f9 = false;
  function s14() {
    if (!u9 || f9)
      return;
    if (r7)
      return void i9(s14);
    const t15 = l9;
    u9.clear(), r7 = true, f9 = true, l9 = f4(u9, e13), f9 = false, r7 = false, o12(l9, t15), c11();
  }
  function m8() {
...
function l8(e13) {
  let o12 = new t14(l9), u9 = false;
  function l9() {
    o12 && !u9 && (r7 ? i9(l9) : (o12.clear(), r7 = true, u9 = true, f4(o12, e13), u9 = false, r7 = false, c11()));
  }
  function f9() {
...
var f7 = class {
  ...
  acquire(e13, t15, r8, o12, l9, n12, s14) {
    this.uid = e10(), this.removed = false, this.type = e13, this.oldValue = t15, this.callback = r8, this.getValue = o12, this.target = l9, this.path = n12, this.equals = s14;
  }
  release() {
...
var v5;
function k4(e13) {
  p8.delete(e13), p8.add(e13), v5 || (v5 = v2(q2));
}
function _3(e13) {
  if (e13.removed)
    return;
...
//# sourceMappingURL=chunk-3PPVODAA.js.map

...
var h = class extends v2 {
  ...
  async update(t2, r2) {
    return (await import("./resourceUtils-UGCY3XBJ.js")).addOrUpdateResource(this, "update", t2, r2);
  }
  hasPath() {
    return r(this.path);
  }
...
var S = f = class extends u(m) {
  ...
  async fetchResources(e3 = {}, t2) {
    return (await import("./resourceUtils-UGCY3XBJ.js")).fetchResources(this, e3, t2);
  }
  async addResource(e3, t2, i) {
    const r2 = await import("./resourceUtils-UGCY3XBJ.js");
  ...
  async removeAllResources(e3) {
    return (await import("./resourceUtils-UGCY3XBJ.js")).removeAllResources(this, e3);
  }
  resourceFromPath(e3) {
...
//# sourceMappingURL=chunk-A3YQWDU2.js.map

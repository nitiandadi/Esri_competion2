...
function E(n, e3) {
  ...
  if ("polyline" === n.type)
    ...
    "extent" === n.type && (r2 += 2 * e2([n.xmin, n.ymin, 0], [n.xmax, n.ymin, 0], t2), r2 += 2 * e2([n.xmin, n.ymin, 0], [n.xmin, n.ymax, 0], t2), r2 *= 2, r2 += 4 * Math.abs(Z(n.zmax, 0) * t2 - Z(n.zmin, 0) * t2));
...
function O(n, v3) {
  ...
  n.disjoint = function(n2, e3) {
    ...
    return v3(n2, e3, (t2, r2, l2) => {
      if (l2 = be(l2), B(l2, 3, 3, n2, e3), l2[0] instanceof p && l2[1] instanceof p)
        return A.relate(l2[0], l2[1], re(l2[2]));
        ...
        if (J(l2[0])) {
          ...
          if (!V(l2[0])) {
            if (l2[0] instanceof p)
              return ce(c(l2[0]), n2.spatialReference);
            if (null === l2[0])
              return null;
            throw new t(n2, e.InvalidParameter, t2);
          }
    ...
    return v3(n2, e3, (t2, r2, l2) => {
      if (l2 = be(l2), B(l2, 2, 2, n2, e3), !(l2[1] instanceof w2) && null !== l2[1])
        throw new t(n2, e.InvalidParameter, e3);
      if (null === l2[0])
        return null;
      if (!(l2[0] instanceof p))
    ...
    return v3(n2, t2, (r2, l2, o) => {
      if (o = be(o), B(o, 2, 2, n2, t2), !(o[1] instanceof m) && null !== o[1])
        throw new t(n2, e.InvalidParameter, t2);
      if (null === o[0])
        return [];
      if (!(o[0] instanceof p))
    ...
    return v3(n2, e3, (r2, l2, o) => {
      if (B(o, 1, 2, n2, e3), null === (o = be(o))[0])
        return 0;
      if (J(o[0]) || V(o[0])) {
    ...
    return v3(n2, e3, (t2, l2, o) => {
      ...
      let c2 = o[1];
      if ((J(o[1]) || V(o[1])) && (c2 = Te(o[1], n2.spatialReference)), !(u3 instanceof p))
        throw new t(n2, e.InvalidParameter, e3);
      if (!(c2 instanceof p))
        throw new t(n2, e.InvalidParameter, e3);
    ...
    return v3(n2, e3, (t2, l2, o) => {
      if (o = be(o), B(o, 2, 3, n2, e3), null === o[0])
        return null;
      if (!(o[0] instanceof p))
        throw new t(n2, e.InvalidParameter, e3);
      const f = le(o[1]);
    ...
    return v3(n2, e3, (t2, l2, o) => {
      if (o = be(o), B(o, 2, 4, n2, e3), null === o[0])
        return null;
      if (!(o[0] instanceof p))
        throw new t(n2, e.InvalidParameter, e3);
      const f = le(o[1]);
    ...
    return v3(n2, t2, (l2, o, f) => {
      if (f = be(f), B(f, 2, 3, n2, t2), null === f[0])
        return null;
      if (!(f[0] instanceof p))
        throw new t(n2, e.InvalidParameter, t2);
      const s2 = le(f[1]);
    ...
    return v3(n2, e3, (t2, l2, f) => {
      if (f = be(f), B(f, 2, 6, n2, e3), null === f[0])
        return null;
    ...
    return v3(n2, t2, (r2, l2, o) => {
      if (o = be(o), B(o, 1, 1, n2, t2), null === o[0])
        return null;
      let c2 = o[0];
      if ((J(o[0]) || V(o[0])) && (c2 = Te(o[0], n2.spatialReference)), null === c2)
        return null;
      if (!(c2 instanceof p))
        throw new t(n2, e.InvalidParameter, t2);
    ...
    return v3(n2, t2, (r2, l2, o) => {
      ...
      if (!(o[0] instanceof p))
        throw new t(n2, e.InvalidParameter, t2);
      if (o[0] instanceof w)
        return [ce(c(o[0]), n2.spatialReference)];
    ...
    return v3(n2, e3, (t2, r2, l2) => {
      if (l2 = be(l2), B(l2, 1, 1, n2, e3), null === l2[0])
        return true;
      if (!(l2[0] instanceof p))
        throw new t(n2, e.InvalidParameter, e3);
...
//# sourceMappingURL=chunk-DW3P3K6F.js.map

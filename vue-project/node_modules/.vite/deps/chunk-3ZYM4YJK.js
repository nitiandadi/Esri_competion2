import {
  ...
  u,
  v as v2
} from "./chunk-3KPCKXC3.js";
import {
  e
} from "./chunk-TN56VXJJ.js";
import {
  T as T2
...
var j2 = class extends v2 {
  ...
  executeQuery(e4, t4) {
    const i3 = "execute" === t4 ? s3 : "executeForCount" === t4 ? n5 : s2, r3 = "execute" === t4 && this.pbfSupportedForQuery(e4);
    let s5 = null;
  ...
  async getFeatureByObjectId(e4, t4) {
    ...
    const r3 = await s3(this._layer.parsedUrl.path, i3);
...
//# sourceMappingURL=chunk-3ZYM4YJK.js.map

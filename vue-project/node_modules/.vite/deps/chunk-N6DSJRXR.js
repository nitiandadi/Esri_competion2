...
async function s4(e4, t5) {
  if ("Utility Network Layer" === e4) {
    const { default: e5 } = await import("./UtilityNetwork-KR6Z24NH.js");
...
var v2 = class extends O(m) {
  ...
  async queryNamedTraceConfigurations(e4, r2) {
    var _a;
    const { queryNamedTraceConfigurations: t5 } = await import("./queryNamedTraceConfigurations-5B2VL45V.js"), o4 = this.networkServiceUrl, a6 = new p2({ ...e4 });
  ...
  async validateTopology(e4, r2) {
    ...
    const { validateNetworkTopology: o4 } = await import("./validateNetworkTopology-O53GTIF2.js"), a6 = this.networkServiceUrl, i2 = await o4(a6, e4, { ...r2 });
  ...
  async submitTopologyValidationJob(e4, r2) {
    ...
    const { submitValidateNetworkTopologyJob: o4 } = await import("./validateNetworkTopology-O53GTIF2.js"), a6 = this.networkServiceUrl, i2 = await o4(a6, e4, { ...r2 });
...
//# sourceMappingURL=chunk-N6DSJRXR.js.map

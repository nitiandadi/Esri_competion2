...
function r2(e, a) {
  for (var r3 = 0; r3 < a.length; r3++) {
    const t2 = a[r3];
    if ("string" != typeof t2 && !Array.isArray(t2)) {
      for (const a2 in t2)
        if ("default" !== a2 && !(a2 in e)) {
          const r4 = Object.getOwnPropertyDescriptor(t2, a2);
          r4 && Object.defineProperty(e, a2, r4.get ? r4 : { enumerable: true, get: () => t2[a2] });
        }
    }
  }
...
var _ = r2({ __proto__: null, default: o(o2) }, [o2]);
export {
  _ as i
};
//# sourceMappingURL=id_ID-RBEBXLW3.js.map

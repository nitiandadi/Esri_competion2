...
function F(n, t2 = [0, 0, 0]) {
  return t2[0] = l(n), t2[1] = N(n), t2[2] = T(n), t2;
}
function G(n, t2, r = n) {
...
function q(n, t2, r, i2, a2) {
  return n[0] = t2, n[1] = r, n[2] = Number.NEGATIVE_INFINITY, n[3] = i2, n[4] = a2, n[5] = Number.POSITIVE_INFINITY, n;
}
function w2(n) {
  return 6 === n.length;
}
...
//# sourceMappingURL=chunk-UZTIVDTR.js.map

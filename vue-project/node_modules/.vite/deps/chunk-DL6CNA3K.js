...
var h = class {
    ...
    if (f2(t, n))
      for (g.clear(); n; ) {
        for (let s = 0, h2 = n.children.length; s < h2; s++) {
          ...
          f2(t, a2) && (n.leaf ? i(h3) : x2(t, a2) ? this._all(h3, i) : g.push(h3));
        }
        n = g.pop();
      }
  }
  ...
  remove(i) {
    ...
    for (X.clear(), Y.clear(); s || X.length > 0; ) {
      if (s || (s = N(X.pop()), h2 = X.data[X.length - 1], a2 = Y.pop() ?? 0, r2 = true), s.leaf && (e = b(s.children, i, s.children.length, s.indexHint), -1 !== e))
        return s.children.splice(e, 1), X.push(s), this._condense(X), this;
      r2 || s.leaf || !x2(s, o2) ? h2 ? (a2++, s = h2.children[a2], r2 = false) : s = null : (X.push(s), Y.push(a2), a2 = 0, h2 = s, s = s.children[0]);
    }
    return this;
  }
  toJSON() {
...
var w = class extends B {
  constructor() {
    super(...arguments), this.height = 1, this.indexHint = new x();
  }
};
...
//# sourceMappingURL=chunk-DL6CNA3K.js.map

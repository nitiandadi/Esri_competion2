import {
  g as g2
} from "./chunk-KSXSHXZK.js";
import "./chunk-LKPW5VN6.js";
import {
  l as l4,
  t as t8,
  ue
} from "./chunk-YDTGJZLX.js";
import {
  d as d2,
  s as s5
...
var ne = class extends a3(E(p3(c3(_(t5(O(i(b)))))))) {
  ...
  async applyEdits(e3, t9) {
    const r5 = await import("./editingSupport-J3HJJORG.js");
    if (await this.load(), t(this.associatedLayer))
...
//# sourceMappingURL=SceneLayer-WOCZ5FNA.js.map

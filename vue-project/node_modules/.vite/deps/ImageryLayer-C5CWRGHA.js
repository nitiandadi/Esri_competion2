...
import "./chunk-CB4S2SEC.js";
import {
  s as s7
} from "./chunk-3MAEJ4CR.js";
import "./chunk-ZE4I5TQG.js";
...
function x3(e6, n10) {
  ...
  const u9 = T4[n3.toJSON(e6.stretchType)], c16 = "u8", m7 = { StretchType: u9, Statistics: V(e6.statistics ?? []), DRA: e6.dynamicRangeAdjustment, UseGamma: e6.useGamma, Gamma: e6.gamma, ComputeGamma: e6.computeGamma };
...
function C2(e6, n10) {
  const t4 = m3.has(n10) ? s6(n10) : null;
...
} } } })], y5.prototype, "sortValue", void 0), e([s3("sortValue")], y5.prototype, "castSortValue", null), e([y({ type: w2, json: { write: true } })], y5.prototype, "viewpoint", void 0), e([y({ type: String, json: { write: true } })], y5.prototype, "where", void 0), y5 = m4 = e([a2("esri.layers.support.MosaicRule")], y5);
var f8 = y5;
...
async function n8(n10, m7, p16) {
  ...
  const S4 = w3.fromJSON(y13.extent), j7 = Math.ceil(S4.width / y13.pixelSizeX - 0.1), w8 = Math.ceil(S4.height / y13.pixelSizeY - 0.1), b4 = S4.spatialReference, k3 = new w2({ x: y13.pixelSizeX, y: y13.pixelSizeY, spatialReference: b4 }), z = ((_b = y13.histograms) == null ? void 0 : _b.length) ? y13.histograms : null, L4 = new n4({ origin: y13.origin, blockWidth: y13.blockWidth, blockHeight: y13.blockHeight, firstPyramidLevel: y13.firstPyramidLevel, maximumPyramidLevel: y13.maxPyramidLevel });
...
var Ne = (a9) => {
  let g3 = class extends a9 {
    ...
    async queryObjectIds(e6, t4) {
      return { query: e6, requestOptions: t4 } = await this._prepareForQuery(e6, t4), s8(this.url, e6, t4);
    }
    async queryRasterCount(e6, t4) {
      return { query: e6, requestOptions: t4 } = await this._prepareForQuery(e6, t4), n6(this.url, e6, t4);
    }
...
var L3 = class extends n2(a3(t2(c3(_(Ne(p3(o3(p5(O(b)))))))))) {
  constructor(...e6) {
  ...
  createPopupTemplate(e6) {
    ...
    return s9 && o5.add("raster.magnitude").add("raster.direction"), p4({ fields: r4, title: t4 }, { ...e6, visibleFieldNames: o5 });
  }
  queryFeatures(e6, r4) {
...
//# sourceMappingURL=ImageryLayer-C5CWRGHA.js.map

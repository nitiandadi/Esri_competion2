...
import {
  K
} from "./chunk-JYX5X6UR.js";
import {
  i
} from "./chunk-TZBBKXOW.js";
import {
  v as v5
} from "./chunk-W6NQZGUS.js";
import {
  i as i2
...
var G = class extends m2.LoadableMixin(m(a3(j))) {
  ...
  async _applyEdits(e4) {
    ...
    i5(r4 ? r4.features : null, i7, this.layer.spatialReference);
...
var Ze = class extends T2(n5(p8(u3(a5(n2(c3(a4(t4(p3(p7(c2(_(O(o4(i3(i(b2))))))))))))))))) {
  constructor(...e4) {
  ...
  readCapabilities(e4, r4) {
    return r4 = r4.layerDefinition || r4, n7(r4, this.url);
  }
  ...
  readTypes(e4, r4) {
    ...
    const t6 = r4.editFieldsInfo, i7 = t6 && t6.creatorField, o6 = t6 && t6.editorField;
    return e4 && e4.map((e5) => (e5 = n6.fromJSON(e5), this._fixTemplates(e5.templates, i7), this._fixTemplates(e5.templates, o6), e5));
  }
  readVisible(e4, r4) {
  ...
  async addAttachment(e4, r4) {
    return p10(this, e4, r4, Ne);
  }
  async updateAttachment(e4, r4, t6) {
    return y4(this, e4, r4, t6, Ne);
  }
  ...
  async createGraphicsSource(e4) {
    ...
    const { default: r4 } = await y(import("./FeatureLayerSource-L4XAU2NP.js"), e4);
  ...
  async save(e4) {
    return (await import("./featureLayerUtils-7NZH5WDP.js")).save(this, e4);
  }
  async saveAs(e4, r4) {
    return (await import("./featureLayerUtils-7NZH5WDP.js")).saveAs(this, e4, r4);
  }
...
//# sourceMappingURL=chunk-ABCADCZZ.js.map

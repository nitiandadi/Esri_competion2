...
var c3 = class extends b2 {
  ...
  static fromOptimizedFeatures(t3, e4, r6) {
    const s4 = b2.createInstance(), i2 = new c3(s4, t3, e4);
...
var C = class {
  ...
  _initData(t3, e4, i2, s4) {
    ...
    for (let o2 = 0; o2 < n4.length; o2 += 4)
      n4[o2 + 1] = 255;
    return n4;
  }
  _resetRange() {
...
var M = class {
      ...
      if ("subtype" === i2.type) {
        ...
        for (const t4 in i2.mapping) {
          ...
          if (r(e5) && r(e5.vvMapping))
            for (const i3 of e5.vvMapping)
              this._bindAttribute(i3, parseInt(t4, 10));
        }
      } else {
        if (this._attributeComputeInfo = { isSubtype: false, map: /* @__PURE__ */ new Map() }, r(i2.vvMapping))
  ...
  setAttributeData(t3, e4) {
    ...
    r6 && (o2 = r6.isSubtype ? r6.map.get(e4.readAttribute(r6.subtypeField)) : r6.map, o2 && o2.size && o2.forEach((t4, r7) => {
      ...
      if (this.config.supportsTextureFloat)
        ...
        l2.setData(s4, o3, 255), l2.setData(s4, o3 + 1, 255);
      else {
  ...
  async _getFilter(t3, e4) {
    ...
    if (r(i2))
      return i2;
    const { default: s4 } = await import("./FeatureFilter-6V257IN4.js"), a2 = new s4({ geometryType: e4.geometryType, hasM: false, hasZ: false, timeInfo: e4.timeInfo, fieldsIndex: new r2(e4.fields) });
...
//# sourceMappingURL=chunk-GSFOZZVA.js.map

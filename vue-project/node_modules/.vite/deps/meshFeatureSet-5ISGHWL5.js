...
import "./chunk-IMB5WKZJ.js";
import {
  r as r3
} from "./chunk-WYUZTDRH.js";
import "./chunk-W6C3QHXL.js";
import {
  L as L2,
  L2 as L3,
  M,
...
async function u2(e5, s4, o2) {
  const { loadGLTFMesh: n3 } = await y2(import("./loadGLTFMesh-6NI2CMP2.js"), o2), a7 = await m4(s4, o2), i2 = n3(new w({ x: 0, y: 0, z: 0, spatialReference: e5.spatialReference }), a7.url, { resolveFile: f6(a7), useTransform: true, signal: r(o2) ? o2.signal : null });
...
async function w3(e5, t2) {
  const { default: s4 } = await y2(import("./request-PV3VIPXP.js"), t2), o2 = "string" == typeof e5.multipart[0] ? await Promise.all(e5.multipart.map(async (e6) => (await s4(e6, { responseType: "array-buffer" })).data)) : e5.multipart;
...
var B = G2 = class extends a4(m2.LoadableMixin(m(p2))) {
  ...
  async toBinaryGLTF(e5) {
    const t2 = import("./gltfexport-E7NTZXYP.js"), r6 = this.load(), o2 = await Promise.all([t2, r6]), { toBinaryGLTF: n3 } = o2[0];
    return n3(this, e5);
  }
  ...
  static async createFromGLTF(e5, r6, o2) {
    ...
    const { loadGLTFMesh: s4 } = await y2(import("./loadGLTFMesh-6NI2CMP2.js"), o2);
...
//# sourceMappingURL=meshFeatureSet-5ISGHWL5.js.map

import {
  s as s5,
  x
} from "./chunk-DNMUMKYV.js";
import {
  d,
  l as l5,
  t as t2
} from "./chunk-DLKP3YK7.js";
import {
  l as l3
...
function y2(e2) {
  for (const r4 in e2) {
    const a3 = e2[r4];
    false === (a3 == null ? void 0 : a3.destroyed) && a3.destroy(), delete e2[r4];
  }
}
function m2(a3, t6) {
  let n5;
  if ("string" == typeof a3) {
    if (!(a3 in s5)) {
      const e2 = Object.entries(s5).filter(([e3, a4]) => s.apiKey && !a4.classic || !s.apiKey && a4.classic && !a4.deprecated).map(([e3]) => `"${e3}"`).join(", ");
      return f2.warn(`Unable to find basemap definition for: ${a3}. Try one of these: ${e2}`), null;
    }
    t6 && (n5 = t6[a3]), n5 || (n5 = x.fromId(a3), t6 && (t6[a3] = n5));
  } else
    n5 = b(x, a3);
  return (n5 == null ? void 0 : n5.destroyed) && (f2.warn("The provided basemap is already destroyed", { basemap: n5 }), n5 = null), n5;
}
function v3(e2) {
  return !!(e2 == null ? void 0 : e2.baseLayers.concat(e2.referenceLayers).some(S));
}
function S(e2) {
  var _a;
  if (I(e2.url))
  ...
  if ("vector-tile" === e2.type)
    for (const r4 in e2.sourceNameToSource) {
      if (I((_a = e2.sourceNameToSource[r4]) == null ? void 0 : _a.sourceUrl))
        return true;
    }
  return false;
}
function h(e2, r4) {
  ...
  if (0 === r4.baseLayers.length)
    return { spatialReference: null, updating: false };
  const a3 = r4.baseLayers.getItemAt(0);
  switch (a3.loadStatus) {
    case "not-loaded":
      a3.load();
    case "loading":
  ...
  const t6 = (("supportedSpatialReferences" in a3 ? a3.supportedSpatialReferences : null) || ["tileInfo" in a3 ? (_a = a3.tileInfo) == null ? void 0 : _a.spatialReference : a3.spatialReference]).filter(Boolean), i2 = e2.spatialReference;
...
e([o({ none: "none", stayAbove: "stay-above" })], p3.prototype, "type", void 0), p3 = t3 = e([a("esri.ground.NavigationConstraint")], p3);
...
var S2 = C = class extends u(m) {
  ...
  async queryElevation(r4, e2) {
    ...
    const { ElevationQuery: o3 } = await import("./ElevationQuery-IWFG3EV7.js");
    f(e2);
  ...
  _loadLayersFromJSON(r4, e2, o3) {
    const t6 = e2 && e2.origin || "web-scene", s6 = e2 && e2.portal || null, a3 = e2 && e2.url || null;
    return import("./layersCreator-MKCECIKQ.js").then(({ populateOperationalLayers: e3 }) => {
      f(o3);
      const i2 = [];
      if (r4.layers && Array.isArray(r4.layers)) {
        const o4 = { context: { origin: t6, url: a3, portal: s6, layerContainerType: "ground" }, defaultLayerType: "ArcGISTiledElevationServiceLayer" };
...
function A(r4) {
  return "elevation" === r4.type || I2(r4);
}
e([y({ json: { read: false } })], S2.prototype, "layers", null), e([r("layers")], S2.prototype, "writeLayers", null), e([y({ readOnly: true })], S2.prototype, "resourceInfo", void 0), e([y({ type: Number, nonNullable: true, range: { min: 0, max: 1 }, json: { type: T, read: { reader: r2, source: "transparency" }, write: { writer: (r4, e2) => {
  e2.transparency = n3(r4);
}, target: "transparency" } } })], S2.prototype, "opacity", void 0), e([y({ type: Boolean, nonNullable: true, json: { read: false } })], S2.prototype, "shading", void 0), e([y({ type: l2, json: { type: [T], write: (r4, e2) => {
  e2.surfaceColor = r4.toJSON().slice(0, 3);
} } })], S2.prototype, "surfaceColor", void 0), e([y({ type: p3, json: { write: true } })], S2.prototype, "navigationConstraint", void 0), S2 = C = e([a("esri.Ground")], S2);
var L = S2;
...
function t5(t6) {
  ...
  if ("string" == typeof t6)
    if (t6 in i) {
      const r4 = i[t6];
      a3 = new L({ resourceInfo: { data: { layers: [r4] } } });
    } else
...
var j2 = class extends l5(d(n.EventedMixin(v))) {
  constructor(s6) {
    ...
    }, getChildrenFunction: (s7) => "layers" in s7 ? s7.layers : null }), this.allTables = t2(this), this.basemap = null, this.editableLayers = new l4({ getCollections: () => [this.allLayers], itemFilterFunction: n4 }), this.ground = new L(), this._basemapCache = p2();
  }
  destroy() {
    var _a, _b;
...
var p4;
var a2 = p4 = class extends l {
  constructor(o3) {
    super(o3), this.color = new l2([0, 0, 0, 1]);
  }
  clone() {
    return new p4(p({ color: this.color }));
  }
};
e([y({ type: l2, json: { write: true } })], a2.prototype, "color", void 0), a2 = p4 = e([a("esri.webmap.background.ColorBackground")], a2);
var m3 = a2;
...
//# sourceMappingURL=chunk-OQUBYICV.js.map

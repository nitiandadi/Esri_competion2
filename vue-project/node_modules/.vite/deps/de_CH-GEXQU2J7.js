    ...
    if ("string" != typeof t2 && !Array.isArray(t2)) {
      for (const r3 in t2)
        if ("default" !== r3 && !(r3 in e)) {
          const n3 = Object.getOwnPropertyDescriptor(t2, r3);
          n3 && Object.defineProperty(e, r3, n3.get ? n3 : { enumerable: true, get: () => t2[r3] });
        }
    }
  }
...
var s = n({ __proto__: null, default: o(i) }, [i]);
export {
  s as d
};
//# sourceMappingURL=de_CH-GEXQU2J7.js.map

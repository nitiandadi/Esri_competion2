...
async function j(e2, o) {
  ...
  if (!e2.isPrimitive) {
    ...
    if (void 0 !== o2)
      return o2;
    const t2 = await import("./objectResourceUtils-R5RGENYR.js"), i2 = await t2.fetch(r2, { disableTextures: true });
    return a2.put(r2, i2.referenceBoundingBox), i2.referenceBoundingBox;
  }
  let i = null;
  if (e2.resource && e2.resource.primitive && (i = a(c2(e2.resource.primitive)), r(o)))
...
//# sourceMappingURL=symbolLayerUtils-3IMBJXQB.js.map

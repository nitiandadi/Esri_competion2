...
var o2 = import("./labelFormatUtils-VE6CFIF7.js");
var c = class {
  constructor(e2, s3) {
  ...
  async updateSchema(r3, a4) {
    ...
    if (this._schema = a4, !a4 || t(o3) || !a2(o3, "attributes"))
      return;
...
var g = class extends c {
  ...
  onTileData(t2, e2) {
    ...
    for (; a4.next(); )
      this._insertFeature(a4, t2.scale);
...
//# sourceMappingURL=chunk-O5H6UTGQ.js.map

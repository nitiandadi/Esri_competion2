...
function w(p2) {
  let u2;
  return p2 ? (u2 = r(p2, (e) => n + '$feature["' + e + '"]' + r2), u2 = o.test(u2) ? u2.replace(o, "") : l + u2, u2 = i.test(u2) ? u2.replace(i, "") : u2 + l, u2 = u2.replace(s, a).replace(t, c)) : u2 = '""', u2;
}
var E = /^\s*\{([^}]+)\}\s*$/i;
function $(e) {
...
//# sourceMappingURL=chunk-XKQGIVQO.js.map

...
async function B() {
  has("host-webworker") ? j2 || (j2 = await import("./request-SXXHWMHV.js")) : U._abortableFetch || (U._abortableFetch = globalThis.fetch.bind(globalThis));
}
async function $() {
  r2 || await import("./IdentityManager-4WK5YXFE.js");
}
async function z(r4) {
  var _a;
...
//# sourceMappingURL=chunk-2HZTCGYV.js.map

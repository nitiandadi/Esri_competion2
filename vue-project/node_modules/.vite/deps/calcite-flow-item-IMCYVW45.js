...
var Panel = proxyCustomElement(class extends H {
  ...
  renderHeaderActionsEnd() {
    ...
    const closableNode = closable ? h("calcite-action", { "aria-label": text, icon: ICONS2.close, onClick: close, ref: this.setCloseRef, text }) : null;
    ...
    return h("div", { class: { [CSS3.headerActionsEnd]: true, [CSS3.headerActions]: true }, hidden: !showContainer, key: "header-actions-end" }, slotNode, closableNode);
  }
  renderMenu() {
  ...
  renderHeaderNode() {
    ...
    return h("header", { class: CSS3.header, hidden: !showHeader }, this.renderHeaderStartActions(), this.renderHeaderSlottedContent(), headerContentNode, this.renderHeaderActionsEnd(), this.renderMenu());
  }
  renderFooterNode() {
  ...
  renderContent() {
    ...
    const containerNode = hasFab ? h("section", { class: CSS3.contentContainer }, defaultSlotNode) : defaultSlotNode;
    return h("div", { class: {
      [CSS3.contentWrapper]: true,
      [CSS3.contentContainer]: !hasFab,
      [CSS3.contentHeight]: hasFab
  ...
  render() {
    ...
    const panelNode = h("article", { "aria-busy": toAriaBoolean(loading), class: CSS3.container, hidden: closed, onKeyDown: panelKeyDownHandler, ref: this.setContainerRef, tabIndex: closable ? 0 : -1 }, this.renderHeaderNode(), this.renderContent(), this.renderFooterNode());
...
var FlowItem = proxyCustomElement(class extends H {
  ...
  renderBackButton() {
    ...
    return showBackButton ? h("calcite-action", { "aria-label": label, class: CSS4.backButton, icon, key: "flow-back-button", onClick: backButtonClick, ref: this.setBackRef, scale: "s", slot: "header-actions-start", text: label }) : null;
  }
  render() {
...
@esri/calcite-components/dist/components/calcite-flow-item.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-flow-item-IMCYVW45.js.map

...
e = x, n = function() {
  function e2(e3, t3, x3) {
    x3 = x3 || 2;
    var i2, u2, v2, y2, o2, p2, a2, l2 = t3 && t3.length, h2 = l2 ? t3[0] * x3 : e3.length, s2 = n2(e3, 0, h2, x3, true), c2 = [];
    if (!s2 || s2.next === s2.prev)
      return c2;
    if (l2 && (s2 = f(e3, t3, s2, x3)), e3.length > 80 * x3) {
      i2 = v2 = e3[0], u2 = y2 = e3[1];
      for (var Z2 = x3; Z2 < h2; Z2 += x3)
        (o2 = e3[Z2]) < i2 && (i2 = o2), (p2 = e3[Z2 + 1]) < u2 && (u2 = p2), o2 > v2 && (v2 = o2), p2 > y2 && (y2 = p2);
  ...
  function t2(e3, n3) {
    ...
    var t3, r3 = e3;
    do {
      if (t3 = false, r3.steiner || !M(r3, r3.next) && 0 !== w(r3.prev, r3, r3.next))
        r3 = r3.next;
      else {
        var x3 = r3.prev;
  ...
  function r2(e3, n3, f2, y2, o2, p2, a2) {
    if (e3) {
      !a2 && p2 && h(e3, y2, o2, p2);
      for (var l2, s2, c2 = e3; e3.prev !== e3.next; )
        if (l2 = e3.prev, s2 = e3.next, p2 ? i(e3, y2, o2, p2) : x2(e3))
          n3.push(l2.i / f2), n3.push(e3.i / f2), n3.push(s2.i / f2), C(e3), e3 = s2.next, c2 = s2.next;
        else if ((e3 = s2) === c2) {
          a2 ? 1 === a2 ? r2(e3 = u(t2(e3), n3, f2), n3, f2, y2, o2, p2, 2) : 2 === a2 && v(e3, n3, f2, y2, o2, p2) : r2(t2(e3), n3, f2, y2, o2, p2, 1);
          break;
        }
    }
  }
  ...
  function i(e3, n3, t3, r3) {
    ...
    if (w(x3, i2, u2) >= 0)
      return false;
    for (var v2 = x3.x < i2.x ? x3.x < u2.x ? x3.x : u2.x : i2.x < u2.x ? i2.x : u2.x, f2 = x3.y < i2.y ? x3.y < u2.y ? x3.y : u2.y : i2.y < u2.y ? i2.y : u2.y, y2 = x3.x > i2.x ? x3.x > u2.x ? x3.x : u2.x : i2.x > u2.x ? i2.x : u2.x, o2 = x3.y > i2.y ? x3.y > u2.y ? x3.y : u2.y : i2.y > u2.y ? i2.y : u2.y, p2 = c(v2, f2, n3, t3, r3), a2 = c(y2, o2, n3, t3, r3), l2 = e3.prevZ, h2 = e3.nextZ; l2 && l2.z >= p2 && h2 && h2.z <= a2; ) {
    ...
    do {
      for (var y2 = f2.next.next; y2 !== f2.prev; ) {
        if (f2.i !== y2.i && d(f2, y2)) {
          var o2 = A(f2, y2);
          return f2 = t2(f2, f2.next), o2 = t2(o2, o2.next), r2(f2, n3, x3, i2, u2, v2), void r2(o2, n3, x3, i2, u2, v2);
        }
        y2 = y2.next;
      }
      f2 = f2.next;
  ...
  function f(e3, r3, x3, i2) {
    ...
    for (u2 = 0, v2 = r3.length; u2 < v2; u2++)
      (f2 = n2(e3, r3[u2] * i2, u2 < v2 - 1 ? r3[u2 + 1] * i2 : e3.length, i2, false)) === f2.next && (f2.steiner = true), o2.push(Z(f2));
    for (o2.sort(y), u2 = 0; u2 < o2.length; u2++)
      x3 = t2(x3 = p(o2[u2], x3), x3.next);
    return x3;
  }
  function y(e3, n3) {
    return e3.x - n3.x;
  ...
  function p(e3, n3) {
    ...
    let u2 = o(x3);
    return t2(u2, u2.next), i2 = o(i2), o(n3 === r3 ? i2 : n3);
  }
  function a(e3, n3) {
    ...
    if (x3 === u2)
      return t3;
    var f2, y2 = t3, o2 = t3.x, p2 = t3.y, a2 = 1 / 0;
    r3 = t3;
    do {
      x3 >= r3.x && r3.x >= o2 && x3 !== r3.x && g(i2 < p2 ? x3 : u2, i2, o2, p2, i2 < p2 ? u2 : x3, i2, r3.x, r3.y) && (f2 = Math.abs(i2 - r3.y) / (x3 - r3.x), j(r3, e3) && (f2 < a2 || f2 === a2 && (r3.x > t3.x || r3.x === t3.x && l(t3, r3))) && (t3 = r3, a2 = f2)), r3 = r3.next;
    } while (r3 !== y2);
    return t3;
  }
  function l(e3, n3) {
  ...
  function s(e3) {
    var n3, t3, r3, x3, i2, u2, v2, f2, y2 = 1;
    do {
      for (t3 = e3, e3 = null, i2 = null, u2 = 0; t3; ) {
        for (u2++, r3 = t3, v2 = 0, n3 = 0; n3 < y2 && (v2++, r3 = r3.nextZ); n3++)
          ;
        for (f2 = y2; v2 > 0 || f2 > 0 && r3; )
          0 !== v2 && (0 === f2 || !r3 || t3.z <= r3.z) ? (x3 = t3, t3 = t3.nextZ, v2--) : (x3 = r3, r3 = r3.nextZ, f2--), i2 ? i2.nextZ = x3 : e3 = x3, x3.prevZ = i2, i2 = x3;
        t3 = r3;
      }
      i2.nextZ = null, y2 *= 2;
    } while (u2 > 1);
  ...
  function z(e3, n3, t3, r3) {
    ...
    return x3 !== i2 && u2 !== v2 || !(0 !== x3 || !b(e3, t3, n3)) || !(0 !== i2 || !b(e3, r3, n3)) || !(0 !== u2 || !b(t3, e3, r3)) || !(0 !== v2 || !b(t3, n3, r3));
  }
  function b(e3, n3, t3) {
  ...
  return e2.deviation = function(e3, n3, t3, r3) {
    ...
    if (x3)
      for (var v2 = 0, f2 = n3.length; v2 < f2; v2++) {
        var y2 = n3[v2] * t3, o2 = v2 < f2 - 1 ? n3[v2 + 1] * t3 : e3.length;
        u2 -= Math.abs(E(e3, y2, o2, t3));
      }
    var p2 = 0;
...
}, void 0 !== (t = n()) && (e.exports = t);

export {
  r
};
//# sourceMappingURL=chunk-TQAOUM4T.js.map

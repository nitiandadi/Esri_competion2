    ...
    if ("string" != typeof i2 && !Array.isArray(i2)) {
      for (const r3 in i2)
        if ("default" !== r3 && !(r3 in e)) {
          const a3 = Object.getOwnPropertyDescriptor(i2, r3);
          a3 && Object.defineProperty(e, r3, a3.get ? a3 : { enumerable: true, get: () => i2[r3] });
        }
    }
  }
...
var n = a({ __proto__: null, default: o(t) }, [t]);
export {
  n as i
};
//# sourceMappingURL=it_IT-WLLSAQBD.js.map

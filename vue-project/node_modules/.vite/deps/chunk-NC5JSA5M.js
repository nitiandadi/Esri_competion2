import {
  s as s2,
  t as t3
} from "./chunk-RN2PJR6V.js";
import {
  t as t2
} from "./chunk-F5GNISRI.js";
import {
  A,
  B as B2,
  C,
...
import {
  ...
  s,
  u as u2
} from "./chunk-SLEDTZY7.js";
import {
  a as a2,
  c,
  r
} from "./chunk-OSHKHCXS.js";
import {
  B,
  G,
  J,
...
async function yn(n, t4) {
  ...
  if ("polyline" === n.type)
    ...
    "extent" === n.type && (r2 += 2 * e2([n.xmin, n.ymin, 0], [n.xmax, n.ymin, 0], e3), r2 += 2 * e2([n.xmin, n.ymin, 0], [n.xmin, n.ymax, 0], e3), r2 *= 2, r2 += 4 * Math.abs(Z(n.zmax, 0) * e3 - Z(n.zmin, 0) * e3));
...
function pn(n) {
  "async" === n.mode && (n.functions.disjoint = function(t4, e3) {
    ...
    return n.standardFunctionAsync(t4, e3, (n2, r2, o) => {
      if (o = be(o), B(o, 3, 3, t4, e3), o[0] instanceof p && o[1] instanceof p)
        return R(o[0], o[1], re(o[2]));
    ...
    return n.standardFunctionAsync(e3, r2, (n2, a3, o) => {
      ...
      if (1 === o.length)
        if (J(o[0])) {
          ...
          if (!V(o[0])) {
            if (o[0] instanceof p)
              return ce(c(o[0]), e3.spatialReference);
            if (null === o[0])
              return null;
            throw new t(e3, e.InvalidParameter, r2);
          }
    ...
    return n.standardFunctionAsync(t4, e3, (n2, r2, o) => {
      if (o = be(o), B(o, 2, 2, t4, e3), !(o[1] instanceof w2) && null !== o[1])
        throw new t(t4, e.InvalidParameter, e3);
      if (null === o[0])
        return null;
      if (!(o[0] instanceof p))
    ...
    return n.standardFunctionAsync(e3, r2, (n2, o, s3) => {
      if (s3 = be(s3), B(s3, 2, 2, e3, r2), !(s3[1] instanceof m) && null !== s3[1])
        throw new t(e3, e.InvalidParameter, r2);
      if (null === s3[0])
        return [];
    ...
    return n.standardFunctionAsync(t4, r2, async (n2, o, s3) => {
      if (B(s3, 1, 2, t4, r2), null === (s3 = be(s3))[0])
        return 0;
      if (G(s3[0])) {
    ...
    return n.standardFunctionAsync(t4, e3, async (n2, o, s3) => {
      if (B(s3, 1, 2, t4, e3), null === (s3 = be(s3))[0])
        return 0;
      if (G(s3[0])) {
    ...
    return n.standardFunctionAsync(t4, e3, (n2, o, s3) => {
      ...
      let f = s3[1];
      if ((J(s3[1]) || V(s3[1])) && (f = Te(s3[1], t4.spatialReference)), !(c2 instanceof p))
        throw new t(t4, e.InvalidParameter, e3);
      if (!(f instanceof p))
        throw new t(t4, e.InvalidParameter, e3);
    ...
    return n.standardFunctionAsync(t4, e3, (n2, o, s3) => {
      if (s3 = be(s3), B(s3, 2, 3, t4, e3), null === s3[0])
        return null;
      if (!(s3[0] instanceof p))
        throw new t(t4, e.InvalidParameter, e3);
      const l2 = le(s3[1]);
    ...
    return n.standardFunctionAsync(t4, e3, (n2, o, s3) => {
      if (s3 = be(s3), B(s3, 2, 4, t4, e3), null === s3[0])
        return null;
      if (!(s3[0] instanceof p))
        throw new t(t4, e.InvalidParameter, e3);
      const l2 = le(s3[1]);
    ...
    return n.standardFunctionAsync(e3, o, (n2, s3, l2) => {
      if (l2 = be(l2), B(l2, 2, 3, e3, o), null === l2[0])
        return null;
    ...
    return n.standardFunctionAsync(t4, e3, (n2, o, l2) => {
      if (l2 = be(l2), B(l2, 2, 6, t4, e3), null === l2[0])
        return null;
    ...
    return n.standardFunctionAsync(e3, r2, (n2, o, s3) => {
      if (s3 = be(s3), B(s3, 1, 1, e3, r2), null === s3[0])
        return null;
      let f = s3[0];
      if ((J(s3[0]) || V(s3[0])) && (f = Te(s3[0], e3.spatialReference)), null === f)
        return null;
      if (!(f instanceof p))
        throw new t(e3, e.InvalidParameter, r2);
    ...
    return n.standardFunctionAsync(e3, r2, async (n2, o, s3) => {
      ...
      if (!(s3[0] instanceof p))
        throw new t(e3, e.InvalidParameter, r2);
      if (s3[0] instanceof w)
        return [ce(c(s3[0]), e3.spatialReference)];
      if (s3[0] instanceof w2)
        return [ce(c(s3[0]), e3.spatialReference)];
    ...
    return n.standardFunctionAsync(t4, e3, (n2, r2, o) => {
      if (o = be(o), B(o, 1, 1, t4, e3), null === o[0])
        return true;
      if (!(o[0] instanceof p))
        throw new t(t4, e.InvalidParameter, e3);
      return J2(o[0]);
...
//# sourceMappingURL=chunk-NC5JSA5M.js.map

...
function _2() {
  var t4, e6, a3, r4 = 0, _4 = 0, v2 = s2, j2 = [], x2 = [], D2 = 1, R2 = 0, T2 = 0, A2 = false, G2 = false, S2 = "";
  return function(t5) {
  ...
  function F2(e7) {
    ...
    return _4 += r4, S2 = S2.slice(r4), x2;
  }
  function L2(t5) {
    return j2.length && X2(j2.join("")), v2 = b, X2("(eof)"), x2;
  }
  function C2() {
    return j2 = j2.length ? [] : j2, "/" === e6 && "*" === t4 ? (T2 = _4 + r4 - 1, v2 = p, e6 = t4, r4 + 1) : "/" === e6 && "/" === t4 ? (T2 = _4 + r4 - 1, v2 = u, e6 = t4, r4 + 1) : "#" === t4 ? (v2 = d, T2 = _4 + r4, r4) : /\s/.test(t4) ? (v2 = m, T2 = _4 + r4, r4) : (A2 = /\d/.test(t4), G2 = /[^\w_]/.test(t4), T2 = _4 + r4, v2 = A2 ? l2 : G2 ? f : c3, r4);
  }
  function H3() {
    return /[^\s]/g.test(t4) ? (X2(j2.join("")), v2 = s2, r4) : (j2.push(t4), e6 = t4, r4 + 1);
  }
  function M2() {
    return "\r" !== t4 && "\n" !== t4 || "\\" === e6 ? (j2.push(t4), e6 = t4, r4 + 1) : (X2(j2.join("")), v2 = s2, r4);
  }
  function P() {
    return M2();
  }
  function V() {
    return "/" === t4 && "*" === e6 ? (j2.push(t4), X2(j2.join("")), v2 = s2, r4 + 1) : (j2.push(t4), e6 = t4, r4 + 1);
  }
  function O() {
    if ("." === e6 && /\d/.test(t4))
      return v2 = h, r4;
  ...
  function N(t5) {
    for (var e7, a4, r5 = 0; ; ) {
      if (e7 = i.indexOf(t5.slice(0, t5.length + r5).join("")), a4 = i[e7], -1 === e7) {
        if (r5-- + t5.length > 0)
          continue;
  ...
  function $() {
    return /[^a-fA-F0-9]/.test(t4) ? (X2(j2.join("")), v2 = s2, r4) : (j2.push(t4), e6 = t4, r4 + 1);
  }
  function z() {
    return "." === t4 || /[eE]/.test(t4) ? (j2.push(t4), v2 = h, e6 = t4, r4 + 1) : "x" === t4 && 1 === j2.length && "0" === j2[0] ? (v2 = k, j2.push(t4), e6 = t4, r4 + 1) : /[^\d]/.test(t4) ? (X2(j2.join("")), v2 = s2, r4) : (j2.push(t4), e6 = t4, r4 + 1);
  }
  function I() {
    return "f" === t4 && (j2.push(t4), e6 = t4, r4 += 1), /[eE]/.test(t4) || "-" === t4 && /[eE]/.test(e6) ? (j2.push(t4), e6 = t4, r4 + 1) : /[^\d]/.test(t4) ? (X2(j2.join("")), v2 = s2, r4) : (j2.push(t4), e6 = t4, r4 + 1);
  }
  function U() {
    if (/[^\d\w_]/.test(t4)) {
      var a4 = j2.join("");
      return v2 = o.indexOf(a4) > -1 ? g2 : _.indexOf(a4) > -1 ? w : y, X2(j2.join("")), v2 = s2, r4;
    }
    return j2.push(t4), e6 = t4, r4 + 1;
  }
}
...
function R(t4, e6 = "100", a3 = "300 es") {
  ...
  for (const n2 of t4)
    if ("preprocessor" === n2.type) {
      const t5 = r4.exec(n2.data);
      if (t5) {
        const r5 = t5[1].replace(/\s\s+/g, " ");
        if (r5 === a3)
          return r5;
        if (r5 === e6)
          return n2.data = "#version " + a3, e6;
...
function G(t4, e6, a3 = "afterVersion") {
  ...
  function n2(t5) {
    ...
    for (let i3 = 0; i3 < t5.length; i3++) {
      const s4 = t5[i3];
      if ("preprocessor" === s4.type && (s4.data.match(/\#(if|ifdef|ifndef)\s+.+/) ? ++n3 : s4.data.match(/\#endif\s*.*/) && --n3), "afterVersion" !== a3 && "afterPrecision" !== a3 || "preprocessor" === s4.type && /^#version/.test(s4.data) && (o3 = Math.max(o3, i3)), "afterPrecision" === a3 && "keyword" === s4.type && "precision" === s4.data) {
        const e8 = r4(t5, i3);
        if (null === e8)
  ...
  let s3 = n2(t4);
  i2(s3 - 1) && t4.splice(s3++, 0, o2);
  for (const c5 of e6)
    t4.splice(s3++, 0, c5);
  i2(s3 - 1) && i2(s3) && t4.splice(s3, 0, o2);
}
...
function X(t4, e6, a3, r4, n2 = "lowp") {
  G(t4, [{ type: "keyword", data: "layout" }, { type: "operator", data: "(" }, { type: "keyword", data: "location" }, { type: "whitespace", data: " " }, { type: "operator", data: "=" }, { type: "whitespace", data: " " }, { type: "integer", data: r4.toString() }, { type: "operator", data: ")" }, { type: "whitespace", data: " " }, { type: "keyword", data: "out" }, { type: "whitespace", data: " " }, { type: "keyword", data: n2 }, { type: "whitespace", data: " " }, { type: "keyword", data: a3 }, { type: "whitespace", data: " " }, { type: "ident", data: e6 }, { type: "operator", data: ";" }], "afterPrecision");
}
function F(t4, e6) {
  let a3, r4, n2 = -1;
  for (let o2 = e6; o2 < t4.length; o2++) {
    ...
    "integer" === e7.type && (n2 = parseInt(e7.data, 10));
  }
  return a3 && r4 && t4.splice(a3, r4 - a3 + 1), n2;
}
function L(r4, n2) {
  const o2 = H2(r4);
  if (r(o2))
  ...
  for (let t4 = 0; t4 < i2.length; ++t4) {
    ...
    switch (r5.type) {
      case "keyword":
        n2 === H.VERTEX_SHADER && "attribute" === r5.data ? r5.data = "in" : "varying" === r5.data && (r5.data = n2 === H.VERTEX_SHADER ? "out" : "in");
        break;
      case "builtin":
        if (/^texture(2D|Cube)(Proj)?(Lod|Grad)?(EXT)?$/.test(r5.data.trim()) && (r5.data = r5.data.replace(/(2D|Cube|EXT)/g, "")), n2 === H.FRAGMENT_SHADER && "gl_FragColor" === r5.data && (s3 || (s3 = A(i2, p2, "fragColor"), S(i2, s3, "vec4")), r5.data = s3), n2 === H.FRAGMENT_SHADER && "gl_FragData" === r5.data) {
          const e6 = F(i2, t4 + 1), a3 = A(i2, p2, "fragData");
          X(i2, a3, "vec4", e6, "mediump"), r5.data = a3;
        } else
          n2 === H.FRAGMENT_SHADER && "gl_FragDepthEXT" === r5.data && (c5 || (c5 = A(i2, p2, "gl_FragDepth")), r5.data = c5);
        break;
      case "ident":
        if (e2.includes(r5.data)) {
          if (n2 === H.VERTEX_SHADER && T(i2, t4))
  ...
  for (let t4 = i2.length - 1; t4 >= 0; --t4) {
    ...
    if ("preprocessor" === e6.type) {
      ...
      const n3 = e6.data.match(/\#ifndef\s+(.*)/);
      n3 && n3[1] && D.includes(n3[1].trim()) && (e6.data = "#if 0");
    }
  }
  return M(r4, x(i2));
}
...
function H2(t4) {
  return e3.enableCache ? C.get(t4) : null;
}
function M(t4, e6) {
  return e3.enableCache && C.set(t4, e6), e6;
}

// node_modules/@arcgis/core/views/webgl/Program.js
var a2 = 4294967295;
var h2 = class {
  constructor(t4, o2, i2, h3, c5 = /* @__PURE__ */ new Map()) {
    this._context = t4, this._locations = h3, this._uniformBlockBindings = c5, this._refCount = 1, this._compiled = false, this._nameToUniformLocation = {}, this._nameToUniform1 = {}, this._nameToUniform1v = /* @__PURE__ */ new Map(), this._nameToUniform2 = /* @__PURE__ */ new Map(), this._nameToUniform3 = /* @__PURE__ */ new Map(), this._nameToUniform4 = /* @__PURE__ */ new Map(), this._nameToUniformMatrix3 = /* @__PURE__ */ new Map(), this._nameToUniformMatrix4 = /* @__PURE__ */ new Map(), t4 || console.error("RenderingContext isn't initialized!"), 0 === o2.length && console.error("Shaders source should not be empty!"), this._context.type === r2.WEBGL2 && (o2 = L(o2, H.VERTEX_SHADER), i2 = L(i2, H.FRAGMENT_SHADER)), this._vShader = f2(this._context, H.VERTEX_SHADER, o2), this._fShader = f2(this._context, H.FRAGMENT_SHADER, i2), this._vShader && this._fShader || console.error("Error loading shaders!"), this._context.instanceCounter.increment(t2.Shader, this), c2() && (this.vertexShader = o2, this.fragmentShader = i2);
    const _4 = this._context.gl, g4 = _4.createProgram();
    if (_4.attachShader(g4, this._vShader), _4.attachShader(g4, this._fShader), this._locations.forEach((t5, o3) => _4.bindAttribLocation(g4, t5, o3)), _4.linkProgram(g4), c2() && !_4.getProgramParameter(g4, _4.LINK_STATUS) && console.error(`Could not link shader
validated: ${_4.getProgramParameter(g4, _4.VALIDATE_STATUS)}, gl error ${_4.getError()}, vertex: ${_4.getShaderParameter(this._vShader, _4.COMPILE_STATUS)}, fragment: ${_4.getShaderParameter(this._fShader, _4.COMPILE_STATUS)}, info log: ${_4.getProgramInfoLog(g4)}, vertex source: ${this.vertexShader}, fragment source: ${this.fragmentShader}`), this._context.type === r2.WEBGL2) {
      const t5 = _4;
      for (const [o3, i3] of this._uniformBlockBindings) {
        const e6 = t5.getUniformBlockIndex(g4, o3);
        e6 < a2 && t5.uniformBlockBinding(g4, e6, i3);
      }
    }
    this._glName = g4, this._context.instanceCounter.increment(t2.Program, this);
  }
  get glName() {
    return this._glName;
  }
  ...
  get compiled() {
    ...
    return null == t4 || t(this.glName) ? (this._compiled = true, true) : (this._compiled = !!this._context.gl.getProgramParameter(this.glName, t4.COMPLETION_STATUS_KHR), this._compiled);
  }
  dispose() {
    if (--this._refCount > 0)
      return;
  ...
  _getUniformLocation(t4) {
    return void 0 === this._nameToUniformLocation[t4] && r(this.glName) && (++l3.numUniforms, this._nameToUniformLocation[t4] = this._context.gl.getUniformLocation(this.glName, t4)), this._nameToUniformLocation[t4];
  }
  hasUniform(t4) {
  ...
  setUniform3f(t4, o2, i2, e6) {
    const n2 = this._nameToUniform3.get(t4);
    void 0 === n2 ? (this._context.gl.uniform3f(this._getUniformLocation(t4), o2, i2, e6), this._nameToUniform3[t4] = [o2, i2, e6]) : o2 === n2[0] && i2 === n2[1] && e6 === n2[2] || (this._context.gl.uniform3f(this._getUniformLocation(t4), o2, i2, e6), n2[0] = o2, n2[1] = i2, n2[2] = e6);
  }
  setUniform3fv(t4, o2) {
    g3(this._nameToUniform3, t4, o2) && this._context.gl.uniform3fv(this._getUniformLocation(t4), o2);
  }
  setUniform4f(t4, o2, i2, e6, n2) {
    const r4 = this._nameToUniform4.get(t4);
    void 0 === r4 ? (this._context.gl.uniform4f(this._getUniformLocation(t4), o2, i2, e6, n2), this._nameToUniform4.set(t4, [o2, i2, e6, n2])) : void 0 !== r4 && o2 === r4[0] && i2 === r4[1] && e6 === r4[2] && n2 === r4[3] || (this._context.gl.uniform4f(this._getUniformLocation(t4), o2, i2, e6, n2), r4[0] = o2, r4[1] = i2, r4[2] = e6, r4[3] = n2);
  }
  setUniform4fv(t4, o2) {
...
function f2(t4, o2, i2) {
  const n2 = t4.gl, s3 = n2.createShader(o2);
  return n2.shaderSource(s3, i2), n2.compileShader(s3), c2() && !n2.getShaderParameter(s3, n2.COMPILE_STATUS) && (console.error("Compile error in ".concat(o2 === H.VERTEX_SHADER ? "vertex" : "fragment", " shader")), console.error(n2.getShaderInfoLog(s3)), console.error(c4(i2))), l3.enabled && (l3.compiledLOC += i2.match(/\n/g).length + 1), s3;
}
function c4(t4) {
  let o2 = 2;
  return t4.replace(/\n/g, () => "\n" + _3(o2++) + ":");
...
function g3(o2, i2, e6) {
  const n2 = o2.get(i2);
  return n2 ? c(n2, e6) : (o2.set(i2, Array.from(e6)), true);
}
...
var e4 = class {
  ...
  _resolve(e6, t4 = /* @__PURE__ */ new Map()) {
    ...
    const l4 = [];
    for (; null != n2; )
      l4.push({ path: n2[1], start: n2.index, length: n2[0].length }), n2 = s3.exec(r4);
    let a3 = 0, h3 = "";
...
//# sourceMappingURL=chunk-7XVHXPW5.js.map

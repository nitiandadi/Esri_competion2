...
e2([y({ type: Number, json: { write: true } })], h.prototype, "density", void 0), e2([y({ type: l2, json: { write: { allowNull: true } } })], h.prototype, "color", void 0), e2([y({ type: Number, cast: o4, json: { write: true } })], h.prototype, "maxPathLength", void 0), e2([y({ type: Number, cast: o4, json: { write: true } })], h.prototype, "trailWidth", void 0), e2([y({ type: Number, json: { write: true } })], h.prototype, "flowSpeed", void 0), e2([y({ type: Number, json: { write: true } })], h.prototype, "trailLength", void 0), e2([y({ type: Number, cast: o4, json: { write: false } })], h.prototype, "smoothing", void 0), e2([y({ type: d3.apiValues, json: { type: d3.jsonValues, read: { reader: d3.read }, write: { writer: d3.write } } })], h.prototype, "flowRepresentation", void 0), e2([o3({ flowRenderer: "flow" })], h.prototype, "type", void 0), e2([y({ type: j, json: { write: true } })], h.prototype, "authoringInfo", void 0), e2([y({ type: p4, json: { write: true } })], h.prototype, "legendOptions", void 0), e2([y({ type: String, json: { write: true } })], h.prototype, "trailCap", void 0), e2([y({ type: String, json: { write: true } })], h.prototype, "background", void 0), h = c2 = e2([a("esri.renderers.FlowRenderer")], h);
var u3 = h;
...
e2([y({ type: Number, json: { write: true } })], l4.prototype, "value", void 0), e2([y({ type: String, json: { write: true } })], l4.prototype, "label", void 0), e2([y({ type: l2, json: { type: [T], write: true } })], l4.prototype, "color", void 0), l4 = e2([a("esri.renderers.support.ColormapInfo")], l4);
var c3 = l4;
...
e2([y({ type: [c3], json: { write: true } })], m5.prototype, "colormapInfos", void 0), e2([o3({ rasterColormap: "raster-colormap" })], m5.prototype, "type", void 0), m5 = c4 = e2([a("esri.renderers.RasterColormapRenderer")], m5);
var l5 = m5;
...
e2([y({ type: Number, json: { write: true } })], d4.prototype, "altitude", void 0), e2([y({ type: Number, json: { write: true } })], d4.prototype, "azimuth", void 0), e2([y({ types: m2, json: { write: true } })], d4.prototype, "colorRamp", void 0), e2([o("colorRamp")], d4.prototype, "readColorRamp", null), e2([y({ type: ["traditional", "multi-directional"], json: { write: true } })], d4.prototype, "hillshadeType", void 0), e2([y({ type: Number, json: { write: true } })], d4.prototype, "pixelSizePower", void 0), e2([y({ type: Number, json: { write: true } })], d4.prototype, "pixelSizeFactor", void 0), e2([y({ type: ["none", "adjusted"], json: { write: true } })], d4.prototype, "scalingType", void 0), e2([o3({ rasterShadedRelief: "raster-shaded-relief" })], d4.prototype, "type", void 0), e2([y({ type: Number, json: { write: true } })], d4.prototype, "zFactor", void 0), d4 = c5 = e2([a("esri.renderers.RasterShadedReliefRenderer")], d4);
var m6 = d4;
...
e2([y({ types: m2, json: { write: true } })], h2.prototype, "colorRamp", void 0), e2([o("colorRamp")], h2.prototype, "readColorRamp", null), e2([y({ type: Boolean, json: { write: true } })], h2.prototype, "computeGamma", void 0), e2([y({ type: Boolean, json: { write: { target: "dra" }, read: { source: "dra" } } })], h2.prototype, "dynamicRangeAdjustment", void 0), e2([y({ type: [Number], json: { write: true } })], h2.prototype, "gamma", void 0), e2([y({ type: Number, json: { write: true } })], h2.prototype, "maxPercent", void 0), e2([y({ type: Number, json: { write: true } })], h2.prototype, "minPercent", void 0), e2([y({ type: Number, json: { write: true } })], h2.prototype, "numberOfStandardDeviations", void 0), e2([y({ type: Number, json: { read: { source: "max" }, write: { target: "max" } } })], h2.prototype, "outputMax", void 0), e2([y({ type: Number, json: { read: { source: "min" }, write: { target: "min" } } })], h2.prototype, "outputMin", void 0), e2([y({ type: Number, json: { write: true } })], h2.prototype, "sigmoidStrengthLevel", void 0), e2([y({ json: { type: [[Number]], write: true } })], h2.prototype, "statistics", void 0), e2([y()], h2.prototype, "histograms", void 0), e2([r2("statistics")], h2.prototype, "writeStatistics", null), e2([y({ type: Boolean, json: { write: true } })], h2.prototype, "useGamma", void 0), e2([y({ type: n4.apiValues, json: { type: n4.jsonValues, write: n4.write } })], h2.prototype, "stretchType", void 0), e2([o("stretchType", ["stretchType"])], h2.prototype, "readStretchType", null), e2([o3({ rasterStretch: "raster-stretch" })], h2.prototype, "type", void 0), h2 = d5 = e2([a("esri.renderers.RasterStretchRenderer")], h2);
var y5 = h2;
...
e2([y({ type: String, json: { write: true } })], E.prototype, "attributeField", void 0), e2([y({ type: h3.apiValues, json: { type: h3.jsonValues, read: { reader: h3.read }, write: { writer: h3.write } } })], E.prototype, "flowRepresentation", void 0), e2([y({ type: ["geographic", "arithmetic"], json: { write: true } })], E.prototype, "rotationType", void 0), e2([y({ type: b2.apiValues, json: { type: b2.jsonValues, read: { reader: b2.read }, write: { writer: b2.write } } })], E.prototype, "style", void 0), e2([y({ json: { write: true } })], E.prototype, "symbolTileSize", void 0), e2([y({ type: c.apiValues, json: { type: c.jsonValues, write: { writer: c.write } } })], E.prototype, "inputUnit", void 0), e2([o("inputUnit")], E.prototype, "readInputUnit", null), e2([y({ type: c.apiValues, json: { type: c.jsonValues, read: { reader: c.read }, write: { writer: c.write } } })], E.prototype, "outputUnit", void 0), e2([o("outputUnit")], E.prototype, "readOutputUnit", null), e2([o3({ vectorField: "vector-field" })], E.prototype, "type", void 0), e2([y({ type: _ })], E.prototype, "styleRenderer", null), e2([y({ type: b })], E.prototype, "sizeVariables", null), e2([y({ type: n2 })], E.prototype, "rotationVariables", null), E = u4 = e2([a("esri.renderers.VectorFieldRenderer")], E);
var x2 = E;
...
e2([y({ json: { type: Object, name: "rasterFunctionArguments" } })], d7.prototype, "functionArguments", null), e2([o("functionArguments")], d7.prototype, "readFunctionArguments", null), e2([r2("functionArguments")], d7.prototype, "writeFunctionArguments", null), e2([y({ json: { type: String, write: { target: "rasterFunction" } } })], d7.prototype, "functionName", void 0), e2([o("functionName", ["rasterFunction", "rasterFunctionInfos", "rasterFunctionDefinition"])], d7.prototype, "readFunctionName", null), e2([o3({ C128: "c128", C64: "c64", F32: "f32", F64: "f64", S16: "s16", S32: "s32", S8: "s8", U1: "u1", U16: "u16", U2: "u2", U32: "u32", U4: "u4", U8: "u8", UNKNOWN: "unknown" }, { ignoreUnknown: false }), y({ json: { default: "unknown" } })], d7.prototype, "outputPixelType", void 0), e2([y({ type: String, json: { read: true, write: true } })], d7.prototype, "variableName", void 0), e2([y({ type: Object, json: { name: "rasterFunctionDefinition" } })], d7.prototype, "rasterFunctionDefinition", void 0), d7 = u6 = e2([a("esri.layers.support.RasterFunction")], d7);
var w3 = d7;
...
e2([y({ types: m8, json: { read: v2, write: true } })], u7.prototype, "areaOfInterest", void 0), e2([y({ readOnly: true })], u7.prototype, "dimensions", null), e2([y({ readOnly: true })], u7.prototype, "variables", null), e2([y({ type: [p5], json: { write: true } })], u7.prototype, "subsetDefinitions", void 0), u7 = p8 = e2([a("esri.layers.support.MultidimensionalSubset")], u7);
var c8 = u7;
...
function I(e3, a6) {
  ...
  let i3 = e(e3.statistics), l8 = e(e3.histograms);
...
function S(e3, a6) {
  if (!a6)
    return e3;
  let r3 = e(e3.statistics), s4 = e(e3.histograms);
...
function U2(e3) {
  ...
  return l5.createFromColormap(e(s4), a6);
}
function A(e3) {
...
//# sourceMappingURL=chunk-JFNLM55P.js.map

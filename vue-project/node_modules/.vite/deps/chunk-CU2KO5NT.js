import {
  p as p3
} from "./chunk-EXL23DF3.js";
import {
  m
} from "./chunk-ECM7B2HV.js";
import {
  d
} from "./chunk-L5JOPRWD.js";
import {
  U,
  r as r2
...
var U2;
var B;
var D = { PortalGroup: () => import("./PortalGroup-JTSWBOCU.js"), PortalItem: () => import("./PortalItem-NUINKV42.js"), PortalUser: () => import("./PortalUser-VZEXB4U5.js") };
var j = U2 = class extends u(m) {
  ...
  readAuthorizedCrossOriginDomains(e3) {
    if (e3)
      for (const r4 of e3)
        s.request.trustedServers.includes(r4) || s.request.trustedServers.push(r4);
    return e3;
  }
  ...
  load(e3) {
    const t = import("./Basemap-HOQOW4SM.js").then(({ default: t2 }) => {
      f(e3), B = t2;
  ...
  async createElevationLayers() {
    await this.load();
    const e3 = this._getHelperService("defaultElevationLayers"), t = (await import("./ElevationLayer-37IAJ3EE.js")).default;
  ...
  fetchCategorySchema(e3) {
    return this.hasCategorySchema ? this.request(this.restUrl + "/portals/self/categorySchema", e3).then((e4) => e4.categorySchema) : p2(e3) ? Promise.reject(a()) : Promise.resolve([]);
  }
  fetchFeaturedGroups(e3) {
    ...
    return p2(e3) ? Promise.reject(a()) : Promise.resolve([]);
  }
  fetchRegions(e3) {
    var _a;
  ...
  signIn() {
    if (this.authMode === U2.AUTH_MODE_ANONYMOUS)

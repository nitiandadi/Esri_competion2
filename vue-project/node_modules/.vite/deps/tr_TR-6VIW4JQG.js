    ...
    if ("string" != typeof o3 && !Array.isArray(o3)) {
      for (const r3 in o3)
        if ("default" !== r3 && !(r3 in e)) {
          const a3 = Object.getOwnPropertyDescriptor(o3, r3);
          a3 && Object.defineProperty(e, r3, a3.get ? a3 : { enumerable: true, get: () => o3[r3] });
        }
    }
  }
...
var s = a({ __proto__: null, default: o(_) }, [_]);
export {
  s as t
};
//# sourceMappingURL=tr_TR-6VIW4JQG.js.map

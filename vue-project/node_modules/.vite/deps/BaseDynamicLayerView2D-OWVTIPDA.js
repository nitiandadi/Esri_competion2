...
var h = class extends i(f(u)) {
  ...
  attach() {
    this._bitmapContainer = new a2(), this.container.addChild(this._bitmapContainer), this._strategy = new v({ container: this._bitmapContainer, fetchSource: this.fetchBitmapData.bind(this), requestUpdate: this.requestUpdate.bind(this) });
  }
  detach() {
...
e([y()], h.prototype, "_strategy", void 0), e([y()], h.prototype, "updating", void 0), h = e([a("esri.views.2d.layers.BaseDynamicLayerView2D")], h);
var c = h;
export {
  c as default
};
//# sourceMappingURL=BaseDynamicLayerView2D-OWVTIPDA.js.map

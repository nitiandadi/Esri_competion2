...
function e(e4, i2, o3 = false) {
  o3 && n.has(i2) || (o3 && n.add(i2), e4.warn(`🛑 DEPRECATED - ${i2}`));
}
...
function r2(n2, i2, o3 = {}) {
  if (has("esri-deprecation-warnings")) {
    ...
    let c = i2;
    t5 && (c += `
	🛠️ Replacement: ${t5}`), r4 && (c += `
	⚙️ Version: ${r4}`), s3 && (c += `
	🔗 See ${s3} for more details.`), e(n2, c, a2);
  }
}
...
function x(t5, e4 = -1) {
  ...
  const c = (...l) => {
    ...
    return f2.then(m, m), f2.then(h2.resolve, h2.reject), N(h2.promise);
  };
  return c;
}
function D() {
  ...
  return o3.resolve = (t5) => e4(t5), o3.reject = (t5) => r4(t5), o3.timeout = (e5, r5) => t4.setTimeout(() => o3.reject(r5), e5), o3.promise = n2, o3;
}
async function O(t5) {
...
//# sourceMappingURL=chunk-QLY5H3XF.js.map

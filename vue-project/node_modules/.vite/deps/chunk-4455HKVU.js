...
var Action = proxyCustomElement(class extends H {
  ...
  render() {
    ...
    return h(Host, null, h("button", { "aria-busy": toAriaBoolean(loading), "aria-controls": indicator ? indicatorId : null, "aria-disabled": toAriaBoolean(disabled), "aria-label": ariaLabel, "aria-pressed": toAriaBoolean(active), class: buttonClasses, disabled, id: buttonId, ref: (buttonEl) => this.buttonEl = buttonEl }, this.renderIconContainer(), this.renderTextContainer()), h("slot", { name: SLOTS.tooltip, onSlotchange: this.handleTooltipSlotChange }), this.renderIndicatorText());
  }
...
@esri/calcite-components/dist/components/action.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4455HKVU.js.map

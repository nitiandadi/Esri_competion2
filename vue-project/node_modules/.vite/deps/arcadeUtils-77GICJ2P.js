import {
  ...
  x,
  y
} from "./chunk-XSI3G4JI.js";
import {
  g
} from "./chunk-HB4Z6IUJ.js";
import "./chunk-PFURQZBT.js";
import "./chunk-REPQRKQT.js";
import "./chunk-4ANFLCNI.js";
import {
  T
} from "./chunk-WAQRBC2W.js";
import "./chunk-WEOA3BYJ.js";
import {
  O
} from "./chunk-3AKYN2SN.js";
import "./chunk-A5LFX3VX.js";
import "./chunk-JOTDK22B.js";
import {
  A,
  Ae,
  B,
...
var T3 = class extends r {
  ...
  marshalledCall(e7, n3, o5, l6) {
    return l6(e7, n3, (n4, r4, a2) => {
      a2 = a2.map((n5) => !C2(n5) || n5 instanceof s2 ? n5 : n(n5, e7, l6));
      const s9 = this.call(o5, { arguments: a2 });
...
function Y2(e7, n3) {
  ...
  let a2 = "VariableDeclaration" === n3.left.type ? n3.left.declarations[0].id.name : n3.left.name;
  a2 = a2.toLowerCase(), se(a2);
  let s9 = "";
  null !== e7.localScope && (void 0 !== e7.localScope[a2] ? s9 = "lscope['" + a2 + "']" : void 0 !== e7.localScope._SymbolsMap[a2] && (s9 = "lscope['" + e7.localScope._SymbolsMap[a2] + "']"));
  let i4 = "";
  if ("" === s9) {
    if (void 0 !== e7.globalScope[a2])
      s9 = "gscope['" + a2 + "']";
    else if (void 0 !== e7.globalScope._SymbolsMap[a2])
      s9 = "gscope['" + e7.globalScope._SymbolsMap[a2] + "']";
    else if (null !== e7.localScope)
      if (e7.undeclaredGlobalsInFunctions.has(a2))
        s9 = "gscope['" + e7.undeclaredGlobalsInFunctions.get(a2).manglename + "']", i4 = e7.undeclaredGlobalsInFunctions.get(a2).manglename;
      else {
        const t5 = { manglename: Me(e7), node: n3.left };
        e7.undeclaredGlobalsInFunctions.set(a2, t5), s9 = "gscope['" + t5.manglename + "']", i4 = t5.manglename;
      }
  }
  return i4 && (r4 += "lang.chkAssig('" + i4 + "',runtimeCtx); \n"), r4 += "if (" + t4 + "===null) {  lastStatement = lc.voidOperation; }\n ", r4 += "else if (lc.isArray(" + t4 + ") || lc.isString(" + t4 + ")) {", r4 += "var " + o5 + "=" + t4 + ".length; \n", r4 += "for(var " + l6 + "=0; " + l6 + "<" + o5 + "; " + l6 + "++) {\n", r4 += s9 + "=" + l6 + ";\n", r4 += V2(e7, n3.body), r4 += "\n}\n", r4 += " lastStatement = lc.voidOperation; \n", r4 += " \n}\n", r4 += "else if (lc.isImmutableArray(" + t4 + ")) {", r4 += "var " + o5 + "=" + t4 + ".length(); \n", r4 += "for(var " + l6 + "=0; " + l6 + "<" + o5 + "; " + l6 + "++) {\n", r4 += s9 + "=" + l6 + ";\n", r4 += V2(e7, n3.body), r4 += "\n}\n", r4 += " lastStatement = lc.voidOperation; \n", r4 += " \n}\n", r4 += "else if (( " + t4 + " instanceof lang.Dictionary) || ( " + t4 + " instanceof lang.Feature)) {", r4 += "var " + o5 + "=" + t4 + ".keys(); \n", r4 += "for(var " + l6 + "=0; " + l6 + "<" + o5 + ".length; " + l6 + "++) {\n", r4 += s9 + "=" + o5 + "[" + l6 + "];\n", r4 += V2(e7, n3.body), r4 += "\n}\n", r4 += " lastStatement = lc.voidOperation; \n", r4 += " \n}\n", e7.isAsync && (r4 += "else if (lc.isFeatureSet(" + t4 + ")) {", r4 += "var " + o5 + "=" + t4 + ".iterator(runtimeCtx.abortSignal); \n", r4 += "for(var " + l6 + "=lang. graphicToFeature( yield " + o5 + ".next()," + t4 + ", runtimeCtx); " + l6 + "!=null; " + l6 + "=lang. graphicToFeature( yield " + o5 + ".next()," + t4 + ", runtimeCtx)) {\n", r4 += s9 + "=" + l6 + ";\n", r4 += V2(e7, n3.body), r4 += "\n}\n", r4 += " lastStatement = lc.voidOperation; \n", r4 += " \n}\n"), r4 += "else { lastStatement = lc.voidOperation; } \n", r4;
}
function H(e7, n3) {
...
function Q(e7, n3) {
  ...
  if ("MemberExpression" === n3.argument.type)
    return t4 = V2(e7, n3.argument.object), true === n3.argument.computed ? o5 = V2(e7, n3.argument.property) : (o5 = "'" + n3.argument.property.name + "'", se(n3.argument.property.name)), "lang.memberupdate(" + t4 + "," + o5 + ",'" + n3.operator + "'," + n3.prefix + ")";
  if (t4 = n3.argument.name.toLowerCase(), se(t4), null !== e7.localScope) {
...
function Z3(e7, n3) {
  ...
  if ("MemberExpression" === n3.left.type)
    return o5 = V2(e7, n3.left.object), true === n3.left.computed ? l6 = V2(e7, n3.left.property) : (l6 = "'" + n3.left.property.name + "'", se(n3.left.property.name)), "lang.assignmember(" + o5 + "," + l6 + ",'" + n3.operator + "'," + t4 + ")";
  if (o5 = n3.left.name.toLowerCase(), se(o5), null !== e7.localScope) {
...
function te2(e7, n3) {
  ...
  return `if (lang.mustBoolean(${V2(e7, n3.test)}, runtimeCtx) === true) {
    ${ne2(e7, n3.consequent)}
  } ` + (null !== n3.alternate ? "IfStatement" === n3.alternate.type ? " else " + te2(e7, n3.alternate) : ` else {
      ${ne2(e7, n3.alternate)}
    }
` : " else {\n      lastStatement = lc.voidOperation;\n    }\n");
}
...
function re2(e7, n3) {
  ...
  void 0 === e7.moduleFactory[o5.uri] && (e7.moduleFactory[o5.uri] = De(o5.syntax, { interceptor: e7.interceptor, services: e7.services, moduleFactory: e7.moduleFactory, lrucache: e7.lrucache, timeReference: e7.timeReference ?? null, libraryResolver: e7.libraryResolver, customfunctions: e7.customfunctions, vars: {} }, e7.isAsync)), e7.moduleFactoryMap[l6] = o5.uri;
  let r4 = "";
  ...
  let a2 = "";
  return e7.undeclaredGlobalsInFunctions.has(t4) ? (a2 = e7.undeclaredGlobalsInFunctions.get(t4).manglename, e7.undeclaredGlobalsInFunctions.delete(t4)) : a2 = Me(e7), e7.globalScope._SymbolsMap[t4] = a2, e7.mangleMap[t4] = a2, "gscope[lang.setAssig('" + a2 + "', runtimeCtx)]=" + r4;
}
function ae(e7, n3) {
...
function ie(e7, n3) {
  ...
  for (let s9 = 0; s9 < n3.params.length; s9++) {
    ...
    se(t5);
    const o6 = Me(e7);
    r4.localScope._SymbolsMap[t5] = o6, r4.mangleMap[t5] = o6, a2 += "lscope['" + o6 + "']=arguments[" + s9.toString() + "];\n";
  }
  return true === e7.isAsync ? (a2 += "return lang.__awaiter(this, void 0, void 0, function* () {\n", a2 += oe(r4, n3.body) + "\n return lastStatement; ", a2 += "});  }", a2 += ", runtimeCtx)," + n3.params.length + ")", a2 += "\n lastStatement = lc.voidOperation; \n") : (a2 += oe(r4, n3.body) + "\n return lastStatement; }, runtimeCtx)," + n3.params.length + ")", a2 += "\n lastStatement = lc.voidOperation; \n"), l6 ? "gscope[lang.setAssig('" + o5 + "', runtimeCtx)]=" + a2 : "gscope['" + o5 + "']=" + a2;
}
function ce2(e7, n3) {
  const t4 = [];
...
function pe(e7, n3) {
  try {
    let t4;
    return true === n3.computed ? t4 = V2(e7, n3.property) : (t4 = "'" + n3.property.name + "'", se(n3.property.name)), "lang.member(" + V2(e7, n3.object) + "," + t4 + ")";
  } catch (t4) {
    throw t4;
  }
}
...
function be(e7, n3) {
  try {
    if ("MemberExpression" === n3.callee.type) {
      let t5;
      true === n3.callee.computed ? t5 = V2(e7, n3.callee.property) : (t5 = "'" + n3.callee.property.name + "'", se(n3.callee.property.name));
      let o6 = "[";
...
T2(xe, W), Z2(xe, W), N(xe, W), Z(xe, W), f2(xe, W), xe.iif = function(e7, n3) {
  try {
    return W(e7, n3, (t4, o5, l6) => {
...
function Oe(t4, o5, l6, r4) {
  const a2 = l6 ? new Ae2() : new Ie();
  t4 || (t4 = {}), o5 || (o5 = {});
  const s9 = new T({ newline: "\n", tab: "	", singlequote: "'", doublequote: '"', forwardslash: "/", backwardslash: "\\" });
  s9.immutable = false, a2._SymbolsMap = { textformatting: 1, infinity: 1, pi: 1 }, a2.textformatting = s9, a2.infinity = Number.POSITIVE_INFINITY, a2.pi = Math.PI;
  for (const e7 in o5)
    a2[e7] = o5[e7], a2._SymbolsMap[e7] = 1;
  for (const e7 in t4)
    a2._SymbolsMap[e7] = 1, t4[e7] && "esri.Graphic" === t4[e7].declaredClass ? a2[e7] = g.createFromGraphic(t4[e7], r4 ?? null) : a2[e7] = t4[e7];
  return a2;
}
Ae2.prototype = Ce;
function Ee(e7, n3) {
  const t4 = { mode: n3, compiled: true, functions: {}, signatures: [], standardFunction: W, standardFunctionAsync: W, evaluateIdentifier: Ge };
  ...
  if ("sync" === n3) {
    ...
    for (const e8 in t4.functions)
      Ce[e8] = new e2(t4.functions[e8]), Ae2.prototype[e8] = Ce[e8];
    for (let e8 = 0; e8 < t4.signatures.length; e8++)
...
var $e = { error(e7) {
  ...
  function s9(e8) {
    e8.done ? t5(e8.value) : e8.value && e8.value.then ? e8.value.then(r4, a2) : (Be++, Be % 100 == 0 ? setTimeout(() => {
      Be = 0, r4(e8.value);
    }, 0) : r4(e8.value));
  }
...
}, setAssig: (e7, n3) => (n3.gdefs[e7] = 1, e7), castString: (e7) => re(e7), aCheck(e7, n3) {
  if (C2(e7)) {
  ...
  return e7 === R ? null : e7;
}, Dictionary: T, Feature: g, UserDefinedCompiledFunction: T3, dictionary(n3) {
  ...
  for (let e7 = 0; e7 < n3.length; e7 += 2) {
    ...
    l6.has(s9) ? r5 = l6.get(s9) : l6.set(s9, r5), n3[e7 + 1] === R ? o5[r5] = null : o5[r5] = n3[e7 + 1];
  }
  const r4 = new T(o5);
  ...
  switch (t4) {
    ...
    case ">=":
      return ne(e7, n3, t4);
    case "+":
      return v2(e7) || v2(n3) ? re(e7) + re(n3) : le(e7) + le(n3);
    case "-":
      return le(e7) - le(n3);
    case "*":
      return le(e7) * le(n3);
  ...
  switch (n3) {
    ...
    case "-=":
      return le(t4) - le(e7);
    case "+=":
      return v2(t4) || v2(e7) ? re(t4) + re(e7) : le(t4) + le(e7);
    case "%=":
      return le(t4) % le(e7);
    default:
      throw new t(null, e.UnsupportedOperator, null);
...
}, graphicToFeature: (e7, t4, o5) => null === e7 ? null : g.createFromGraphicLikeObject(e7.geometry, e7.attributes, t4, o5.timeReference), memberupdate(n3, t4, o5, l6) {
  let r4;
  if (J(n3)) {
    if (!Y(t4))
    ...
    r4 = le(n3.global(t4)), n3.setGlobal(t4, "++" === o5 ? r4 + 1 : r4 - 1);
  }
  ...
  if (n3 instanceof p2) {
    if (v2(t4))
      return q(n3, t4, null, null);
    throw new t(null, e.InvalidMemberAccessKey, null);
  }
  if (J(n3)) {
    if (Y(t4) && isFinite(t4) && Math.floor(t4) === t4) {
  ...
  const o5 = n3.moduleFactory[t4]({ vars: {}, moduleSingletons: n3.moduleSingletons, depthCounter: n3.depthCounter, console: n3.console, abortSignal: n3.abortSignal, isAsync: n3.isAsync, services: n3.services, lrucache: n3.lrucache, timeReference: n3.timeReference ? n3.timeReference : null, interceptor: n3.interceptor }, n3.spatialReference);
...
function Ne(e7, n3, c4 = false) {
  null === n3 && (n3 = { vars: {}, customfunctions: {} });
  let u7 = null;
  e7.usesModules && (u7 = new s4(null, e7.loadedModules));
  const p6 = { isAsync: c4, globalScope: _e(n3.vars, c4 ? Ce : xe, n3.customfunctions), moduleFactory: {}, moduleFactoryMap: {}, undeclaredGlobalsInFunctions: /* @__PURE__ */ new Map(), customfunctions: n3.customfunctions, libraryResolver: u7, localScope: null, mangleMap: {}, depthCounter: { depth: 1 }, exports: {}, console: je, lrucache: n3.lrucache, timeReference: n3.timeReference ?? null, interceptor: n3.interceptor, services: n3.services, symbols: { symbolCounter: 0 } };
  let m5 = V2(p6, e7);
  "" === m5 && (m5 = "lc.voidOperation; "), p6.undeclaredGlobalsInFunctions.size > 0 && p6.undeclaredGlobalsInFunctions.forEach((e8) => {
    throw new s(n3, e.InvalidIdentifier, e8.node);
  });
  let g5 = "";
  g5 = c4 ? "var runtimeCtx=this.prepare(context, true);\n var lc = this.lc;  var lang = this.lang; var gscope=runtimeCtx.globalScope; \nreturn lang.__awaiter(this, void 0, void 0, function* () {\n\n function mainBody() {\n var lastStatement=lc.voidOperation;\n return lang.__awaiter(this, void 0, void 0, function* () {\n" + m5 + "\n return lastStatement; }); } \n return this.postProcess(yield mainBody()); }); " : "var runtimeCtx=this.prepare(context, false);\n var lc = this.lc;  var lang = this.lang; var gscope=runtimeCtx.globalScope; \n function mainBody() {\n var lastStatement=lc.voidOperation;\n " + m5 + "\n return lastStatement; } \n return this.postProcess(mainBody()); ";
  const d5 = p6.moduleFactory, f5 = p6.moduleFactoryMap, h3 = p6.exports, y4 = {};
  for (const t4 in h3)
    y4[t4] = void 0 !== p6.mangleMap[t4] ? p6.mangleMap[t4] : t4;
  const b4 = { lc: ve, lang: $e, mangles: p6.mangleMap, postProcess(e8) {
    if (e8 instanceof A && (e8 = e8.value), e8 instanceof j && (e8 = e8.value), e8 === R && (e8 = null), e8 === D)
    ...
    const o5 = Oe(e8.vars, e8.customfunctions, n4, e8.timeReference);
    return { localStack: [], isAsync: n4, moduleFactory: d5, moduleFactoryMap: f5, mangleMap: this.mangles, moduleSingletons: {}, exports: h3, gdefs: {}, exportmangle: y4, spatialReference: t4, globalScope: o5, abortSignal: void 0 === e8.abortSignal || null === e8.abortSignal ? { aborted: false } : e8.abortSignal, localScope: null, services: e8.services, console: e8.console ? e8.console : je, lrucache: e8.lrucache, timeReference: e8.timeReference ?? null, interceptor: e8.interceptor, symbols: { symbolCounter: 0 }, depthCounter: { depth: 1 } };
  } };
  return new Function("context", "spatialReference", g5).bind(b4);
}
async function Le() {
  return Ee([await import("./geomasync-Q2XSU4SY.js")], "async"), true;
}
var Ue = class extends s3 {
  ...
  global(e7) {
    ...
    if (void 0 === o5)
      throw new t(null, e.InvalidIdentifier, null);
    if (C2(o5) && !(o5 instanceof s2)) {
      const t4 = new s2();
      return t4.fn = o5, t4.parameterEvaluator = W, t4.context = this.moduleContext, n3[this.moduleContext.exportmangle[e7]] = t4, t4;
    }
    return o5;
  }
};
function De(e7, n3, t4 = false) {
  ...
  let a2 = "";
  a2 = t4 ? "var runtimeCtx=this.prepare(context, true);\n var lc = this.lc;  var lang = this.lang; var gscope=runtimeCtx.globalScope; \nreturn lang.__awaiter(this, void 0, void 0, function* () {\n\n function mainBody() {\n var lastStatement=lc.voidOperation;\n return lang.__awaiter(this, void 0, void 0, function* () {\n" + r4 + "\n return lastStatement; }); } \n yield mainBody(); \n return this.prepareModule(runtimeCtx); }); " : "var runtimeCtx=this.prepare(context, false);\n var lc = this.lc;  var lang = this.lang; var gscope=runtimeCtx.globalScope; \n function mainBody() {\n var lastStatement=lc.voidOperation;\n " + r4 + "\n return lastStatement; } \n mainBody(); \n return this.prepareModule(runtimeCtx); ";
  const s9 = l6.moduleFactory, i4 = l6.moduleFactoryMap, c4 = l6.exports, u7 = {};
  for (const o5 in c4)
    u7[o5] = void 0 !== l6.mangleMap[o5] ? l6.mangleMap[o5] : o5;
  const p6 = { lc: ve, lang: $e, mangles: l6.mangleMap, prepareModule: (e8) => new Ue(e8), prepare(e8, n4) {
    let t5 = e8.spatialReference;
    null == t5 && (t5 = new f({ wkid: 102100 }));
    const o5 = Oe(e8.vars, e8.customfunctions, n4, e8.timeReference);
    return { localStack: [], isAsync: n4, exports: c4, exportmangle: u7, gdefs: {}, moduleFactory: s9, moduleFactoryMap: i4, moduleSingletons: e8.moduleSingletons, mangleMap: this.mangles, spatialReference: t5, globalScope: o5, abortSignal: void 0 === e8.abortSignal || null === e8.abortSignal ? { aborted: false } : e8.abortSignal, localScope: null, services: e8.services, console: e8.console ? e8.console : je, lrucache: e8.lrucache, timeReference: e8.timeReference ?? null, interceptor: e8.interceptor, symbols: { symbolCounter: 0 }, depthCounter: e8.depthCounter };
  } };
  return new Function("context", "spatialReference", a2).bind(p6);
}
...
var t2;
!function(e7) {
  e7.Break = "break", e7.Continue = "continue", e7.Else = "else", e7.False = "false", e7.For = "for", e7.From = "from", e7.Function = "function", e7.If = "if", e7.Import = "import", e7.Export = "export", e7.In = "in", e7.Null = "null", e7.Return = "return", e7.True = "true", e7.Var = "var", e7.While = "while";
}(e4 || (e4 = {})), function(e7) {
...
var u4 = class extends Error {
  constructor({ code: e7, index: t4, line: n3, column: r4, len: i4 = 0, description: a2, data: o5 }) {
    var _a;
    super(`${a2 ?? e7}`), this.declaredRootClass = "esri.arcade.lib.parsingerror", this.name = "ParsingError", this.code = e7, this.index = t4, this.line = n3, this.column = r4, this.len = i4, this.data = o5, this.description = a2, this.range = { start: { line: n3, column: r4 - 1 }, end: { line: n3, column: r4 + i4 } }, (_a = Error.captureStackTrace) == null ? void 0 : _a.call(Error, this, u4);
  }
};
function m3(e7) {
  return (e7 == null ? void 0 : e7.type) === t2.Program;
}
function f3(e7) {
  return (e7 == null ? void 0 : e7.type) === t2.BlockStatement;
}
function I(e7) {
  return (e7 == null ? void 0 : e7.type) === t2.BlockComment;
}
function S(e7) {
  return (e7 == null ? void 0 : e7.type) === t2.EmptyStatement;
}
function V3(e7) {
  return (e7 == null ? void 0 : e7.type) === t2.VariableDeclarator;
}
  ...
  attachTrailingComments(n3) {
    ...
    if (f3(n3) && m4(e7, n3))
      for (let t4 = this._newComments.length - 1; t4 >= 0; --t4) {
        ...
        m4(s10, n3) && (e7.trailingComments = [...e7.trailingComments ?? [], s10], this._newComments.splice(t4, 1));
      }
    let s9 = [];
    if (this._newComments.length > 0)
      for (let t4 = this._newComments.length - 1; t4 >= 0; --t4) {
        const m5 = this._newComments[t4];
        i3(m5, e7) ? (e7.trailingComments = [...e7.trailingComments ?? [], m5], this._newComments.splice(t4, 1)) : i3(m5, n3) && (s9.unshift(m5), this._newComments.splice(t4, 1));
      }
    if (e7 == null ? void 0 : e7.trailingComments) {
      i3(e7.trailingComments[0], n3) && (s9 = [...s9, ...e7.trailingComments], delete e7.trailingComments);
    }
  ...
  attachLeadingComments(t4) {
    ...
    if (s9) {
      for (let o5 = (((_a = s9.leadingComments) == null ? void 0 : _a.length) ?? 0) - 1; o5 >= 0; --o5) {
        ...
        t4.range[0] >= l6.range[1] ? (i4.unshift(l6), s9.leadingComments.splice(o5, 1)) : V3(t4) && !I(l6) && (m5.unshift(l6), s9.leadingComments.splice(o5, 1));
      }
      return 0 === ((_b = s9.leadingComments) == null ? void 0 : _b.length) && delete s9.leadingComments, i4.length && (t4.leadingComments = i4), void (m5.length && (t4.trailingComments = [...m5, ...t4.trailingComments ?? []]));
    }
    for (let n3 = this._newComments.length - 1; n3 >= 0; --n3) {
      const e7 = this._newComments[n3];
      t4.range[0] >= e7.range[0] && (i4.unshift(e7), this._newComments.splice(n3, 1));
    }
    i4.length && (t4.leadingComments = i4);
  }
  attachComments(t4) {
    if (m3(t4) && t4.body.length > 0) {
      const n3 = this._nodeStack[this._nodeStack.length - 1];
      return n3 ? (n3.trailingComments = [...n3.trailingComments ?? [], ...this._newComments], this._newComments.length = 0, void this._nodeStack.pop()) : (t4.trailingComments = [...this._newComments], void (this._newComments.length = 0));
    }
...
var e5 = class {
  ...
  throwError(r4) {
    throw r4.description = r4.description ?? o4(r4.code, r4.data), new u4(r4);
  }
  tolerateError(r4) {
    r4.description = r4.description ?? o4(r4.code, r4.data);
    const e7 = new u4(r4);
    if (!this.tolerant)
      throw e7;
    this.recordError(e7);
...
var u6 = [[], [], []];
n2.forEach((e7) => u6[e7.length - 1].push(e7)), r2.forEach((e7) => u6[e7.length - 1].push(e7)), a.forEach((e7) => u6[e7.length - 1].push(e7)), i2.forEach((e7) => u6[e7.length - 1].push(e7)), o2.forEach((e7) => u6[e7.length - 1].push(e7));
var x2 = class {
  constructor(e7, t4) {
  ...
  skipSingleLineComment(e7) {
    const i4 = [], s9 = this.index - e7, n3 = { start: { line: this.lineNumber, column: this.index - this.lineStart - e7 }, end: { line: 0, column: 0 } };
    for (; !this.eof(); ) {
      ...
      if (++this.index, D2.isLineTerminator(r4)) {
        ...
        return 13 === r4 && 10 === this.source.charCodeAt(this.index) && ++this.index, ++this.lineNumber, this.lineStart = this.index, i4;
      }
    }
    if (n3) {
  ...
  skipMultiLineComment() {
    const e7 = [], i4 = this.index - 2, s9 = { start: { line: this.lineNumber, column: this.index - this.lineStart - 2 }, end: { line: 0, column: 0 } };
    for (; !this.eof(); ) {
      ...
      if (D2.isLineTerminator(n3))
        ...
        if (47 === this.source.charCodeAt(this.index + 1)) {
          if (this.index += 2, s9) {
            ...
            const t4 = { multiLine: true, start: i4 + 2, end: this.index - 2, range: [i4, this.index], loc: s9 };
            e7.push(t4);
          }
          return e7;
        }
    ...
    if (s9) {
      s9.end = { line: this.lineNumber, column: this.index - this.lineStart };
      const t4 = { multiLine: true, start: i4 + 2, end: this.index, range: [i4, this.index], loc: s9 };
      e7.push(t4);
    }
  ...
  scanComments() {
    ...
    for (; !this.eof(); ) {
      ...
      if (D2.isWhiteSpace(i4))
        ++this.index;
      else if (D2.isLineTerminator(i4))
  ...
  isKeyword(e7) {
    switch ((e7 = e7.toLowerCase()).length) {
      case 2:
        return e7 === e4.If || e7 === e4.In;
      case 3:
        return e7 === e4.Var || e7 === e4.For;
      case 4:
        return e7 === e4.Else;
      case 5:
        return e7 === e4.Break || e7 === e4.While;
      case 6:
        return e7 === e4.Return || e7 === e4.Import || e7 === e4.Export;
      case 8:
        return e7 === e4.Function || e7 === e4.Continue;
      default:
        return false;
    }
  }
  codePointAt(e7) {
    ...
    if (t4 >= 55296 && t4 <= 56319) {
      const i4 = this.source.charCodeAt(e7 + 1);
      if (i4 >= 56320 && i4 <= 57343) {
        t4 = 1024 * (t4 - 55296) + i4 - 56320 + 65536;
      }
    }
    return t4;
  }
  ...
  scanUnicodeCodePointEscape() {
    let e7 = this.source[this.index], i4 = 0;
    for ("}" === e7 && this.throwUnexpectedToken(); !this.eof() && (e7 = this.source[this.index++], D2.isHexDigit(e7.charCodeAt(0))); )
      i4 = 16 * i4 + d3(e7);
    return (i4 > 1114111 || "}" !== e7) && this.throwUnexpectedToken(), D2.fromCodePoint(i4);
  }
  getIdentifier() {
    const e7 = this.index++;
    for (; !this.eof(); ) {
  ...
  getComplexIdentifier() {
    let e7, i4 = this.codePointAt(this.index), s9 = D2.fromCodePoint(i4);
    for (this.index += s9.length, 92 === i4 && (117 !== this.source.charCodeAt(this.index) && this.throwUnexpectedToken(), ++this.index, "{" === this.source[this.index] ? (++this.index, e7 = this.scanUnicodeCodePointEscape()) : (e7 = this.scanHexEscape("u"), null !== e7 && "\\" !== e7 && D2.isIdentifierStart(e7.charCodeAt(0)) || this.throwUnexpectedToken()), s9 = e7); !this.eof() && (i4 = this.codePointAt(this.index), D2.isIdentifierPart(i4)); )
      e7 = D2.fromCodePoint(i4), s9 += e7, this.index += e7.length, 92 === i4 && (s9 = s9.substring(0, s9.length - 1), 117 !== this.source.charCodeAt(this.index) && this.throwUnexpectedToken(), ++this.index, "{" === this.source[this.index] ? (++this.index, e7 = this.scanUnicodeCodePointEscape()) : (e7 = this.scanHexEscape("u"), null !== e7 && "\\" !== e7 && D2.isIdentifierPart(e7.charCodeAt(0)) || this.throwUnexpectedToken()), s9 += e7);
    return s9;
  }
  octalToDecimal(e7) {
    let i4 = "0" !== e7, s9 = l4(e7);
    return !this.eof() && D2.isOctalDigit(this.source.charCodeAt(this.index)) && (i4 = true, s9 = 8 * s9 + l4(this.source[this.index++]), "0123".includes(e7) && !this.eof() && D2.isOctalDigit(this.source.charCodeAt(this.index)) && (s9 = 8 * s9 + l4(this.source[this.index++]))), { code: s9, octal: i4 };
  }
  scanIdentifier() {
    let e7;
    const t4 = this.index, i4 = 92 === this.source.charCodeAt(t4) ? this.getComplexIdentifier() : this.getIdentifier();
    if (e7 = 1 === i4.length ? l3.Identifier : this.isKeyword(i4) ? l3.Keyword : i4.toLowerCase() === e4.Null ? l3.NullLiteral : i4.toLowerCase() === e4.True || i4.toLowerCase() === e4.False ? l3.BooleanLiteral : l3.Identifier, e7 !== l3.Identifier && t4 + i4.length !== this.index) {
      const e8 = this.index;
      this.index = t4, this.tolerateUnexpectedToken(p5.InvalidEscapedReservedWord), this.index = e8;
    }
    return { type: e7, value: i4, lineNumber: this.lineNumber, lineStart: this.lineStart, start: t4, end: this.index };
  }
  scanPunctuator() {
    const e7 = this.index;
    ...
    switch (t4) {
      ...
      case "}":
        ...
        break;
      default:
        for (let e8 = u6.length; e8 > 0; e8--)
          if (t4 = this.source.substring(this.index, this.index + e8), u6[e8 - 1].includes(t4)) {
            this.index += e8;
            break;
          }
    }
    return this.index === e7 && this.throwUnexpectedToken(), { type: l3.Punctuator, value: t4, lineNumber: this.lineNumber, lineStart: this.lineStart, start: e7, end: this.index };
  }
  scanHexLiteral(e7) {
    let i4 = "";
    for (; !this.eof() && D2.isHexDigit(this.source.charCodeAt(this.index)); )
      i4 += this.source[this.index++];
    return 0 === i4.length && this.throwUnexpectedToken(), D2.isIdentifierStart(this.source.charCodeAt(this.index)) && this.throwUnexpectedToken(), { type: l3.NumericLiteral, value: parseInt("0x" + i4, 16), lineNumber: this.lineNumber, lineStart: this.lineStart, start: e7, end: this.index };
  }
  scanBinaryLiteral(e7) {
    ...
    return { type: l3.NumericLiteral, value: parseInt(i4, 2), lineNumber: this.lineNumber, lineStart: this.lineStart, start: e7, end: this.index };
  }
  scanOctalLiteral(e7, i4) {
    let s9 = "", n3 = false;
    ...
    return n3 || 0 !== s9.length || this.throwUnexpectedToken(), (D2.isIdentifierStart(this.source.charCodeAt(this.index)) || D2.isDecimalDigit(this.source.charCodeAt(this.index))) && this.throwUnexpectedToken(), { type: l3.NumericLiteral, value: parseInt(s9, 8), lineNumber: this.lineNumber, lineStart: this.lineStart, start: i4, end: this.index };
  }
  scanNumericLiteral() {
    const i4 = this.index;
    let s9 = this.source[i4];
    ...
    if ("." !== s9) {
      if (n3 = this.source[this.index++], s9 = this.source[this.index], "0" === n3) {
        ...
        if ("o" === s9 || "O" === s9)
          return this.scanOctalLiteral(s9, i4);
      }
    ...
    return D2.isIdentifierStart(this.source.charCodeAt(this.index)) && this.throwUnexpectedToken(), { type: l3.NumericLiteral, value: parseFloat(n3), lineNumber: this.lineNumber, lineStart: this.lineStart, start: i4, end: this.index };
  }
  scanStringLiteral() {
    const i4 = this.index;
    let s9 = this.source[i4];
      ...
      if ("\\" === e7)
        if (e7 = this.source[this.index++], e7 && D2.isLineTerminator(e7.charCodeAt(0)))
          ...
          switch (e7) {
            ...
            case "x": {
              const t4 = this.scanHexEscape(e7);
              null === t4 && this.throwUnexpectedToken(p5.InvalidHexEscapeSequence), r4 += t4;
              break;
            }
            case "n":
              r4 += "\n";
    ...
    return "" !== s9 && (this.index = i4, this.throwUnexpectedToken()), { type: l3.StringLiteral, value: r4, lineNumber: this.lineNumber, lineStart: this.lineStart, start: i4, end: this.index };
  }
  scanTemplate() {
    let e7 = "", i4 = false;
          ...
          switch (s10) {
            ...
            case "u":
              if ("{" === this.source[this.index])
                ...
                const t4 = this.index, i5 = this.scanHexEscape(s10);
                null !== i5 ? e7 += i5 : (this.index = t4, e7 += s10);
              }
              break;
            case "x": {
              const t4 = this.scanHexEscape(s10);
              null === t4 && this.throwUnexpectedToken(p5.InvalidHexEscapeSequence), e7 += t4;
              break;
            }
            case "b":
              e7 += "\b";
            ...
            case "v":
              ...
              break;
            default:
              "0" === s10 ? (D2.isDecimalDigit(this.source.charCodeAt(this.index)) && this.throwUnexpectedToken(p5.TemplateOctalLiteral), e7 += "\0") : D2.isOctalDigit(s10.charCodeAt(0)) ? this.throwUnexpectedToken(p5.TemplateOctalLiteral) : e7 += s10;
          }
      else {
        if ("{" === this.source[this.index]) {
    ...
    return i4 || this.throwUnexpectedToken(), n3 || this.curlyStack.pop(), { type: l3.Template, value: this.source.slice(s9 + 1, this.index - h3), cooked: e7, head: n3, tail: r4, lineNumber: this.lineNumber, lineStart: this.lineStart, start: s9, end: this.index };
  }
  lex() {
    if (this.eof())
...
var w3;
function g2(t4, e7 = 0) {
  let r4 = t4.start - t4.lineStart, i4 = t4.lineNumber;
  return r4 < 0 && (r4 += e7, i4--), { index: t4.start, line: i4, column: r4 };
}
function y2(t4) {
...
var f4 = class {
  constructor(r4, n3 = {}, a2) {
    this.delegate = a2, this.hasLineTerminator = false, this.options = { tokens: "boolean" == typeof n3.tokens && n3.tokens, comments: "boolean" == typeof n3.comments && n3.comments, tolerant: "boolean" == typeof n3.tolerant && n3.tolerant }, this.options.comments && (this.commentHandler = new o3()), this.errorHandler = new e5(this.options.tolerant), this.scanner = new x2(r4, this.errorHandler), this.context = { isAssignmentTarget: false, blockContext: k.None, curlyParsingType: w3.AsObject }, this.rawToken = { type: l3.EOF, value: "", lineNumber: this.scanner.lineNumber, lineStart: 0, start: 0, end: 0 }, this.tokens = [], this.startMarker = { index: 0, line: this.scanner.lineNumber, column: 0 }, this.endMarker = { index: 0, line: this.scanner.lineNumber, column: 0 }, this.readNextRawToken(), this.endMarker = { index: this.scanner.index, line: this.scanner.lineNumber, column: this.scanner.index - this.scanner.lineStart };
  }
  throwIfInvalidType(t4, e7, { validTypes: r4, invalidTypes: i4 }) {
    (r4 == null ? void 0 : r4.some((e8) => t4.type === e8)) || (i4 == null ? void 0 : i4.some((e8) => t4.type === e8)) && this.throwError(p5.InvalidExpression, e7);
  }
  throwError(t4, e7, r4 = this.endMarker) {
    const { index: i4, line: n3, column: s9 } = e7, a2 = r4.index - i4 - 1;
    this.errorHandler.throwError({ code: t4, index: i4, line: n3, column: s9 + 1, len: a2 });
  }
  tolerateError(t4, e7) {
    throw new Error("######################################### !!!");
  }
  unexpectedTokenError(t4 = {}) {
    ...
    let i4, { code: n3, data: h3 } = t4;
    if (e7) {
      if (!n3)
        switch (e7.type) {
          case l3.EOF:
            n3 = p5.UnexpectedEndOfScript;
            break;
          case l3.Identifier:
            n3 = p5.UnexpectedIdentifier;
            break;
          case l3.NumericLiteral:
            n3 = p5.UnexpectedNumber;
            break;
          case l3.StringLiteral:
            n3 = p5.UnexpectedString;
            break;
          case l3.Template:
            n3 = p5.UnexpectedTemplate;
        }
      i4 = e7.value.toString();
    } else
      i4 = "ILLEGAL";
    n3 = n3 ?? p5.UnexpectedToken, h3 || (h3 = { value: i4 });
    const c4 = o4(n3, h3);
    if (e7) {
      const t5 = e7.start, r4 = e7.lineNumber, i5 = e7.start - e7.lineStart + 1;
      return new u4({ code: n3, index: t5, line: r4, column: i5, len: e7.end - e7.start - 1, data: h3, description: c4 });
    }
    const { index: p6, line: l6 } = this.endMarker;
    return new u4({ code: n3, index: p6, line: l6, column: this.endMarker.column + 1, data: h3, description: c4 });
  }
  ...
  collectComments(t4) {
    ...
    e7 && t4.length && t4.forEach((t5) => {
      const r4 = { type: t5.multiLine ? t2.BlockComment : t2.LineComment, value: this.getSourceValue(t5), range: t5.range, loc: t5.loc };
      e7.collectComment(r4);
    });
  }
  peekAhead(t4) {
    const e7 = () => (this.scanner.scanComments(), this.scanner.lex()), r4 = this.scanner.saveState(), i4 = t4.call(this, e7);
    return this.scanner.restoreState(r4), i4;
  }
  getSourceValue(t4) {
  ...
  expectPunctuator(t4) {
    ...
    this.matchPunctuator(t4) ? this.readNextRawToken() : this.throwUnexpectedToken({ rawToken: e7, code: p5.PunctuatorExpected, data: { value: t4 } });
  }
  expectKeyword(t4) {
  ...
  withBlockContext(t4, e7) {
    ...
    this.context.curlyParsingType = w3.Automatic;
    const n3 = e7.call(this);
    return this.context.blockContext = r4, this.context.curlyParsingType = i4, n3;
  }
  consumeSemicolon() {
  ...
  parsePrimaryExpression() {
    ...
    switch (e7.type) {
      case l3.Identifier:
        return this.readNextRawToken(), this.finalize({ type: t2.Identifier, name: e7.value, ...this.getItemLocation(t4) });
      case l3.NumericLiteral:
      case l3.StringLiteral:
        return this.context.isAssignmentTarget = false, this.readNextRawToken(), this.finalize({ type: t2.Literal, value: e7.value, raw: this.getSourceValue(e7), isString: "string" == typeof e7.value, ...this.getItemLocation(t4) });
      case l3.BooleanLiteral:
        return this.context.isAssignmentTarget = false, this.readNextRawToken(), this.finalize({ type: t2.Literal, value: e7.value.toLowerCase() === e4.True, raw: this.getSourceValue(e7), isString: false, ...this.getItemLocation(t4) });
      case l3.NullLiteral:
        return this.context.isAssignmentTarget = false, this.readNextRawToken(), this.finalize({ type: t2.Literal, value: null, raw: this.getSourceValue(e7), isString: false, ...this.getItemLocation(t4) });
      case l3.Template:
  ...
  parseArrayInitializer() {
    ...
    for (; !this.matchPunctuator("]"); ) {
      ...
      this.matchPunctuator(",") ? (this.readNextRawToken(), this.throwError(p5.InvalidExpression, t5)) : (e7.push(this.inheritCoverGrammar(this.parseAssignmentExpression)), this.matchPunctuator("]") || this.expectPunctuator(","));
    }
    return this.expectPunctuator("]"), this.finalize({ type: t2.ArrayExpression, elements: e7, ...this.getItemLocation(t4) });
  }
  parseObjectPropertyKey() {
    const t4 = this.captureStartMarker(), e7 = this.rawToken;
    switch (e7.type) {
      case l3.StringLiteral:
        return this.readNextRawToken(), this.finalize({ type: t2.Literal, value: e7.value, raw: this.getSourceValue(e7), isString: true, ...this.getItemLocation(t4) });
      case l3.Identifier:
      case l3.BooleanLiteral:
      case l3.NullLiteral:
      case l3.Keyword:
  ...
  parseObjectProperty() {
    ...
    return this.matchPunctuator(":") ? (this.readNextRawToken(), n3 = this.inheritCoverGrammar(this.parseAssignmentExpression)) : t4.type === l3.Identifier ? (i4 = true, n3 = this.finalize({ type: t2.Identifier, name: t4.value, ...this.getItemLocation(e7) })) : this.throwUnexpectedToken({ rawToken: this.rawToken }), this.finalize({ type: t2.Property, kind: "init", key: r4, value: n3, shorthand: i4, ...this.getItemLocation(e7) });
  }
  parseObjectExpression() {
    ...
    return this.expectPunctuator("}"), this.finalize({ type: t2.ObjectExpression, properties: e7, ...this.getItemLocation(t4) });
  }
  parseTemplateElement(t4 = false) {
    const e7 = this.rawToken;
    e7.type !== l3.Template && this.throwUnexpectedToken({ rawToken: e7 }), t4 && !e7.head && this.throwUnexpectedToken({ code: p5.InvalidTemplateHead, rawToken: e7 });
    const r4 = this.captureStartMarker();
    this.readNextRawToken();
    const { value: i4, cooked: n3, tail: o5 } = e7, c4 = this.finalize({ type: t2.TemplateElement, value: { raw: i4, cooked: n3 }, tail: o5, ...this.getItemLocation(r4) });
  ...
  parseTemplateLiteral() {
    ...
    for (r4.push(i4); !i4.tail; )
      e7.push(this.parseExpression()), i4 = this.parseTemplateElement(), r4.push(i4);
    return this.finalize({ type: t2.TemplateLiteral, quasis: r4, expressions: e7, ...this.getItemLocation(t4) });
  }
  ...
  parseMemberName() {
    ...
    return this.readNextRawToken(), t4.type !== l3.NullLiteral && t4.type !== l3.Identifier && t4.type !== l3.Keyword && t4.type !== l3.BooleanLiteral && this.throwUnexpectedToken({ rawToken: t4 }), this.finalize({ type: t2.Identifier, name: t4.value, ...this.getItemLocation(e7) });
  }
  parseLeftHandSideExpression() {
    ...
    for (; i4 = this.getMatchingPunctuator("([."); )
      switch (i4) {
        case "(": {
          this.context.isAssignmentTarget = false, e7.type !== t2.Identifier && e7.type !== t2.MemberExpression && this.throwError(p5.IdentiferExpected, t4, r4);
          const i5 = this.parseArguments();
          e7 = this.finalize({ type: t2.CallExpression, callee: e7, arguments: i5, ...this.getItemLocation(t4) });
          continue;
        }
        case "[": {
          this.context.isAssignmentTarget = true, this.expectPunctuator("[");
          const r5 = this.isolateCoverGrammar(this.parseExpression);
          this.expectPunctuator("]"), e7 = this.finalize({ type: t2.MemberExpression, computed: true, object: e7, property: r5, ...this.getItemLocation(t4) });
          continue;
        }
        case ".": {
          this.context.isAssignmentTarget = true, this.expectPunctuator(".");
          const r5 = this.parseMemberName();
          e7 = this.finalize({ type: t2.MemberExpression, computed: false, object: e7, property: r5, ...this.getItemLocation(t4) });
          continue;
        }
      }
    return e7;
  ...
  parseUpdateExpression() {
    const t4 = this.captureStartMarker();
    let e7 = this.getMatchingPunctuator(n2);
    if (e7) {
      this.readNextRawToken();
      const r5 = this.captureStartMarker(), i5 = this.inheritCoverGrammar(this.parseUnaryExpression);
      return i5.type !== t2.Identifier && i5.type !== t2.MemberExpression && i5.type !== t2.CallExpression && this.throwError(p5.InvalidExpression, r5), this.context.isAssignmentTarget || this.tolerateError(p5.InvalidLeftHandSideInAssignment, t4), this.context.isAssignmentTarget = false, this.finalize({ type: t2.UpdateExpression, operator: e7, argument: i5, prefix: true, ...this.getItemLocation(t4) });
    }
    const r4 = this.captureStartMarker(), i4 = this.inheritCoverGrammar(this.parseLeftHandSideExpression), n3 = this.captureStartMarker();
    return this.hasLineTerminator ? i4 : (e7 = this.getMatchingPunctuator(n2), e7 ? (i4.type !== t2.Identifier && i4.type !== t2.MemberExpression && this.throwError(p5.InvalidExpression, r4, n3), this.context.isAssignmentTarget || this.tolerateError(p5.InvalidLeftHandSideInAssignment, t4), this.readNextRawToken(), this.context.isAssignmentTarget = false, this.finalize({ type: t2.UpdateExpression, operator: e7, argument: i4, prefix: false, ...this.getItemLocation(t4) })) : i4);
  }
  parseUnaryExpression() {
    const t4 = this.getMatchingPunctuator(r2);
    if (t4) {
      const e7 = this.captureStartMarker();
      this.readNextRawToken();
      const r4 = this.inheritCoverGrammar(this.parseUnaryExpression);
      return this.context.isAssignmentTarget = false, this.finalize({ type: t2.UnaryExpression, operator: t4, argument: r4, prefix: true, ...this.getItemLocation(e7) });
    }
  ...
  parseBinaryExpression() {
    ...
    let a2 = e7, o5 = this.inheritCoverGrammar(this.parseUnaryExpression);
    const h3 = [a2, r4, o5], c4 = [i4];
    for (; this.rawToken.type === l3.Punctuator && (i4 = T4(this.rawToken.value)) > 0; ) {
      for (; h3.length > 2 && i4 <= c4[c4.length - 1]; ) {
        o5 = h3.pop();
        const t5 = h3.pop();
        c4.pop(), a2 = h3.pop(), n3.pop();
        const e8 = n3[n3.length - 1], r5 = g2(e8, e8.lineStart);
        h3.push(this.finalize(this.createBinaryOrLogicalExpression(r5, t5, a2, o5)));
      }
      h3.push(this.rawToken.value), c4.push(i4), n3.push(this.rawToken), this.readNextRawToken(), h3.push(this.inheritCoverGrammar(this.parseUnaryExpression));
    }
    let p6 = h3.length - 1;
    e7 = h3[p6];
    let l6 = n3.pop();
    for (; p6 > 1; ) {
      ...
      if (!t5)
        break;
      const r5 = l6 == null ? void 0 : l6.lineStart, i5 = g2(t5, r5), s9 = h3[p6 - 1];
      e7 = this.finalize(this.createBinaryOrLogicalExpression(i5, s9, h3[p6 - 2], e7)), p6 -= 2, l6 = t5;
    }
    return e7;
  }
  createBinaryOrLogicalExpression(t4, e7, r4, i4) {
    const n3 = a.includes(e7) ? t2.LogicalExpression : t2.BinaryExpression;
    return n3 === t2.BinaryExpression || (r4.type !== t2.AssignmentExpression && r4.type !== t2.UpdateExpression || this.throwError(p5.InvalidExpression, ...y2(r4)), i4.type !== t2.AssignmentExpression && i4.type !== t2.UpdateExpression || this.throwError(p5.InvalidExpression, ...y2(r4))), { type: n3, operator: e7, left: r4, right: i4, ...this.getItemLocation(t4) };
  }
  parseAssignmentExpression() {
    const t4 = this.captureStartMarker(), e7 = this.inheritCoverGrammar(this.parseBinaryExpression), r4 = this.captureStartMarker(), i4 = this.getMatchingPunctuator(i2);
    if (!i4)
      return e7;
    e7.type !== t2.Identifier && e7.type !== t2.MemberExpression && this.throwError(p5.InvalidExpression, t4, r4), this.context.isAssignmentTarget || this.tolerateError(p5.InvalidLeftHandSideInAssignment, t4), this.matchPunctuator("=") || (this.context.isAssignmentTarget = false), this.readNextRawToken();
    const n3 = this.isolateCoverGrammar(this.parseAssignmentExpression);
    return this.finalize({ type: t2.AssignmentExpression, left: e7, operator: i4, right: n3, ...this.getItemLocation(t4) });
  }
  parseExpression() {
  ...
  parseStatementListItem() {
    return this.context.isAssignmentTarget = true, this.matchKeyword(e4.Function) ? this.parseFunctionDeclaration() : this.matchKeyword(e4.Export) ? this.parseExportDeclaration() : this.matchKeyword(e4.Import) ? this.parseImportDeclaration() : this.parseStatement();
  }
  parseBlock() {
    const t4 = this.captureStartMarker();
    this.expectPunctuator("{");
    const e7 = this.parseStatements("}");
    return this.expectPunctuator("}"), this.finalize({ type: t2.BlockStatement, body: e7, ...this.getItemLocation(t4) });
  }
  parseObjectStatement() {
    const t4 = this.captureStartMarker(), e7 = this.parseObjectExpression();
    return this.finalize({ type: t2.ExpressionStatement, expression: e7, ...this.getItemLocation(t4) });
  }
  parseBlockOrObjectStatement() {
    if (this.context.curlyParsingType === w3.AsObject)
      return this.parseObjectStatement();
    return this.peekAhead((t4) => {
      let e7 = t4();
      return (e7.type === l3.Identifier || e7.type === l3.StringLiteral) && (e7 = t4(), e7.type === l3.Punctuator && ":" === e7.value);
  ...
  parseIdentifier() {
    ...
    if (t4.type !== l3.Identifier)
      return null;
    const e7 = this.captureStartMarker();
    return this.readNextRawToken(), this.finalize({ type: t2.Identifier, name: t4.value, ...this.getItemLocation(e7) });
  }
  parseVariableDeclarator() {
    const t4 = this.captureStartMarker(), e7 = this.parseIdentifier();
    e7 || this.throwUnexpectedToken({ code: p5.IdentiferExpected });
    let r4 = null;
    if (this.matchPunctuator("=")) {
      this.readNextRawToken();
    ...
    return this.finalize({ type: t2.VariableDeclarator, id: e7, init: r4, ...this.getItemLocation(t4) });
  }
  ...
  parseVariableDeclaration() {
    const t4 = this.captureStartMarker();
    this.expectKeyword(e4.Var);
    const e7 = this.parseVariableDeclarationList();
    return this.consumeSemicolon(), this.finalize({ type: t2.VariableDeclaration, declarations: e7, kind: "var", ...this.getItemLocation(t4) });
  }
  parseEmptyStatement() {
    const t4 = this.captureStartMarker();
  ...
  parseExpressionStatement() {
    ...
    return this.consumeSemicolon(), this.finalize({ type: t2.ExpressionStatement, expression: e7, ...this.getItemLocation(t4) });
  }
  parseIfClause() {
  ...
  parseIfStatement() {
    const t4 = this.captureStartMarker();
    this.expectKeyword(e4.If), this.expectPunctuator("(");
    const e7 = this.captureStartMarker(), r4 = this.parseExpression(), i4 = this.captureStartMarker();
    this.expectPunctuator(")"), r4.type !== t2.AssignmentExpression && r4.type !== t2.UpdateExpression || this.throwError(p5.InvalidExpression, e7, i4);
    const n3 = this.parseIfClause();
    let s9 = null;
    return this.matchKeyword(e4.Else) && (this.readNextRawToken(), s9 = this.parseIfClause()), this.finalize({ type: t2.IfStatement, test: r4, consequent: n3, alternate: s9, ...this.getItemLocation(t4) });
  }
  parseWhileStatement() {
    const t4 = this.captureStartMarker();
    this.expectKeyword(e4.While), this.expectPunctuator("(");
    const e7 = this.captureStartMarker(), r4 = this.parseExpression(), i4 = this.captureStartMarker();
    this.expectPunctuator(")"), r4.type !== t2.AssignmentExpression && r4.type !== t2.UpdateExpression || this.throwError(p5.InvalidExpression, e7, i4);
    const n3 = this.withBlockContext(k.WhileLoop, this.parseStatement);
    return this.finalize({ type: t2.WhileStatement, test: r4, body: n3, ...this.getItemLocation(t4) });
  }
  parseForStatement() {
    let t4 = null, e7 = null, r4 = null, i4 = null, n3 = null;
    const s9 = this.captureStartMarker();
    if (this.expectKeyword(e4.For), this.expectPunctuator("("), this.matchPunctuator(";"))
      this.readNextRawToken();
    else if (this.matchKeyword(e4.Var)) {
      const e8 = this.captureStartMarker();
      this.readNextRawToken();
      const r5 = this.parseVariableDeclarationList();
      if (1 === r5.length && this.matchKeyword(e4.In)) {
        r5[0].init && this.throwError(p5.ForInOfLoopInitializer, e8), i4 = this.finalize({ type: t2.VariableDeclaration, declarations: r5, kind: "var", ...this.getItemLocation(e8) }), this.readNextRawToken(), n3 = this.parseExpression();
      } else
        this.matchKeyword(e4.In) && this.throwError(p5.InvalidLeftHandSideInForIn, e8), t4 = this.finalize({ type: t2.VariableDeclaration, declarations: r5, kind: "var", ...this.getItemLocation(e8) }), this.expectPunctuator(";");
    } else {
      const e8 = this.context.isAssignmentTarget, r5 = this.captureStartMarker();
      t4 = this.inheritCoverGrammar(this.parseAssignmentExpression), this.matchKeyword(e4.In) ? (this.context.isAssignmentTarget || this.tolerateError(p5.InvalidLeftHandSideInForIn, r5), t4.type !== t2.Identifier && this.throwError(p5.InvalidLeftHandSideInForIn, r5), this.readNextRawToken(), i4 = t4, n3 = this.parseExpression(), t4 = null) : (this.context.isAssignmentTarget = e8, this.expectPunctuator(";"));
    }
    i4 || (this.matchPunctuator(";") || (e7 = this.isolateCoverGrammar(this.parseExpression)), this.expectPunctuator(";"), this.matchPunctuator(")") || (r4 = this.isolateCoverGrammar(this.parseExpression))), this.expectPunctuator(")");
    const o5 = this.withBlockContext(k.ForLoop, () => this.isolateCoverGrammar(this.parseStatement));
    return i4 && n3 ? this.finalize({ type: t2.ForInStatement, left: i4, right: n3, body: o5, ...this.getItemLocation(s9) }) : this.finalize({ type: t2.ForStatement, init: t4, test: e7, update: r4, body: o5, ...this.getItemLocation(s9) });
  }
  parseContinueStatement() {
    const t4 = this.captureStartMarker();
    return this.expectKeyword(e4.Continue), this.consumeSemicolon(), this.finalize({ type: t2.ContinueStatement, ...this.getItemLocation(t4) });
  }
  parseBreakStatement() {
    const t4 = this.captureStartMarker();
    return this.expectKeyword(e4.Break), this.consumeSemicolon(), this.finalize({ type: t2.BreakStatement, ...this.getItemLocation(t4) });
  }
  parseReturnStatement() {
    const t4 = this.captureStartMarker();
    this.expectKeyword(e4.Return);
    const e7 = !this.matchPunctuator(";") && !this.matchPunctuator("}") && !this.hasLineTerminator && this.rawToken.type !== l3.EOF || this.rawToken.type === l3.StringLiteral || this.rawToken.type === l3.Template ? this.parseExpression() : null;
    return this.consumeSemicolon(), this.finalize({ type: t2.ReturnStatement, argument: e7, ...this.getItemLocation(t4) });
  }
  parseStatement() {
  ...
  parseFormalParameters() {
    ...
    if (this.expectPunctuator("("), !this.matchPunctuator(")"))
      for (; this.rawToken.type !== l3.EOF; ) {
        ...
        if (e7 || this.throwUnexpectedToken({ rawToken: this.rawToken, code: p5.IdentiferExpected }), t4.push(e7), this.matchPunctuator(")"))
          break;
        if (this.expectPunctuator(","), this.matchPunctuator(")"))
          break;
      }
  ...
  parseFunctionDeclaration() {
    ...
    const t4 = this.captureStartMarker();
    this.expectKeyword(e4.Function);
    const e7 = this.parseIdentifier();
    e7 || this.throwUnexpectedToken({ code: p5.InvalidFunctionIdentifier });
    const r4 = this.parseFormalParameters(), i4 = this.context.blockContext;
    this.context.blockContext = this.context.blockContext | k.Function;
    const n3 = this.parseBlock();
    return this.context.blockContext = i4, this.finalize({ type: t2.FunctionDeclaration, id: e7, params: r4, body: n3, ...this.getItemLocation(t4) });
  }
  parseScript() {
    const t4 = this.captureStartMarker(), e7 = this.parseStatements(), r4 = this.finalize({ type: t2.Program, body: e7, ...this.getItemLocation(t4) });
  ...
  parseExportDeclaration() {
    ...
    let t4 = null;
    const e7 = this.captureStartMarker();
    return this.expectKeyword(e4.Export), this.matchKeyword(e4.Var) ? t4 = this.parseVariableDeclaration() : this.matchKeyword("function") ? t4 = this.parseFunctionDeclaration() : this.throwUnexpectedToken({ code: p5.InvalidExpression }), this.finalize({ type: t2.ExportNamedDeclaration, declaration: t4, specifiers: [], source: null, ...this.getItemLocation(e7) });
  }
  parseModuleSpecifier() {
    const t4 = this.captureStartMarker(), e7 = this.rawToken;
    if (e7.type === l3.StringLiteral)
      return this.readNextRawToken(), this.finalize({ type: t2.Literal, value: e7.value, raw: this.getSourceValue(e7), isString: true, ...this.getItemLocation(t4) });
    this.throwError(p5.InvalidModuleUri, t4);
  }
  parseDefaultSpecifier() {
    const t4 = this.captureStartMarker(), e7 = this.parseIdentifier();
    return e7 || this.throwUnexpectedToken({ code: p5.IdentiferExpected }), this.finalize({ type: t2.ImportDefaultSpecifier, local: e7, ...this.getItemLocation(t4) });
  }
  parseImportDeclaration() {
    this.context.blockContext !== k.None && this.throwUnexpectedToken({ code: p5.ModuleImportRootOnly });
    const t4 = this.captureStartMarker();
    this.expectKeyword(e4.Import);
    const e7 = this.parseDefaultSpecifier();
    this.expectContextualKeyword(e4.From);
    const r4 = this.parseModuleSpecifier();
    return this.finalize({ type: t2.ImportDeclaration, specifiers: [e7], source: r4, ...this.getItemLocation(t4) });
  }
};

// node_modules/@arcgis/core/arcade/lib/arcade-parser.js
function s7(r4, s9, t4) {
  return new f4(r4, s9, t4).parseScript();
}
...
var e6 = class {
  ...
  deepGet(s9) {
    if (!s9 || !s9.length)
      return null;
    const t4 = (s10, i4) => null == s10 ? null : i4.length ? t4(s10 instanceof e6 ? s10.get(i4[0]) : s10[i4[0]], i4.slice(1)) : s10;
    return t4(this.get(s9[0]), s9.slice(1));
  }
  set(e7, s9) {
    const t4 = this, i4 = this._keys.indexOf(e7);
    return i4 > -1 ? t4._values[i4] = s9 : (t4._keys.push(e7), t4._values.push(s9), t4.length = t4._values.length), this;
  }
  sortedSet(e7, s9, t4, i4) {
    const h3 = this, l6 = this._keys.length, r4 = t4 || 0, n3 = void 0 !== i4 ? i4 : l6 - 1;
    if (0 === l6)
  ...
  filter(e7) {
    const s9 = this;
    return s9._keys.forEach((t4, i4) => {
      false === e7(s9._values[i4], t4, i4) && s9.delete(t4);
    }), this;
  }
  clone() {
...
var l5 = class {
  ...
  normalizeModuleUri(e7) {
    const r4 = /^[a-z0-9A-Z]+(@[0-9]+\.[0-9]+\.[0-9]+)?([\?|\/].*)?$/gi, o5 = /(?<portalurl>.+)\/home\/item\.html\?id\=(?<itemid>.+)$/gi, c4 = /(?<portalurl>.+)\/sharing\/rest\/content\/users\/[a-zA-Z0-9]+\/items\/(?<itemid>.+)$/gi, u7 = /(?<portalurl>.+)\/sharing\/rest\/content\/items\/(?<itemid>.+)$/gi, n3 = /(?<itemid>.*)@(?<versionstring>[0-9]+\.[0-9]+\.[0-9]+)([\?|\/].*)?$/gi;
    if (e7.startsWith("portal+")) {
      let l6 = e7.substring(7), a2 = "", m5 = l6, d5 = false;
      for (const e8 of [o5, u7, c4]) {
        const t4 = e8.exec(l6);
        if (null !== t4) {
          const e9 = t4.groups;
          m5 = e9.itemid, a2 = e9.portalurl, d5 = true;
          break;
        }
      }
      if (false === d5) {
        if (!r4.test(l6))
          throw new p3(l.UnsupportedUriProtocol, { uri: e7 });
        m5 = l6, a2 = this.portalUri;
      }
      ...
      return l6 = new b({ url: a2 }).restUrl + "/content/items/" + m5 + "/resources/" + h3 + ".arc", { url: l6, scheme: "portal", uri: "PO:" + l6 };
    }
    ...
    throw new p3(l.UnrecognisedUri, { uri: e7 });
  }
  ...
  async fetchSource(t4) {
    if ("portal" === t4.scheme) {
      const o5 = await U2(t4.url, { responseType: "text", query: {} });
      if (o5.data)
        return d4(o5.data, []);
    }
    if ("mock" === t4.scheme)
  ...
  static getDefault() {
    return this._default ?? (l5._default = l5._moduleResolverFactory());
  }
...
l5.mocks = {}, l5.cachedModules = new t3(30), l5._default = null, l5._moduleResolverFactory = () => {
  const e7 = b.getDefault();
  return new l5(e7.url);
};

// node_modules/@arcgis/core/arcade/arcadeRuntime.js
var P2 = class extends r {
  constructor(e7, t4) {
    super(), this.definition = null, this.context = null, this.definition = e7, this.context = t4;
  }
  createFunction(e7) {
    return (...t4) => {
      const n3 = { spatialReference: this.context.spatialReference, console: this.context.console, timeReference: this.context.timeReference ? this.context.timeReference : null, lrucache: this.context.lrucache, exports: this.context.exports, libraryResolver: this.context.libraryResolver, interceptor: this.context.interceptor, localScope: {}, depthCounter: { depth: e7.depthCounter.depth + 1 }, globalScope: this.context.globalScope };
      if (n3.depthCounter.depth > 64)
        throw new t(e7, e.MaximumCallDepth, null);
      return Re(this.definition, n3, t4, null);
    };
  }
  call(e7, t4) {
    return V4(e7, t4, (n3, l6, a2) => {
      const i4 = { spatialReference: e7.spatialReference, globalScope: e7.globalScope, depthCounter: { depth: e7.depthCounter.depth + 1 }, libraryResolver: e7.libraryResolver, exports: e7.exports, timeReference: e7.timeReference ?? null, console: e7.console, lrucache: e7.lrucache, interceptor: e7.interceptor, localScope: {} };
      if (i4.depthCounter.depth > 64)
        throw new t(e7, e.MaximumCallDepth, t4);
      return Re(this.definition, i4, a2, t4);
    });
  }
  marshalledCall(e7, t4, n3, r4) {
    return r4(e7, t4, (o5, l6, a2) => {
      const i4 = { spatialReference: e7.spatialReference, globalScope: n3.globalScope, depthCounter: { depth: e7.depthCounter.depth + 1 }, libraryResolver: e7.libraryResolver, exports: e7.exports, console: e7.console, timeReference: e7.timeReference ?? null, lrucache: e7.lrucache, interceptor: e7.interceptor, localScope: {} };
      return a2 = a2.map((t5) => !C2(t5) || t5 instanceof s2 ? t5 : n(t5, e7, r4)), n(Re(this.definition, i4, a2, t4), n3, r4);
    });
  }
};
var T6 = class extends s3 {
  ...
  global(e7) {
    ...
    if (t4.valueset || (t4.value = _(this.executingContext, t4.node), t4.valueset = true), C2(t4.value) && !(t4.value instanceof s2)) {
      const e8 = new s2();
  ...
  loadModule(e7) {
    ...
    null == n3 && (n3 = new f({ wkid: 102100 })), this.moduleScope = Fe2({}, e7.customfunctions, e7.timeReference), this.executingContext = { spatialReference: n3, globalScope: this.moduleScope, localScope: null, libraryResolver: new s4(e7.libraryResolver._moduleSingletons, this.source.syntax.loadedModules), exports: {}, console: e7.console ? e7.console : Ae3, timeReference: e7.timeReference ?? null, lrucache: e7.lrucache, interceptor: e7.interceptor, depthCounter: { depth: 1 } }, _(this.executingContext, this.source.syntax);
  }
};
function W3(e7, t4) {
  const n3 = [];
  for (let r4 = 0; r4 < t4.arguments.length; r4++)
    n3.push(_(e7, t4.arguments[r4]));
  return n3;
}
...
function Y3(e7, t4) {
  ...
  for (let n3 = 0; n3 < t4.properties.length; n3++) {
    const i5 = _(e7, t4.properties[n3]);
    if (C2(i5.value))
      throw new t(e7, e.NoFunctionInDictionary, t4);
    if (false === v2(i5.key))
      throw new t(e7, e.KeyMustBeString, t4);
    let s9 = i5.key.toString();
    const c4 = s9.toLowerCase();
    a2.has(c4) ? s9 = a2.get(c4) : a2.set(c4, s9), i5.value === R ? l6[s9] = null : l6[s9] = i5.value;
  }
  const i4 = new T(l6);
  return i4.immutable = false, i4;
}
function z3(e7, t4) {
  return { key: "Identifier" === t4.key.type ? t4.key.name : _(e7, t4.key), value: _(e7, t4.value) };
}
function H3(e7, t4) {
  const l6 = _(e7, t4.right);
  "VariableDeclaration" === t4.left.type && _(e7, t4.left);
  let a2 = null, i4 = "";
  if ("VariableDeclaration" === t4.left.type) {
    const e8 = t4.left.declarations[0].id;
    "Identifier" === e8.type && (i4 = e8.name);
  } else
    "Identifier" === t4.left.type && (i4 = t4.left.name);
  if (!i4)
    throw new t(e7, e.InvalidIdentifier, t4);
  if (i4 = i4.toLowerCase(), null != e7.localScope && void 0 !== e7.localScope[i4] && (a2 = e7.localScope[i4]), null === a2 && void 0 !== e7.globalScope[i4] && (a2 = e7.globalScope[i4]), null === a2)
    throw new t(e7, e.InvalidIdentifier, t4);
  if (J(l6) || v2(l6)) {
    const n3 = l6.length;
    for (let r4 = 0; r4 < n3; r4++) {
      a2.value = r4;
      const n4 = _(e7, t4.body);
      if (n4 === D)
        break;
      if (n4 instanceof A)
        return n4;
  ...
  if (!(l6 instanceof T || z(l6)))
    return R;
  {
    const n3 = l6.keys();
    for (let r4 = 0; r4 < n3.length; r4++) {
      a2.value = n3[r4];
      const o5 = _(e7, t4.body);
      if (o5 === D)
        break;
      if (o5 instanceof A)
        return o5;
...
function J3(e7, t4) {
  null !== t4.init && _(e7, t4.init);
  const n3 = { testResult: true, lastAction: R };
  do {
    X2(e7, t4, n3);
  } while (true === n3.testResult);
  return n3.lastAction instanceof A ? n3.lastAction : R;
}
function Q2(e7, t4) {
  const n3 = { testResult: true, lastAction: R };
  if (n3.testResult = _(e7, t4.test), false === n3.testResult)
    return R;
  if (true !== n3.testResult)
    throw new t(e7, e.BooleanConditionRequired, t4);
  for (; true === n3.testResult && (n3.lastAction = _(e7, t4.body), n3.lastAction !== D) && !(n3.lastAction instanceof A); )
    if (n3.testResult = _(e7, t4.test), true !== n3.testResult && false !== n3.testResult)
      throw new t(e7, e.BooleanConditionRequired, t4);
  return n3.lastAction instanceof A ? n3.lastAction : R;
}
function X2(e7, t4, n3) {
  if (null !== t4.test) {
    if (n3.testResult = _(e7, t4.test), false === n3.testResult)
      return;
    if (true !== n3.testResult)
  ...
  n3.lastAction = _(e7, t4.body), n3.lastAction !== D ? n3.lastAction instanceof A ? n3.testResult = false : null !== t4.update && _(e7, t4.update) : n3.testResult = false;
}
function Z4(e7, t4) {
  let l6, a2 = null, i4 = "";
  if ("MemberExpression" === t4.argument.type) {
    if (a2 = _(e7, t4.argument.object), true === t4.argument.computed ? i4 = _(e7, t4.argument.property) : "Identifier" === t4.argument.property.type && (i4 = t4.argument.property.name), J(a2)) {
      if (!Y(i4))
        throw new t(e7, e.ArrayAccessorMustBeNumber, t4);
      if (i4 < 0 && (i4 = a2.length + i4), i4 < 0 || i4 >= a2.length)
        throw new t(e7, e.OutOfBounds, t4);
      l6 = le(a2[i4]), a2[i4] = "++" === t4.operator ? l6 + 1 : l6 - 1;
    } else if (a2 instanceof T) {
      if (false === v2(i4))
        throw new t(e7, e.KeyAccessorMustBeString, t4);
      if (true !== a2.hasField(i4))
        throw new t(e7, e.FieldNotFound, t4);
      l6 = le(a2.field(i4)), a2.setField(i4, "++" === t4.operator ? l6 + 1 : l6 - 1);
    } else if (z(a2)) {
      if (false === v2(i4))
        throw new t(e7, e.KeyAccessorMustBeString, t4);
      if (true !== a2.hasField(i4))
      ...
      if (true !== a2.hasGlobal(i4))
        throw new t(e7, e.ModuleExportNotFound, t4);
      l6 = le(a2.global(i4)), a2.setGlobal(i4, "++" === t4.operator ? l6 + 1 : l6 - 1);
    }
    return false === t4.prefix ? l6 : "++" === t4.operator ? l6 + 1 : l6 - 1;
  }
  if (a2 = "Identifier" === t4.argument.type ? t4.argument.name.toLowerCase() : "", !a2)
    throw new t(e7, e.InvalidIdentifier, t4);
  if (null != e7.localScope && void 0 !== e7.localScope[a2])
    return l6 = le(e7.localScope[a2].value), e7.localScope[a2] = { value: "++" === t4.operator ? l6 + 1 : l6 - 1, valueset: true, node: t4 }, false === t4.prefix ? l6 : "++" === t4.operator ? l6 + 1 : l6 - 1;
  if (void 0 !== e7.globalScope[a2])
    return l6 = le(e7.globalScope[a2].value), e7.globalScope[a2] = { value: "++" === t4.operator ? l6 + 1 : l6 - 1, valueset: true, node: t4 }, false === t4.prefix ? l6 : "++" === t4.operator ? l6 + 1 : l6 - 1;
  throw new t(e7, e.InvalidIdentifier, t4);
}
function $(e7, t4, n3, l6, a2) {
  switch (t4) {
    case "=":
      return e7 === R ? null : e7;
    case "/=":
    ...
    case "-=":
      return le(n3) - le(e7);
    case "+=":
      return v2(n3) || v2(e7) ? re(n3) + re(e7) : le(n3) + le(e7);
    case "%=":
      return le(n3) % le(e7);
    default:
      throw new t(a2, e.UnsupportedOperator, l6);
  }
}
function ee2(e7, t4) {
  let l6 = null, a2 = "";
  if ("MemberExpression" === t4.left.type) {
    if (l6 = _(e7, t4.left.object), true === t4.left.computed)
      a2 = _(e7, t4.left.property);
    else {
      if ("Identifier" !== t4.left.property.type)
        throw new t(e7, e.InvalidIdentifier, t4);
      a2 = t4.left.property.name;
    }
    const i5 = _(e7, t4.right);
    if (J(l6)) {
      if (!Y(a2))
        throw new t(e7, e.ArrayAccessorMustBeNumber, t4);
      if (a2 < 0 && (a2 = l6.length + a2), a2 < 0 || a2 > l6.length)
        throw new t(e7, e.OutOfBounds, t4);
      if (a2 === l6.length) {
        if ("=" !== t4.operator)
          throw new t(e7, e.OutOfBounds, t4);
        l6[a2] = $(i5, t4.operator, l6[a2], t4, e7);
      } else
        l6[a2] = $(i5, t4.operator, l6[a2], t4, e7);
    } else if (l6 instanceof T) {
      if (false === v2(a2))
        throw new t(e7, e.KeyAccessorMustBeString, t4);
      if (true === l6.hasField(a2))
        l6.setField(a2, $(i5, t4.operator, l6.field(a2), t4, e7));
      else {
        if ("=" !== t4.operator)
          throw new t(e7, e.FieldNotFound, t4, { key: a2 });
        l6.setField(a2, $(i5, t4.operator, null, t4, e7));
      }
    } else if (z(l6)) {
      if (false === v2(a2))
        throw new t(e7, e.KeyAccessorMustBeString, t4);
      ...
      if (false === v2(a2))
        throw new t(e7, e.ModuleAccessorMustBeString, t4);
      if (true !== l6.hasGlobal(a2))
        throw new t(e7, e.ModuleExportNotFound, t4);
      l6.setGlobal(a2, $(i5, t4.operator, l6.global(a2), t4, e7));
    }
    return R;
  }
  l6 = t4.left.name.toLowerCase();
  const i4 = _(e7, t4.right);
  if (null != e7.localScope && void 0 !== e7.localScope[l6])
    return e7.localScope[l6] = { value: $(i4, t4.operator, e7.localScope[l6].value, t4, e7), valueset: true, node: t4.right }, R;
  if (void 0 !== e7.globalScope[l6])
    return e7.globalScope[l6] = { value: $(i4, t4.operator, e7.globalScope[l6].value, t4, e7), valueset: true, node: t4.right }, R;
  throw new t(e7, e.InvalidIdentifier, t4);
}
function te3(e7, t4) {
  if ("AssignmentExpression" === t4.expression.type || "UpdateExpression" === t4.expression.type)
    return _(e7, t4.expression);
  if ("CallExpression" === t4.expression.type) {
    const n3 = _(e7, t4.expression);
...
function ne3(e7, t4) {
  const n3 = _(e7, t4.test);
  if (true === n3)
    return _(e7, t4.consequent);
  if (false === n3)
    return null !== t4.alternate ? _(e7, t4.alternate) : R;
  throw new t(e7, e.BooleanConditionRequired, t4);
}
function re3(e7, t4) {
  let n3 = R;
  for (let r4 = 0; r4 < t4.body.length; r4++)
    if (n3 = _(e7, t4.body[r4]), n3 instanceof A || n3 === D || n3 === F)
      return n3;
  return n3;
}
function oe2(e7, t4) {
  if (null === t4.argument)
    return new A(R);
  const n3 = _(e7, t4.argument);
  return new A(n3);
}
function le3(e7, t4) {
  const n3 = t4.id.name.toLowerCase();
  return e7.globalScope[n3] = { valueset: true, node: null, value: new P2(t4, e7) }, R;
}
function ae2(e7, t4) {
  var _a, _b;
  const n3 = t4.specifiers[0].local.name.toLowerCase(), r4 = e7.libraryResolver.loadLibrary(n3);
  let o5 = null;
  return ((_a = e7.libraryResolver._moduleSingletons) == null ? void 0 : _a.has(r4.uri)) ? o5 = e7.libraryResolver._moduleSingletons.get(r4.uri) : (o5 = new T6(r4), o5.loadModule(e7), (_b = e7.libraryResolver._moduleSingletons) == null ? void 0 : _b.set(r4.uri, o5)), e7.globalScope[n3] = { value: o5, valueset: true, node: t4 }, R;
}
function ie2(e7, t4) {
  if (_(e7, t4.declaration), "FunctionDeclaration" === t4.declaration.type)
...
function se2(e7, t4) {
  for (let n3 = 0; n3 < t4.declarations.length; n3++)
    _(e7, t4.declarations[n3]);
  return R;
}
function ce3(e7, t4) {
  let n3 = null === t4.init ? null : _(e7, t4.init);
  if (n3 === R && (n3 = null), "Identifier" !== t4.id.type)
    throw new t(e7, e.InvalidIdentifier, t4);
  const l6 = t4.id.name.toLowerCase();
  return null != e7.localScope ? e7.localScope[l6] = { value: n3, valueset: true, node: t4.init } : e7.globalScope[l6] = { value: n3, valueset: true, node: t4.init }, R;
}
function ue2(e7, t4) {
  try {
    const l6 = _(e7, t4.object);
    if (null === l6)
    ...
    if (false === t4.computed) {
      if ("Identifier" === t4.property.type) {
        ...
        if (l6 instanceof p2)
          return q(l6, t4.property.name, t4, e7);
        if (l6 instanceof T6) {
    ...
    }
    {
      ...
      if (l6 instanceof p2) {
        if (v2(a2))
          return q(l6, a2, t4, e7);
        throw new t(e7, e.InvalidMemberAccessKey, t4);
      }
      if (J(l6)) {
        if (Y(a2) && isFinite(a2) && Math.floor(a2) === a2) {
          if (a2 < 0 && (a2 = l6.length + a2), a2 >= l6.length || a2 < 0)
            throw new t(e7, e.OutOfBounds, t4);
          return l6[a2];
        }
        throw new t(e7, e.InvalidMemberAccessKey, t4);
...
function pe2(e7, t4) {
  try {
    ...
    for (let l6 = 0; l6 < t4.elements.length; l6++) {
      const a2 = _(e7, t4.elements[l6]);
      if (C2(a2))
        throw new t(e7, e.NoFunctionInArray, t4);
      a2 === R ? n3.push(null) : n3.push(a2);
    }
    return n3;
  } catch (n3) {
    throw n3;
...
function de2(e7, t4) {
  try {
    const n3 = [_(e7, t4.left), _(e7, t4.right)], l6 = n3[0], a2 = n3[1];
    switch (t4.operator) {
      case "|":
      case "<<":
      case ">>":
      ...
      case "^":
      case "&":
        return Ae(le(l6), le(a2), t4.operator);
      case "==":
        return te(l6, a2);
      case "!=":
        return !te(l6, a2);
      ...
      case "<=":
      case ">=":
        return ne(l6, a2, t4.operator);
      case "+":
        return v2(l6) || v2(a2) ? re(l6) + re(a2) : le(l6) + le(a2);
      case "-":
        return le(l6) - le(a2);
      case "*":
        return le(l6) * le(a2);
...
function ge2(e7, t4) {
  ...
  for (const o5 of t4.quasis)
    if (n3 += o5.value ? o5.value.cooked : "", false === o5.tail) {
      n3 += t4.expressions[r4] ? re(me2(_(e7, t4.expressions[r4]), e7, t4)) : "", r4++;
    }
  return n3;
}
function ve3(e7, t4) {
  ...
  try {
    ...
    if (null != e7.localScope && void 0 !== e7.localScope[l6])
      return n3 = e7.localScope[l6], true === n3.valueset || (n3.value = _(e7, n3.node), n3.valueset = true), n3.value;
    if (void 0 !== e7.globalScope[l6])
      return n3 = e7.globalScope[l6], true === n3.valueset || (n3.value = _(e7, n3.node), n3.valueset = true), n3.value;
    throw new t(e7, e.InvalidIdentifier, t4);
  } catch (l6) {
    throw l6;
  }
...
function ye2(e7, t4) {
  try {
    if ("MemberExpression" === t4.callee.type) {
      const n3 = _(e7, t4.callee.object);
      if (!(n3 instanceof T6))
        throw new t(e7, e.FuncionNotFound, t4);
      const l6 = false === t4.callee.computed ? t4.callee.property.name : _(e7, t4.callee.property);
      if (!n3.hasGlobal(l6))
        throw new t(e7, e.FuncionNotFound, t4);
      const a2 = n3.global(l6);
      if (!C2(a2))
        throw new t(e7, e.CallNonFunction, t4);
      return a2.call(e7, t4);
    }
...
function xe2(e7, t4, n3, r4) {
  try {
    const o5 = _(e7, t4.arguments[n3]);
    if (te(o5, r4))
      return _(e7, t4.arguments[n3 + 1]);
    {
      const o6 = t4.arguments.length - n3;
      return 1 === o6 ? _(e7, t4.arguments[n3]) : 2 === o6 ? null : 3 === o6 ? _(e7, t4.arguments[n3 + 2]) : xe2(e7, t4, n3 + 2, r4);
    }
  } catch (o5) {
    throw o5;
  }
...
function Se2(e7, t4, n3, l6) {
  try {
    ...
    if (3 === t4.arguments.length - n3)
      return _(e7, t4.arguments[n3 + 2]);
    {
      const l7 = _(e7, t4.arguments[n3 + 2]);
      if (false === L(l7))
...
function Re(e7, t4, n3, l6) {
  try {
    ...
    if (i4 === F)
      throw new t(t4, e.UnexpectedToken, l6);
    return i4 instanceof j ? i4.value : i4;
  } catch (a2) {
    throw a2;
  }
}
T2(be2, V4), Z2(be2, V4), N(be2, V4), Z(be2, V4), f2(be2, V4), O(be2, V4), be2.iif = function(e7, t4) {
  try {
    B(null === t4.arguments ? [] : t4.arguments, 3, 3, e7, t4);
    const n3 = _(e7, t4.arguments[0]);
    if (false === L(n3))
      throw new t(e7, e.BooleanConditionRequired, t4);
    return _(e7, true === n3 ? t4.arguments[1] : t4.arguments[2]);
  } catch (n3) {
    throw n3;
  }
...
function Fe2(e7, t4, r4) {
  const o5 = new Ie2();
  e7 || (e7 = {}), t4 || (t4 = {});
  const l6 = new T({ newline: "\n", tab: "	", singlequote: "'", doublequote: '"', forwardslash: "/", backwardslash: "\\" });
  l6.immutable = false, o5.textformatting = { value: l6, valueset: true, node: null };
  for (const n3 in t4)
    o5[n3] = { value: new e2(t4[n3]), native: true, valueset: true, node: null };
  for (const n3 in e7)
    e7[n3] && "esri.Graphic" === e7[n3].declaredClass ? o5[n3] = { value: g.createFromGraphic(e7[n3], r4), valueset: true, node: null } : o5[n3] = { value: e7[n3], valueset: true, node: null };
  return o5;
}
...
function Me2(e7) {
  ...
  for (const n3 in t4.functions)
    be2[n3] = { value: new e2(t4.functions[n3]), valueset: true, node: null }, Ie2.prototype[n3] = be2[n3];
...
function Ee2(e7, n3) {
  ...
  let a2 = null;
  e7.usesModules && (a2 = new s4(/* @__PURE__ */ new Map(), e7.loadedModules));
  const i4 = { spatialReference: l6, globalScope: Fe2(n3.vars, n3.customfunctions, n3.timeReference), localScope: null, exports: {}, libraryResolver: a2, console: n3.console ? n3.console : Ae3, timeReference: n3.timeReference ?? null, lrucache: n3.lrucache, interceptor: n3.interceptor, depthCounter: { depth: 1 } };
  let s9 = _(i4, e7);
  if (s9 instanceof A && (s9 = s9.value), s9 instanceof j && (s9 = s9.value), s9 === R && (s9 = null), s9 === D)
    throw new t(i4, e.IllegalResult, null);
  if (s9 === F)
    throw new t(i4, e.IllegalResult, null);
  if (C2(s9))
    throw new t(i4, e.IllegalResult, null);
...
function F3(t4, r4) {
  ...
  if (has("esri-csp-restrictions") || false === A3) {
    return function(e7) {
      return j2.executeScript(t4, e7);
    };
  }
  try {
    return Ne(t4, r4, true);
  } catch (n3) {
    if ("esri.arcade.arcadeuncompilableerror" === n3.declaredRootClass)
      return function(e7) {
        return j2.executeScript(t4, e7);
...
function E3(e7) {
  Me2(e7), Ee(e7, "sync"), null === j2 ? x4.push(e7) : (Ee(e7, "async"), j2.extend(e7));
}
function G2(e7, t4 = []) {
  return d4(e7, t4);
}
function v4(e7, t4, r4 = []) {
  return U4(d4(e7, r4), t4);
}
function U4(e7, t4) {
  if (true === t4.useAsync || true === e7.isAsync) {
    if (null === j2)
      throw new t(null, e.AsyncNotEnabled, null);
    return j2.executeScript(e7, t4);
  }
  return Ee2(e7, t4);
}
function _2(e7, t4) {
...
async function z4() {
  const [e7, t4] = await Promise.all([import("./geometryEngine-YZPHZDBX.js"), import("./geomsync-AYGEHVOT.js")]);
...
async function O3() {
  await Le(), j2 = await import("./arcadeAsyncRuntime-MBDNUD4Q.js");
  for (const e7 of x4)
    j2.extend(e7), Ee(e7, "async");
  return x4 = null, true;
}
function T7() {
  return w5;
...
async function K2() {
  await N3();
  const [e7, r4, n3, s9, u7] = await Promise.all([import("./featureSetUtils-6RXZNVY6.js"), import("./featuresetbase-24S4CPRV.js"), import("./featuresetgeom-ANIMZ7C3.js"), import("./featuresetstats-IPPAP7IC.js"), import("./featuresetstring-3VWJBSLT.js")]);
  return te4 = e7, j2.extend([r4, n3, s9, u7]), Ee([r4, n3, s9, u7], "async"), w5 = true, true;
}
function Q3(e7, t4 = []) {
...
async function X3(e7, t4, r4 = [], n3 = false, s9 = null) {
  return Y4(/* @__PURE__ */ new Set(), e7, t4, r4, n3, s9);
}
async function Y4(e7, t4, r4, n3 = [], s9 = false, u7 = null) {
  const a2 = "string" == typeof t4 ? G2(t4) : t4, o5 = [];
  return a2 && (false === B3() && (D4(a2) || s9) && o5.push(k3()), false === q2() && (true === a2.isAsync || r4) && o5.push(N3()), false === T7() && (Q3(a2) || W4(a2, n3)) && o5.push(J4())), o5.length && await Promise.all(o5), await $2(e7, a2, u7, r4, s9), true;
}
function Z5(e7, t4 = []) {
...
async function $2(e7, t4, r4 = null, s9 = false, u7 = false) {
  const i4 = x(t4);
  null === r4 && i4.length > 0 && (r4 = l5.getDefault()), t4.loadedModules = {};
  for (const n3 of i4) {
    i(r4);
    const i5 = r4.normalizeModuleUri(n3.source);
    if (e7.has(i5.uri))
      throw new t(null, e.CircularModules, null);
    e7.add(i5.uri);
    const c4 = await r4.fetchModule(i5);
    await Y4(e7, c4, s9, [], u7, r4), e7.delete(i5.uri), c4.isAsync && (t4.isAsync = true), c4.usesFeatureSet && (t4.usesFeatureSet = true), c4.usesGeometry && (t4.usesGeometry = true), t4.loadedModules[n3.libname] = { uri: i5.uri, script: c4 };
  }
}
function ee3(e7) {
  if (D4(e7))
...
var ne4 = Object.freeze(Object.defineProperty({ __proto__: null, _loadScriptDependenciesImpl: Y4, compileScript: M2, enableAsyncSupport: N3, enableAsyncSupportImpl: O3, enableFeatureSetSupport: J4, enableFeatureSetSupportImpl: K2, enableGeometrySupport: k3, enableGeometrySupportImpl: z4, executeScript: U4, extend: E3, extractExpectedFieldLiterals: C4, extractFieldLiterals: R3, featureSetUtils: re4, isAsyncEnabled: q2, isFeatureSetSupportEnabled: T7, isGeometryEnabled: B3, loadDependentModules: $2, loadScriptDependencies: X3, parseAndExecuteScript: v4, parseScript: G2, referencesFunction: I2, referencesMember: _2, scriptIsAsync: V5, scriptTouchesGeometry: ee3, scriptUsesFeatureSet: Q3, scriptUsesGeometryEngine: D4, scriptUsesModules: Z5 }, Symbol.toStringTag, { value: "Module" }));

// node_modules/@arcgis/core/support/arcadeUtils.js
var C5 = /^\$(feature|aggregatedFeatures)\./i;
var M3 = { vars: { $feature: "any", $view: "any" }, spatialReference: null };
function P4(e7) {
  return e7.replace(/[|\\{}()[\]^$+*?.]/g, "\\$&");
}
function I3(e7) {
  return null == e7 ? null : J(e7) || V(e7) ? "array" : U(e7) ? "date" : v2(e7) ? "text" : L(e7) ? "boolean" : Y(e7) ? "number" : e7 instanceof T ? "dictionary" : z(e7) ? "feature" : e7 instanceof w ? "point" : e7 instanceof v ? "polygon" : e7 instanceof m ? "polyline" : e7 instanceof u ? "multipoint" : e7 instanceof w2 ? "extent" : G(e7) ? "featureSet" : E(e7) ? "featureSetCollection" : null;
}
function A4(r4) {
  if (!r4)
    return null;
...
function G3(e7, n3) {
  ...
  if (!t4)
    return null;
  try {
    return n3 = n3 || p(M3), M2(t4, n3);
  } catch (o5) {
  }
  return null;
}
function T8(e7, r4) {
  return { vars: { $feature: null == e7 ? new g() : g.createFromGraphic(e7, null), $view: r4 && r4.view }, spatialReference: r4 && r4.sr };
}
function U5(e7, r4, n3) {
  return g.createFromGraphicLikeObject(r4, e7, n3, null);
}
function V6(e7, r4) {
...
function J5(e7, r4) {
  ...
  const i4 = s9.filter((e8) => e8.includes("*"));
  return s9 = s9.filter((e8) => !i4.includes(e8)), r4 && i4.forEach((e8) => {
    const n4 = new RegExp(`^${e8.split(/\*+/).map(P4).join(".*")}$`, "i");
...
function H5(e7) {
  if (!e7 || null == e7.spatialReference && (null == e7.scale || null == e7.viewingMode))
    return;
  return { view: e7.viewingMode && null != e7.scale ? new T({ viewingMode: e7.viewingMode, scale: e7.scale }) : null, sr: e7.spatialReference };
}
function K3({ url: e7, spatialReference: r4, lrucache: n3, interceptor: t4 }) {
  const o5 = re4();
  return o5 ? o5.createFeatureSetCollectionFromService(e7, r4, n3, t4) : null;
}
function N4({ layer: e7, spatialReference: r4, outFields: n3, returnGeometry: t4, lrucache: o5, interceptor: s9 }) {
  if (null === e7)
    return null;
  const i4 = re4();
  return i4 ? i4.constructFeatureSet(e7, r4, n3, t4 ?? true, o5, s9) : null;
}
function Q4(e7) {
...
function W5(e7, r4) {
  return T.convertJsonToArcade(e7, r4);
}
function X4(e7, r4, n3 = []) {
  return X3(e7, r4, n3);
}
function Y5() {
  return k3();
...
export {
  ...
  T8 as createExecContext,
  U5 as createFeature,
  G3 as createFunction,
  A4 as createSyntaxTree,
  O4 as dependsOnView,
  Z6 as enableFeatureSetOperations,
  ...
  B4 as hasVariable,
  X4 as loadScriptDependencies,
  V6 as updateExecContext
};
//# sourceMappingURL=arcadeUtils-77GICJ2P.js.map

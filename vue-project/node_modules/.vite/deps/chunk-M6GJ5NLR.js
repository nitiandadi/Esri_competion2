...
function B(t4) {
  if (!a2(t4))
    return null;
  const e4 = t4.clone(), { width: l4, height: i, pixels: o2 } = t4, s9 = o2[0], r3 = e4.pixels[0], h4 = e2(t4.mask);
...
function W(t4, e4, i) {
  ...
  const k3 = new Uint8Array(d4), M4 = e2(t4.mask);
...
function m4(t4, r3, o2, s9 = "geographic") {
  if (!a2(t4) || t(o2))
    return t4;
  const a4 = "vector-magdir" === r3 ? t4.clone() : e2(d2(t4, r3)), h4 = a4.pixels[1];
...
//# sourceMappingURL=chunk-M6GJ5NLR.js.map

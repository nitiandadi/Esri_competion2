...
function l(t, n, r = 1e3) {
  switch (t.toLowerCase()) {
    ...
    case "mean":
      return s(ae(n));
    case "min":
      return Math.min.apply(Math, ae(n));
    case "sum":
      return u(ae(n));
    case "max":
      return Math.max.apply(Math, ae(n));
    case "stdev":
    case "stddev":
      return Math.sqrt(c(ae(n)));
    case "var":
    case "variance":
      return c(ae(n));
    case "count":
...
//# sourceMappingURL=chunk-HKEMCUCV.js.map

...
var U2;
var B;
var D = { PortalGroup: () => import("./PortalGroup-4BUPQJNO.js"), PortalItem: () => import("./PortalItem-3QPLKTNV.js"), PortalUser: () => import("./PortalUser-UXBGBHQT.js") };
var j = U2 = class extends u(m) {
  ...
  load(e3) {
    const t = import("./@arcgis_core_Basemap__js.js").then(({ default: t2 }) => {
      f(e3), B = t2;
  ...
  async createElevationLayers() {
    await this.load();
    const e3 = this._getHelperService("defaultElevationLayers"), t = (await import("./ElevationLayer-U5LNSKKQ.js")).default;
...
//# sourceMappingURL=chunk-EAKUFEPO.js.map

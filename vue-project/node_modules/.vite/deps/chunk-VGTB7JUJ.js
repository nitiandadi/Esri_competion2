...
var h2 = class {
  ...
  static add(i3, t3) {
    return new h2(i3.x + t3.x, i3.y + t3.y);
  }
  static sub(i3, t3) {
    return new h2(i3.x - t3.x, i3.y - t3.y);
  }
...
var l = class {
  static simplify(i3, t3, h3) {
    ...
    if (0 === a.length || 0 === y.length)
      return;
    l.fillParent(h3, y, a), l.fillParent(h3, a, y);
    const r2 = [];
    l.calcDeltas(r2, y, a), l.calcDeltas(r2, a, y), l.addDeltas(r2, h3);
  }
  ...
  static calcDeltas(i3, t3, s2) {
    ...
    for (let n3 = 0; n3 < h3; n3 += 4) {
      const h4 = [], e3 = l.calcDelta(n3, t3, s2, h4);
  ...
  static calcDelta(i3, t3, s2, h3) {
    ...
    if (-1 === n3)
      return 0;
    const e3 = h3.length;
    return e3 > 1 && h3[e3 - 2] === n3 ? 0 : (h3.push(n3), l.calcDelta(n3, s2, t3, h3) + 1);
  }
...
//# sourceMappingURL=chunk-VGTB7JUJ.js.map

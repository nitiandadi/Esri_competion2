...
var p = class extends v {
  ...
  _peekByScaleFirst(e2) {
    ...
    h.has(o) || (u(a3, c), a3.sort((e3, t2) => e3 - t2), o = a3.reduce((e3, t2) => Math.abs(t2 - o) < Math.abs(e3 - o) ? t2 : e3, a3[0])), o = Math.min(o, s), o = Math.max(o, r);
...
e([y({ constructOnly: true })], p.prototype, "concurrency", void 0), e([y({ constructOnly: true })], p.prototype, "process", void 0), e([y()], p.prototype, "state", void 0), e([y({ constructOnly: true })], p.prototype, "strategy", void 0), e([y({ constructOnly: true })], p.prototype, "tileInfoView", void 0), e([y({ readOnly: true })], p.prototype, "updating", null), p = e([a2("esri.views.2d.tiling.TileQueue")], p);
var y2 = p;

export {
  y2 as y
};
//# sourceMappingURL=chunk-DDAW6PTY.js.map

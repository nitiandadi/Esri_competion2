    ...
    if ("string" != typeof a2 && !Array.isArray(a2)) {
      for (const o3 in a2)
        if ("default" !== o3 && !(o3 in e)) {
          const r4 = Object.getOwnPropertyDescriptor(a2, o3);
          r4 && Object.defineProperty(e, o3, r4.get ? r4 : { enumerable: true, get: () => a2[o3] });
        }
    }
  }
...
var s = r2({ __proto__: null, default: o(_) }, [_]);
export {
  s as h
};
//# sourceMappingURL=hr_HR-GYUE3JWA.js.map

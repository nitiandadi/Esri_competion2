    ...
    if ("string" != typeof i2 && !Array.isArray(i2)) {
      for (const r3 in i2)
        if ("default" !== r3 && !(r3 in e)) {
          const o4 = Object.getOwnPropertyDescriptor(i2, r3);
          o4 && Object.defineProperty(e, r3, o4.get ? o4 : { enumerable: true, get: () => i2[r3] });
        }
    }
  }

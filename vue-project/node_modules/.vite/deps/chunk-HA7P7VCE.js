import {
  ...
  p,
  x
} from "./chunk-UMG24TN2.js";
import {
  T
} from "./chunk-HUKDJ3MH.js";
import {
  f as f2,
  n as n2,
  o,
...
function m4(e2, t3, a3 = "AND") {
  return f2.create("((" + u2(e2, i.Standardised) + ")" + a3 + "(" + u2(t3, i.Standardised) + "))", e2.fieldsIndex);
}
function y(e2, n3, o3, i3 = null, u4 = null, l3 = null) {
  let d3, f6, p4, m6;
  switch (e2.type) {
    case "interval":
      return R2(y(e2.value, n3, o3, i3, u4, l3), e2.qualifier, e2.op);
    case "case-expression": {
      let r2 = " CASE ";
      "simple" === e2.format && (r2 += y(e2.operand, n3, o3, i3, u4, l3));
      for (let t3 = 0; t3 < e2.clauses.length; t3++)
        r2 += " WHEN " + y(e2.clauses[t3].operand, n3, o3, i3, u4, l3) + " THEN " + y(e2.clauses[t3].value, n3, o3, i3, u4, l3);
      return null !== e2.else && (r2 += " ELSE " + y(e2.else, n3, o3, i3, u4, l3)), r2 += " END ", r2;
    }
    case "parameter": {
      const r2 = o3[e2.value.toLowerCase()];
      if ("string" == typeof r2) {
        return "'" + o3[e2.value.toLowerCase()].toString().replace(/'/g, "''") + "'";
      }
      if (c3(r2))
        return T2(r2, n3, l3);
      if (a(r2))
      ...
      if (r2 instanceof Array) {
        ...
        for (let s4 = 0; s4 < r2.length; s4++)
          "string" == typeof r2[s4] ? e3.push("'" + r2[s4].toString().replace(/'/g, "''") + "'") : c3(r2[s4]) ? e3.push(T2(r2[s4], n3, l3)) : a(r2[s4]) ? e3.push(h2(r2[s4], n3, l3)) : e3.push(r2[s4].toString());
        return e3;
      }
      return r2.toString();
    }
    case "expression-list":
      ...
      for (const r2 of e2.value)
        f6.push(y(r2, n3, o3, i3, u4, l3));
      return f6;
    case "unary-expression":
      return " ( NOT " + y(e2.expr, n3, o3, i3, u4, l3) + " ) ";
    case "binary-expression":
      switch (e2.operator) {
        case "AND":
          return " (" + y(e2.left, n3, o3, i3, u4, l3) + " AND " + y(e2.right, n3, o3, i3, u4, l3) + ") ";
        case "OR":
          return " (" + y(e2.left, n3, o3, i3, u4, l3) + " OR " + y(e2.right, n3, o3, i3, u4, l3) + ") ";
        case "IS":
          if ("null" !== e2.right.type)
            throw new s2(t.UnsupportedIsRhs);
          return " (" + y(e2.left, n3, o3, i3, u4, l3) + " IS NULL )";
        case "ISNOT":
          if ("null" !== e2.right.type)
            throw new s2(t.UnsupportedIsRhs);
          return " (" + y(e2.left, n3, o3, i3, u4, l3) + " IS NOT NULL )";
        case "IN":
          return d3 = [], "expression-list" === e2.right.type ? (d3 = y(e2.right, n3, o3, i3, u4), " (" + y(e2.left, n3, o3, i3, u4, l3) + " IN (" + d3.join(",") + ")) ") : (m6 = y(e2.right, n3, o3, i3, u4, l3), m6 instanceof Array ? " (" + y(e2.left, n3, o3, i3, u4, l3) + " IN (" + m6.join(",") + ")) " : " (" + y(e2.left, n3, o3, i3, u4, l3) + " IN (" + m6 + ")) ");
        case "NOT IN":
          return d3 = [], "expression-list" === e2.right.type ? (d3 = y(e2.right, n3, o3, i3, u4), " (" + y(e2.left, n3, o3, i3, u4, l3) + " NOT IN (" + d3.join(",") + ")) ") : (m6 = y(e2.right, n3, o3, i3, u4, l3), m6 instanceof Array ? " (" + y(e2.left, n3, o3, i3, u4, l3) + " NOT IN (" + m6.join(",") + ")) " : " (" + y(e2.left, n3, o3, i3, u4, l3) + " NOT IN (" + m6 + ")) ");
        case "BETWEEN":
          return p4 = y(e2.right, n3, o3, i3, u4, l3), " (" + y(e2.left, n3, o3, i3, u4, l3) + " BETWEEN " + p4[0] + " AND " + p4[1] + " ) ";
        case "NOTBETWEEN":
          return p4 = y(e2.right, n3, o3, i3, u4, l3), " (" + y(e2.left, n3, o3, i3, u4, l3) + " NOT BETWEEN " + p4[0] + " AND " + p4[1] + " ) ";
        case "LIKE":
          return "" !== e2.escape ? " (" + y(e2.left, n3, o3, i3, u4, l3) + " LIKE " + y(e2.right, n3, o3, i3, u4, l3) + " ESCAPE '" + e2.escape + "') " : " (" + y(e2.left, n3, o3, i3, u4, l3) + " LIKE " + y(e2.right, n3, o3, i3, u4, l3) + ") ";
        case "NOT LIKE":
          return "" !== e2.escape ? " (" + y(e2.left, n3, o3, i3, u4, l3) + " NOT LIKE " + y(e2.right, n3, o3, i3, u4, l3) + " ESCAPE '" + e2.escape + "') " : " (" + y(e2.left, n3, o3, i3, u4, l3) + " NOT LIKE " + y(e2.right, n3, o3, i3, u4, l3) + ") ";
        case "<>":
        case "<":
        case ">":
        case ">=":
        ...
        case "+":
        case "/":
          return " (" + y(e2.left, n3, o3, i3, u4, l3) + " " + e2.operator + " " + y(e2.right, n3, o3, i3, u4, l3) + ") ";
        case "||":
          return " (" + y(e2.left, n3, o3, i3, u4, l3) + " " + (n3 === i.SqlServer ? "+" : e2.operator) + " " + y(e2.right, n3, o3, i3, u4, l3) + ") ";
      }
    ...
    case "timestamp":
    case "date":
      return T2(e2.value, n3, l3);
    case "number":
      return e2.value.toString();
    case "current-time":
      return L("date" === e2.mode, n3);
    case "column-reference":
      return i3 && i3.toLowerCase() === e2.column.toLowerCase() ? "(" + u4 + ")" : e2.column;
    case "data-type":
      return e2.value;
    case "function": {
      const r2 = y(e2.args, n3, o3, i3, u4, l3);
...
function g2(e2, t3, a3) {
  switch (e2.toLowerCase().trim()) {
    ...
    case "extract":
      return "EXTRACT(" + t3[0].replace(/\'/g, "") + " FROM " + t3[1] + ")";
    case "cast": {
      let e3 = "";
      switch (a3) {
        case i.Oracle:
...
function h2(t3, a3, n3, s4) {
  (n3 == null ? void 0 : n3.outputTimeReference) && (t3 = c2.arcadeDateAndZoneToArcadeDate(t3, n3 == null ? void 0 : n3.outputTimeReference));
  const c4 = t3.toDateTime(), o3 = 0 === c4.hour && 0 === c4.minute && 0 === c4.second && 0 === c4.millisecond;
  switch (a3) {
    case i.FILEGDB:
    case i.Standardised:
    case i.StandardisedNoInterval:
      return o3 ? `date '${c4.toFormat("yyyy-LL-dd")}'` : `date '${c4.toFormat("yyyy-LL-dd HH:mm:ss")}'`;
    case i.Oracle:
      return o3 ? `TO_DATE('${c4.toFormat("yyyy-LL-dd")}','YYYY-MM-DD')` : `TO_DATE('${c4.toFormat("yyyy-LL-dd HH:mm:ss")}','YYYY-MM-DD HH24:MI:SS')`;
    case i.SqlServer:
      return `'${c4.toFormat(o3 ? "yyyy-LL-dd" : "yyyy-LL-dd HH:mm:ss")}'`;
    case i.PGDB:
      return `#${c4.toFormat(o3 ? "LL-dd-yyyy" : "LL-dd-yyyy HH:mm:ss")}#`;
    case i.Postgres:
      return `TIMESTAMP '${c4.toFormat(o3 ? "yyyy-LL-dd" : "yyyy-LL-dd HH:mm:ss")}'`;
    default:
      return `date '${c4.toFormat("yyyy-LL-dd HH:mm:ss")}'`;
  }
}
function T2(e2, a3, n3, s4) {
  let c4 = c3(e2) ? DateTime.fromJSDate(e2) : DateTime.fromSQL(e2);
  const o3 = 0 === c4.hour && 0 === c4.minute && 0 === c4.second && 0 === c4.millisecond;
  switch ((n3 == null ? void 0 : n3.inputTimeReference) && (c4 = DateTime.fromObject({ day: c4.day, year: c4.year, month: c4.month, hour: c4.hour, minute: c4.minute, second: c4.second, millisecond: c4.millisecond }, { zone: n3.inputTimeReference })), (n3 == null ? void 0 : n3.outputTimeReference) && (c4 = c4.setZone(n3.outputTimeReference)), a3) {
    case i.FILEGDB:
    case i.Standardised:
    case i.StandardisedNoInterval:
      return o3 ? `date '${c4.toFormat("yyyy-LL-dd")}'` : `date '${c4.toFormat("yyyy-LL-dd HH:mm:ss")}'`;
...
function S2(e2, r2, t3 = {}) {
  ...
  for (const c4 of r2) {
    const e3 = c4.type ? s4[c4.type] : void 0;
    a3[c4.name.toLowerCase()] = void 0 === e3 ? "" : e3;
  }
  for (const c4 in t3) {
    const e3 = s4[t3[c4]];
    n3[c4.toLowerCase()] = void 0 === e3 ? "" : e3;
  }
  ...
  nextBatch(e2) {
    ...
    return n3.returnpromise = new Promise((a3, i3) => {
      this._parent._getSet(this._progress).then((r2) => {
        ...
        const l3 = c(r2._candidates, "candidates");
    ...
    return e2.returnpromise = new Promise((n3, s4) => {
      this._parent._getSet(this._progress).then((a3) => {
        ...
        if (this._lastId < i3.length - 1)
          ...
          c(a3._candidates, "candidates").length > 0 ? this._parent._refineSetBlock(a3, this._parent._maxProcessingRate(), this._progress).then(() => {
...
function f4(t3, n3) {
  ...
  for (let i3 = 0; i3 < t3.length; i3++) {
    if (void 0 !== t3[i3] && null !== t3[i3]) {
      const n4 = t3[i3];
      if (u(n4) || s(n4))
        void 0 === u4[n4] && (c4.push(n4), u4[n4] = 1);
      else {
        let t4 = false;
        for (let e2 = 0; e2 < s4.length; e2++)
          true === m(s4[e2], n4) && (t4 = true);
        false === t4 && (s4.push(n4), c4.push(n4));
      }
    }
    if (c4.length >= n3 && -1 !== n3)
      return c4;
  }
  return c4;
}
...
async function k(e2, r2, a3, c4 = false) {
  const u4 = e2.iterator(a3), s4 = [], i3 = { ticker: 0 };
  let l3 = await u4.next();
  for (; null !== l3; ) {
    ...
    null === e3 ? false === c4 && (s4[s4.length] = e3) : s4[s4.length] = e3, l3 = await u4.next();
  }
  return s4;
}
async function C2(e2, r2, a3 = 1e3, c4 = null) {
  const u4 = e2.iterator(c4), s4 = [], i3 = {}, l3 = { ticker: 0 };
  let o3 = await u4.next();
  for (; null !== o3; ) {
    if (l3.ticker++, c4 && c4.aborted)
      throw new o(n2.Cancelled);
...
var v3 = class {
  ...
  async _getAggregatePagesDataSourceDefinition(e2, t3, n3, i3, a3, l3, u4) {
    if (null === this._parent)
      throw new o(n2.NeverReach);
    return this._parent._getAggregatePagesDataSourceDefinition(e2, t3, n3, i3, a3, l3, u4);
  }
  ...
  async _manualStat(e2, t3, s4, r2) {
    ...
    switch (e2.toLowerCase()) {
      ...
      case "distinct":
        return n3 = await C2(this, t3, s4, r2), { calculated: true, result: n3 };
      case "avg":
      case "mean":
  ...
  intersection(e2, t3 = false) {
    return v3._featuresetFunctions.intersection.bind(this)(e2, t3);
  }
  difference(e2, t3 = false, s4 = true) {
    return v3._featuresetFunctions.difference.bind(this)(e2, t3, s4);
  }
  symmetricDifference(e2, t3 = false, s4 = true) {
    return v3._featuresetFunctions.symmetricDifference.bind(this)(e2, t3, s4);
  }
  morphShape(e2, t3, s4 = "unknown", r2 = null) {
    return v3._featuresetFunctions.morphShape.bind(this)(e2, t3, s4, r2);
  }
  morphShapeAndAttributes(e2, t3, s4 = "unknown") {
    return v3._featuresetFunctions.morphShapeAndAttributes.bind(this)(e2, t3, s4);
  }
  union(e2, t3 = false) {
    return v3._featuresetFunctions.union.bind(this)(e2, t3);
  }
  intersects(e2) {
    return v3._featuresetFunctions.intersects.bind(this)(e2);
  }
  envelopeIntersects(e2) {
    return v3._featuresetFunctions.envelopeIntersects.bind(this)(e2);
  }
  contains(e2) {
    return v3._featuresetFunctions.contains.bind(this)(e2);
  }
  overlaps(e2) {
    return v3._featuresetFunctions.overlaps.bind(this)(e2);
  }
  relate(e2, t3) {
    return v3._featuresetFunctions.relate.bind(this)(e2, t3);
  }
  within(e2) {
    return v3._featuresetFunctions.within.bind(this)(e2);
  }
  touches(e2) {
    return v3._featuresetFunctions.touches.bind(this)(e2);
  }
  top(e2) {
    return v3._featuresetFunctions.top.bind(this)(e2);
  }
  crosses(e2) {
    return v3._featuresetFunctions.crosses.bind(this)(e2);
  }
  buffer(e2, t3, s4, r2 = true) {
    return v3._featuresetFunctions.buffer.bind(this)(e2, t3, s4, r2);
  }
  filter(e2, t3 = null) {
    return v3._featuresetFunctions.filter.bind(this)(e2, t3);
  }
  orderBy(e2) {
    return v3._featuresetFunctions.orderBy.bind(this)(e2);
  }
  dissolve(e2, t3) {
    return v3._featuresetFunctions.dissolve.bind(this)(e2, t3);
  }
  groupby(e2, t3) {
    return v3._featuresetFunctions.groupby.bind(this)(e2, t3);
  }
      ...
      e2.next().then((l3) => {
        try {
          if (null === l3)
            ...
            const u4 = t3(s4, l3, r2, this);
            C(u4) ? u4.then((s5) => {
              this._reduceImpl(e2, t3, s5, r2 + 1, n3, i3, a3);
            }, i3) : this._reduceImpl(e2, t3, u4, r2 + 1, n3, i3, a3);
          }
        } catch (u4) {
          i3(u4);
        }
  ...
  removeField(e2) {
    return v3._featuresetFunctions.removeField.bind(this)(e2);
  }
  addField(e2, t3, s4 = null) {
    return v3._featuresetFunctions.addField.bind(this)(e2, t3, s4);
  }
      ...
      e2.next().then((a3) => {
        try {
          if (null === a3)
            ...
            const l3 = t3(a3);
            null == l3 ? this._forEachImpl(e2, t3, s4, r2, n3, i3) : C(l3) ? l3.then(() => {
              try {
  ...
  get dateTimeReferenceFieldIndex() {
    return null === this._dateFieldIndex && (this._dateFieldIndex = T.create(this.getFieldsIndex(), this)), this._dateFieldIndex;
  }
  fieldTimeZone(e2) {
...
var u3 = class extends v3 {
  ...
  _stat(e2, t3, r2, s4, a3, n3, u4) {
    return this._manualStat(e2, t3, n3, u4);
  }
...
var f5 = class extends v3 {
  ...
  async executeSpatialRelationTest(e2) {
    ...
    switch (this._relation) {
      case "esriSpatialRelEnvelopeIntersects": {
        const t3 = g(this._relationGeom), i3 = g(e2.geometry);
        return h(t3, i3);
      }
  ...
  static registerAction() {
    v3._featuresetFunctions.intersects = function(t3) {
      return null == t3 ? new u3({ parentfeatureset: this }) : new f5({ parentfeatureset: this, relation: "esriSpatialRelIntersects", relationGeom: t3 });
    }, v3._featuresetFunctions.envelopeIntersects = function(t3) {
      return null == t3 ? new u3({ parentfeatureset: this }) : new f5({ parentfeatureset: this, relation: "esriSpatialRelEnvelopeIntersects", relationGeom: t3 });
    }, v3._featuresetFunctions.contains = function(t3) {
      return null == t3 ? new u3({ parentfeatureset: this }) : new f5({ parentfeatureset: this, relation: "esriSpatialRelContains", relationGeom: t3 });
    }, v3._featuresetFunctions.overlaps = function(t3) {
      return null == t3 ? new u3({ parentfeatureset: this }) : new f5({ parentfeatureset: this, relation: "esriSpatialRelOverlaps", relationGeom: t3 });
    }, v3._featuresetFunctions.within = function(t3) {
      return null == t3 ? new u3({ parentfeatureset: this }) : new f5({ parentfeatureset: this, relation: "esriSpatialRelWithin", relationGeom: t3 });
    }, v3._featuresetFunctions.touches = function(t3) {
      return null == t3 ? new u3({ parentfeatureset: this }) : new f5({ parentfeatureset: this, relation: "esriSpatialRelTouches", relationGeom: t3 });
    }, v3._featuresetFunctions.crosses = function(t3) {
      return null == t3 ? new u3({ parentfeatureset: this }) : new f5({ parentfeatureset: this, relation: "esriSpatialRelCrosses", relationGeom: t3 });
    }, v3._featuresetFunctions.relate = function(t3, i3) {
      return null == t3 ? new u3({ parentfeatureset: this }) : new f5({ parentfeatureset: this, relation: "esriSpatialRelRelation", relationGeom: t3, relationString: i3 });
    };
  }
};
...
//# sourceMappingURL=chunk-HA7P7VCE.js.map

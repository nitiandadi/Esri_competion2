...
var Y = J = class extends a2(O(s5(m))) {
  ...
  async createFeatureLayer() {
    ...
    if (this.hasOwnProperty("sublayers"))
      return null;
    const { layer: e3 } = this, r6 = e3 == null ? void 0 : e3.parsedUrl, t4 = new (0, (await import("./FeatureLayer-2Y7EQOLA.js")).default)({ url: r6 == null ? void 0 : r6.path });
...
//# sourceMappingURL=chunk-4HR7WNF4.js.map

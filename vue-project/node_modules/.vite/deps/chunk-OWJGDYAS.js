...
var F = class extends v {
  ...
  async featureSetFromJSON(e2, t2, r2) {
    ...
    const { meshFeatureSetFromJSON: s3 } = await y(import("./meshFeatureSet-2CMRFGOW.js"), r2);
  ...
  async executeRelationshipQuery(e2, t2) {
    const [{ default: r2 }, { executeRelationshipQuery: o2 }] = await y(Promise.all([import("./RelationshipQuery-KYOW75ZW.js"), import("./executeRelationshipQuery-7ELXAHL6.js")]), t2);
  ...
  async executeRelationshipQueryForCount(e2, t2) {
    const [{ default: r2 }, { executeRelationshipQueryForCount: o2 }] = await y(Promise.all([import("./RelationshipQuery-KYOW75ZW.js"), import("./executeRelationshipQuery-7ELXAHL6.js")]), t2);
    return e2 = r2.from(e2), (this.gdbVersion || this.dynamicDataSource) && ((e2 = e2.clone()).gdbVersion = e2.gdbVersion || this.gdbVersion, e2.dynamicDataSource = e2.dynamicDataSource || this.dynamicDataSource), o2(this.url, e2, t2);
  }
  async executeAttachmentQuery(e2, t2) {
    const { executeAttachmentQuery: r2, fetchAttachments: o2, processAttachmentQueryResult: s3 } = await y(import("./queryAttachments-ANCMS5D3.js"), t2), u2 = f(this.url);
    return s3(u2, await (this.queryAttachmentsSupported ? r2(u2, e2, t2) : o2(u2, e2, t2)));
  }
  async executeTopFeaturesQuery(e2, t2) {
    const { executeTopFeaturesQuery: r2 } = await y(import("./executeTopFeaturesQuery-5BNZYDRH.js"), t2);
    return r2(this.parsedUrl, e2, this.sourceSpatialReference, t2);
  }
  async executeForTopIds(e2, t2) {
    const { executeForTopIds: r2 } = await y(import("./executeForTopIds-VPNK4F74.js"), t2);
    return r2(this.parsedUrl, e2, t2);
  }
  async executeForTopExtents(e2, t2) {
    const { executeForTopExtents: r2 } = await y(import("./executeForTopExtents-XLHM43KW.js"), t2);
    return r2(this.parsedUrl, e2, t2);
  }
  async executeForTopCount(e2, t2) {
    const { executeForTopCount: r2 } = await y(import("./executeForTopCount-YI7IS2OI.js"), t2);
    return r2(this.parsedUrl, e2, t2);
  }
  _normalizeQuery(e2) {
    let t2 = x.from(e2);
...
//# sourceMappingURL=chunk-OWJGDYAS.js.map

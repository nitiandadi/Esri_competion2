...
var Notice = proxyCustomElement(class extends H {
  ...
  render() {
    const { el } = this;
    const closeButton = h("button", { "aria-label": this.messages.close, class: CSS.close, onClick: this.close, ref: (el2) => this.closeButton = el2 }, h("calcite-icon", { icon: "x", scale: this.scale === "l" ? "m" : "s" }));
...
@esri/calcite-components/dist/components/calcite-notice.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-notice-BLFQ7TSQ.js.map

...
var d = class extends Error {
  constructor(t, n) {
    super(i(a[t], n)), this.declaredRootClass = "esri.arcade.arcadedate.dateerror", Error.captureStackTrace && Error.captureStackTrace(this, d);
  }
};
var c = class {
  constructor(e) {
  ...
  static fromParts(e = 0, t = 1, r = 1, s = 0, i3 = 0, o2 = 0, a2 = 0, d2) {
    ...
    let T = 0;
    o2 > 59 ? (T = o2 - 59, o2 = 59) : o2 < 0 && (T = o2, o2 = 0);
    let w = 0;
    a2 > 999 ? (w = a2 - 999, a2 = 999) : a2 < 0 && (w = a2, a2 = 0);
    let y = DateTime.fromObject({ day: r, year: e, month: t, hour: s, minute: i3, second: o2, millisecond: a2 }, { zone: u(d2) });
    return 0 !== l && (y = y.plus({ months: l })), 0 !== m && (y = y.plus({ days: m })), 0 !== f && (y = y.plus({ minutes: f })), 0 !== T && (y = y.plus({ seconds: T })), 0 !== w && (y = y.plus({ milliseconds: w })), new c(y);
  }
  ...
  static arcadeDateAndZoneToArcadeDate(e, t) {
    const n = u(t);
    return e.isUnknownTimeZone || n === i2.instance ? c.fromParts(e.year, e.monthJS + 1, e.day, e.hour, e.minute, e.second, e.millisecond, n) : new c(e._date.setZone(t));
  }
  static dateJSToArcadeDate(e) {
    return new c(DateTime.fromJSDate(e, { zone: "system" }));
  }
  static dateJSAndZoneToArcadeDate(e, t = "system") {
    return new c(DateTime.fromJSDate(e, { zone: t }));
  }
  static unknownEpochToArcadeDate(e) {
    return new c(DateTime.fromMillis(e, { zone: i2.instance }));
  }
  static unknownDateJSToArcadeDate(e) {
    return new c(DateTime.fromMillis(e.getTime(), { zone: i2.instance }));
  }
  static epochToArcadeDate(e, t = "system") {
    return new c(DateTime.fromMillis(e, { zone: t }));
  }
  ...
  static dateTimeAndZoneToArcadeDate(e, t) {
    const n = u(t);
    return e.zone === i2.instance || n === i2.instance ? c.fromParts(e.year, e.month, e.day, e.hour, e.minute, e.second, e.millisecond, n) : new c(e.setZone(n));
  }
  static nowToArcadeDate(e) {
    return new c(DateTime.fromJSDate(/* @__PURE__ */ new Date(), { zone: e }));
  }
  static nowUTCToArcadeDate() {
    return new c(DateTime.utc());
  }
  get isSystem() {
...
//# sourceMappingURL=chunk-VQUDNY75.js.map

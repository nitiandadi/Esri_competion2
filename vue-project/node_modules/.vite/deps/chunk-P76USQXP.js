...
function r(t2, h, i) {
  const { ctx: e3, canvas: o } = g(t2, i), n = e3.getImageData(0, 0, t2.width, t2.height), a2 = c(o, h);
  return f(o), { dataUrl: a2, data: n };
}
function l(t2, h) {
  const { ctx: i, canvas: e3 } = g(t2, h), o = i.getImageData(0, 0, t2.width, t2.height);
  return f(e3), o;
}
function g(t2, h) {
  const i = d();
  ...
  return e3.putImageData(t2, 0, 0), h.flipY && q(e3), { ctx: e3, canvas: i };
}
function f(t2) {
...
var u = null;
function c(t2, h) {
  const i = I[h.format], e3 = h.quality / 100;
  return t2.toDataURL(i, e3);
}
function s2(h, i) {
  const e3 = D(h), o = k[e3];
  return { format: e3, quality: a(null != i ? i : o, 0, 100) };
}
function w(t2, h) {
  return h / Math.max(t2[0], t2[1]);
}
function m(t2, h, i, e3 = 0, o = 0, n = t2.width - e3, a2 = t2.height - o, r2 = false) {
...
function v(t2) {
  ...
  for (let e3 = 0; e3 < i; e3 += 4) {
    ...
    if (255 !== t3 && t3 > 0) {
      const i2 = 255 / t3;
      h[e3 + 0] = h[e3 + 0] * i2, h[e3 + 1] = h[e3 + 1] * i2, h[e3 + 2] = h[e3 + 2] * i2;
    }
  }
}
...
//# sourceMappingURL=chunk-P76USQXP.js.map

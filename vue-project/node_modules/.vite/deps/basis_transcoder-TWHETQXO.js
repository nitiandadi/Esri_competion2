...
e2 = { get exports() {
  ...
  o = t;
} }, r = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, "undefined" != typeof __filename && (r = r || __filename), i = function(n2) {
  var e3, i2, o2 = void 0 !== (n2 = n2 || {}) ? n2 : {};
  ...
  l ? (v = c ? require_path().dirname(v) + "/" : __dirname + "/", p = function(t, n3) {
    return y || (y = require_fs()), h || (h = require_path()), t = h.normalize(t), y.readFileSync(t, n3 ? null : "utf8");
  }, d = function(t) {
    var n3 = p(t, true);
  ...
  function Q(t) {
    for (; t.length > 0; ) {
      ...
      if ("function" != typeof n3) {
        var e4 = n3.func;
        "number" == typeof e4 ? void 0 === n3.arg ? o2.dynCall_v(e4) : o2.dynCall_vi(e4, n3.arg) : e4(void 0 === n3.arg ? null : n3.arg);
      } else
        n3(o2);
    }
  }
  ...
  function mt(t, n3) {
    return String.prototype.startsWith ? t.startsWith(n3) : 0 === t.indexOf(n3);
  }
  ...
  function _t() {
    return g || !s && !c || "function" != typeof fetch || Ct(wt) ? new Promise(function(t, n3) {
      t(Tt());
  ...
  function Dt(t, n3) {
    var e4 = xt(n3, function(t2) {
      this.name = n3, this.message = t2;
      var e5 = new Error(t2).stack;
  ...
  function Vt(t) {
    ...
    Mt([t], i3.map(function(t2) {
      ...
      var o3 = {};
      return i3.forEach(function(n4, e5) {
        ...
        o3[r3] = { read: function(t3) {
          ...
          var e6 = [];
          l2(f2, t3, c2.toWireType(e6, n5)), Wt(e6);
        } };
...
var a = n({ __proto__: null, default: o }, [o]);
export {
  a as b
};
//# sourceMappingURL=basis_transcoder-TWHETQXO.js.map

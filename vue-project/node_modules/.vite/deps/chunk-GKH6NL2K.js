...
var h = class extends v2 {
  ...
  set path(t2) {
    r(t2) && Y(t2) ? s.getLogger(this.declaredClass).error("portalitemresource:invalid-path", "A portal item resource path must be relative") : this._set("path", t2);
  }
  _castPath(t2) {
  ...
  fetch(t2 = "json", r2) {
    ...
    return this.portalItem.portal.request(o2, { responseType: t2, query: { token: this.portalItem.apiKey }, signal: x(r2, "signal") });
  }
  async update(t2, r2) {
    return (await import("./resourceUtils-3DMLV5CL.js")).addOrUpdateResource(this, "update", t2, r2);
  }
  hasPath() {
    return r(this.path);
  }
  _normalizePath(t2, r2) {
    return t(t2) ? t2 : (t2 = t2.replace(/^\/+/, ""), r(r2) && Y(t2) && (t2 = G(t2, r2.itemUrl)), t2 == null ? void 0 : t2.replace(/^\/+/, "").replace(/^(\.\/)?resources\//, ""));
  }
};
e([y()], h.prototype, "portalItem", void 0), e([y({ type: String, value: null })], h.prototype, "path", null), e([s3("path")], h.prototype, "_castPath", null), e([y({ type: String, readOnly: true })], h.prototype, "url", null), e([y({ type: String, readOnly: true })], h.prototype, "itemRelativeUrl", null), h = e([a("esri.portal.PortalItemResource")], h);
var n = h;
...
e([y()], e2.prototype, "created", void 0), e([y()], e2.prototype, "rating", void 0), e2 = e([a("esri.portal.PortalRating")], e2);
var c2 = e2;

// node_modules/@arcgis/core/portal/PortalItem.js
var f;
var b2 = /* @__PURE__ */ new Set(["Map Service", "Feature Service", "Feature Collection", "Scene Service", "Image Service", "Stream Service", "Vector Tile Service", "GeoJson", "CSV", "KML", "WFS", "WMTS", "WMS", "Feed"]);
var k = /* @__PURE__ */ new Set(["KML", "GeoJson", "CSV"]);
var S = f = class extends u(m) {
  static from(e3) {
    return v(f, e3);
  }
  constructor(e3) {
  ...
  load(e3) {
    const t2 = this.portal ?? (this.portal = b.getDefault()), i = t2.load(e3).then(() => this.sourceJSON ? this.sourceJSON : this.id && this.itemUrl ? t2.request(this.itemUrl, { signal: r(e3) ? e3.signal : null, query: { token: this.apiKey } }) : {}).then((e4) => {
  ...
  async deleteRating() {
    await c(this.portal).request(this.itemUrl + "/deleteRating", { method: "post" });
  }
  fetchData(e3 = "json", t2) {
    return c(this.portal).request(this.itemUrl + "/data", { responseType: e3, ...t2, query: { token: this.apiKey } });
  }
  async fetchRating(e3) {
    const t2 = await c(this.portal).request(this.itemUrl + "/rating", { query: { token: this.apiKey }, ...e3 });
    return null != t2.rating ? (t2.created = new Date(t2.created), new c2(t2)) : null;
  }
  fetchRelatedItems(e3, t2) {
    return c(this.portal).requestToTypedArray(this.itemUrl + "/relatedItems", { query: { ...e3, token: this.apiKey }, ...t2 }, f);
  }
  getThumbnailUrl(e3) {
  ...
  reload() {
    return c(this.portal).request(this.itemUrl ?? "", { cacheBust: true, query: { token: this.apiKey } }).then((e3) => (this.sourceJSON = e3, this.read(e3), this));
  }
  update(e3) {
    return this.id ? this.load().then(() => c(this.portal).signIn()).then(() => {
  ...
  async copy(e3) {
    ...
    await this.load();
    const { portal: t2, itemUrl: r2 } = this;
    await c(t2).signIn();
    const { copyResources: o2, folder: s4, tags: a3, title: n2 } = e3 || {}, p2 = { method: "post", query: { copyPrivateResources: "all" === o2, folder: "string" == typeof s4 ? s4 : s4 == null ? void 0 : s4.id, includeResources: !!o2, tags: a3 == null ? void 0 : a3.join(","), title: n2 } }, { itemId: c3 } = await t2.request(`${r2}/copy`, p2);
    return new f({ id: c3, portal: t2 });
  }
  updateThumbnail(e3) {
    return this.id ? this.load().then(() => this.portal.signIn()).then(() => {
      const t2 = e3.thumbnail, i = e3.filename, r2 = { method: "post" };
      if ("string" == typeof t2)
        tt(t2) ? r2.query = { data: t2 } : r2.query = { url: F(t2) }, r(i) && (r2.query.filename = i);
      else {
  ...
  async fetchResources(e3 = {}, t2) {
    return (await import("./resourceUtils-3DMLV5CL.js")).fetchResources(this, e3, t2);
  }
  async addResource(e3, t2, i) {
    const r2 = await import("./resourceUtils-3DMLV5CL.js");
  ...
  async removeAllResources(e3) {
    return (await import("./resourceUtils-3DMLV5CL.js")).removeAllResources(this, e3);
  }
  resourceFromPath(e3) {
    return new n({ portalItem: this, path: e3 });
  }
  toJSON() {
    const e3 = this.extent, t2 = { accessInformation: this.accessInformation, categories: p(this.categories), created: this.created && this.created.getTime(), description: this.description, extent: e3 && [[e3.xmin, e3.ymin], [e3.xmax, e3.ymax]], id: this.id, isOrgItem: this.isOrgItem, licenseInfo: this.licenseInfo, modified: this.modified && this.modified.getTime(), name: this.name, owner: this.owner, ownerFolder: this.ownerFolder, snippet: this.snippet, sourceUrl: this.sourceUrl, spatialReference: this.spatialReference, tags: p(this.tags), thumbnail: this.thumbnail, title: this.title, type: this.type, typeKeywords: p(this.typeKeywords), url: this.url };
    return l(t2);
  }
  static fromJSON(e3) {
    if (!e3)
...
e([y({ type: ["private", "shared", "org", "public"] })], S.prototype, "access", void 0), e([y()], S.prototype, "accessInformation", void 0), e([y({ type: String })], S.prototype, "apiKey", void 0), e([y({ json: { read: { source: "appProxies" } } })], S.prototype, "applicationProxies", void 0), e([y()], S.prototype, "avgRating", void 0), e([y()], S.prototype, "categories", void 0), e([y({ type: Date })], S.prototype, "created", void 0), e([y()], S.prototype, "culture", void 0), e([y()], S.prototype, "description", void 0), e([y({ readOnly: true })], S.prototype, "displayName", null), e([y({ type: w })], S.prototype, "extent", void 0), e([o("extent")], S.prototype, "readExtent", null), e([y()], S.prototype, "groupCategories", void 0), e([y({ readOnly: true })], S.prototype, "iconUrl", null), e([y()], S.prototype, "id", void 0), e([y({ readOnly: true })], S.prototype, "isLayer", null), e([y({ type: Boolean, readOnly: true })], S.prototype, "isOrgItem", void 0), e([y()], S.prototype, "itemControl", void 0), e([y({ readOnly: true })], S.prototype, "itemPageUrl", null), e([y({ readOnly: true })], S.prototype, "itemUrl", null), e([y()], S.prototype, "licenseInfo", void 0), e([y({ type: Date })], S.prototype, "modified", void 0), e([y()], S.prototype, "name", void 0), e([y()], S.prototype, "numComments", void 0), e([y()], S.prototype, "numRatings", void 0), e([y()], S.prototype, "numViews", void 0), e([y()], S.prototype, "owner", void 0), e([y()], S.prototype, "ownerFolder", void 0), e([y({ type: b })], S.prototype, "portal", void 0), e([y()], S.prototype, "screenshots", void 0), e([y()], S.prototype, "size", void 0), e([y()], S.prototype, "snippet", void 0), e([y()], S.prototype, "sourceJSON", void 0), e([y({ type: String })], S.prototype, "sourceUrl", void 0), e([y({ type: String })], S.prototype, "spatialReference", void 0), e([y()], S.prototype, "tags", void 0), e([y()], S.prototype, "thumbnail", void 0), e([y({ readOnly: true })], S.prototype, "thumbnailUrl", null), e([y()], S.prototype, "title", void 0), e([y()], S.prototype, "type", void 0), e([y()], S.prototype, "typeKeywords", void 0), e([y({ type: String, json: { read(e3, t2) {
  var _a;
  if (k.has(t2.type)) {
  ...
  return e3;
} } })], S.prototype, "url", void 0), e([y({ readOnly: true })], S.prototype, "userItemUrl", null), S = f = e([a("esri.portal.PortalItem")], S);
var x2 = S;

export {
  x2 as x
};
//# sourceMappingURL=chunk-GKH6NL2K.js.map

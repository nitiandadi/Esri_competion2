...
} } } })], c2.prototype, "scaleExpressionTitle", void 0), e([y({ type: String, json: { write: true } })], c2.prototype, "url", void 0), e([r2("visualVariables")], c2.prototype, "writeVisualVariables", null), c2 = p4 = e([a("esri.renderers.DictionaryRenderer")], c2);
var u4 = c2;
...
e([y({ type: String, json: { write: true } })], p5.prototype, "unit", void 0), p5 = e3 = e([a("esri.renderers.support.DotDensityLegendOptions")], p5);
var c3 = p5;
...
e([y({ type: String, json: { write: true } })], p6.prototype, "minLabel", void 0), e([y({ type: String, json: { write: true } })], p6.prototype, "maxLabel", void 0), e([y({ type: String, json: { write: true } })], p6.prototype, "title", void 0), p6 = e([a("esri.renderers.support.HeatmapLegendOptions")], p6);
...
e([y({ type: j, json: { write: true, origins: { "web-scene": { write: false, read: false } } } })], v2.prototype, "authoringInfo", void 0), e([y({ type: Number, json: { origins: { "portal-item": { write: true }, "web-map": { write: true } } } })], v2.prototype, "blurRadius", null), e([y({ type: [a4], json: { write: true } })], v2.prototype, "colorStops", void 0), e([y({ type: String, json: { write: true } })], v2.prototype, "field", void 0), e([y({ type: Number, json: { write: { overridePolicy: (e4, t4, i5) => ({ enabled: null == i5 }) }, origins: { "web-scene": { write: false } } } })], v2.prototype, "fieldOffset", void 0), e([y({ type: p6, json: { write: true } })], v2.prototype, "legendOptions", void 0), e([y({ type: Number, json: { write: true } })], v2.prototype, "maxDensity", void 0), e([y({ type: Number, json: { origins: { "portal-item": { write: true }, "web-map": { write: true } } } })], v2.prototype, "maxPixelIntensity", null), e([y({ type: Number, json: { write: true } })], v2.prototype, "minDensity", void 0), e([y({ type: Number, json: { origins: { "portal-item": { write: true }, "web-map": { write: true } } } })], v2.prototype, "minPixelIntensity", null), e([y({ type: Number, cast: o2, json: { write: true } })], v2.prototype, "radius", void 0), e([y({ type: Number, range: { min: 0 }, json: { default: 0, write: true } })], v2.prototype, "referenceScale", void 0), e([o({ heatmap: "heatmap" })], v2.prototype, "type", void 0), e([y({ type: String, json: { write: true, origins: { "web-document": { write: false }, "portal-item": { write: false } } } })], v2.prototype, "valueExpression", void 0), e([y({ type: String })], v2.prototype, "valueExpressionTitle", void 0), e([y({ readOnly: true })], v2.prototype, "_pixelIntensityToDensity", null), v2 = j2 = e([a(D)], v2);
var P = v2;
...
e([y({ type: String, json: { write: true } })], p7.prototype, "title", void 0), p7 = e([a("esri.renderers.support.PieChartLegendOptions")], p7);
...
e([y({ type: [a3], json: { write: true } })], f.prototype, "attributes", void 0), e([y({ type: S, json: { default: null, write: true } })], f.prototype, "backgroundFillSymbol", void 0), e([y({ type: l2, json: { write: true } })], f.prototype, "defaultColor", void 0), e([y({ type: String, json: { write: true } })], f.prototype, "defaultLabel", void 0), e([y({ type: Number, range: { min: 0, max: 1 }, json: { write: true } })], f.prototype, "holePercentage", void 0), e([y({ type: i4, json: { write: true } })], f.prototype, "othersCategory", void 0), e([y({ type: p7, json: { write: true } })], f.prototype, "legendOptions", void 0), e([y({ type: m, json: { default: null, write: true } })], f.prototype, "outline", void 0), e([y({ type: Number, cast: o2, json: { write: true } })], f.prototype, "size", void 0), e([o({ pieChart: "pie-chart" })], f.prototype, "type", void 0), f = e([a("esri.renderers.PieChartRenderer")], f);
var j3 = f;

// node_modules/@arcgis/core/renderers/support/types.js
var p8 = { key: "type", base: p2, typeMap: { heatmap: P, simple: p3, "unique-value": T2, "class-breaks": _, "dot-density": y4, dictionary: u4, "pie-chart": j3 }, errorContext: "renderer" };
var n2 = { key: "type", base: p2, typeMap: { simple: p3, "unique-value": T2, "class-breaks": _, heatmap: P }, errorContext: "renderer" };
...
var s3 = u2({ types: p8 });
function o3(r3, n3, t4) {
  return r3 ? r3 && (r3.styleName || r3.styleUrl) && "uniqueValue" !== r3.type ? (t4 && t4.messages && t4.messages.push(new t2("renderer:unsupported", "Only UniqueValueRenderer can be referenced from a web style, but found '" + r3.type + "'", { definition: r3, context: t4 })), null) : s3(r3, n3, t4) : null;
}
...
//# sourceMappingURL=chunk-PVXAD5LL.js.map

...
export const useroadconditionStore = defineStore('roadcondition',() => {
    ...
    //
    //
    function getRoadDataByRoadName(roadName: string): RoadData | undefined {
        return roadDataList.find((roadData: RoadData) => roadData.roadName === roadName);
      }
    //
    async function renderFeatureLayer(featureLayer: any) {
      //
    //粒子
    ...
    return { fetchCongestionEvaluationData, getRoadDataByRoadName, renderFeatureLayer, updateFeatureLayerAttributes,roadDataList };
});
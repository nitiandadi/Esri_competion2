...
import TopFilter from "@arcgis/core/rest/support/TopFilter.js";
  // import lineloop from '@/assets/myAssets/lineloop.json';
  ...
  // import roadline from '@/features/device/roadline';
  import { ref } from 'vue';
  const store = useViewStore();
  let echartLayer: EchartsLayer | null = null;
  let myChart: echarts.ECharts ;
  onMounted(()=>{
    store.CreateMapView();
    let view = store.getView() as __esri.MapView;
    const echartsLayer = new EchartsLayer(view, {});
    echartsLayer.setVisiable(true);
    var geoCoordMap = {
                '上海': [121.4648, 31.2891],
                '东莞': [113.8953, 22.901],
                '东营': [118.7073, 37.5513],
...
if(!echartsLayer)
  (echartsLayer as any).chart.setOption(option1);

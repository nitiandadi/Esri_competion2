...
import environment from '../views/attractionPages/environment.vue'
...
.el-card{
  ...
  width: 190px;
  height: 200px;
  left: -380px; /* 卡片开始的位置在右边屏幕外 */
  /* ...其余样式... */
  border-radius: 6px; /* 添加边角弧度 */
  background-image: linear-gradient(-90deg, #182940 0%, #115687 100%); /* 添加渐变 */
  pointer-events: auto;
